...
*)
    ...
    let bankersQueueIntOfSeqGen = gen {
    ...
    let bankersQueueIntSnocGen = gen {
        let! n = Gen.length2thru12
        let! x = Gen.listInt n
        return ((BankersQueue.empty() |> snocThruList x), x)
    }

    let bankersQueueObjGen = gen {
        let! n = Gen.length1thru12
        let! n2 = Gen.length1thru12
        let! x = Gen.listObj n
...
*)
    ...
    let batchedQueueIntOfSeqGen = gen {
        let! n = Gen.length1thru12
        let! x = Gen.listInt n
        return ((BatchedQueue.ofSeq x) :> IQueue<int>, x)
    }

    let batchedQueueIntSnocGen = gen {
        let! n = Gen.length1thru12
        let! x = Gen.listInt n
        return ((BatchedQueue.empty() |> snocThruList x), x)
    }

    let batchedQueueObjGen = gen {
        let! n = Gen.length2thru12
        let! n2 = Gen.length1thru12
        let! x = Gen.listObj n
        let! y = Gen.listObj n2
...
non-IQueue generators from random ofList
*)
    let hoodMelvilleQueueOfListGen = gen {
        let! n = Gen.length2thru12
        let! x = Gen.listInt n
...
IQueue generators from random ofSeq and/or snoc elements from random list 
*)
    let hoodMelvilleQueueIntGen = gen {
        let! n = Gen.length1thru12
        let! n2 = Gen.length2thru12
        let! x = Gen.listInt n
        let! y = Gen.listInt n2
    ...
    let hoodMelvilleQueueIntOfSeqGen = gen {
        let! n = Gen.length1thru12
        let! x = Gen.listInt n
        return ((HoodMelvilleQueue.ofSeq x) :> IQueue<int>, x)
    }

    let hoodMelvilleQueueIntSnocGen = gen {
        let! n = Gen.length1thru12
        let! x = Gen.listInt n
        return ((HoodMelvilleQueue.empty() |> snocThruList x), x)
    }

    let hoodMelvilleQueueObjGen = gen {
        let! n = Gen.length2thru12
        let! n2 = Gen.length1thru12
        let! x = Gen.listObj n
        let! y = Gen.listObj n2
    ...
    let hoodMelvilleQueueStringGen = gen {
        let! n = Gen.length1thru12
        let! n2 = Gen.length2thru12
        let! x = Gen.listString n
        let! y = Gen.listString n2
...
non-IQueue generators from random ofList
*)
    let physicistQueueOfListqGen = gen {
        let! n = Gen.length2thru12
        let! x = Gen.listInt n
...
*)
    ...
    let physicistQueueIntOfSeqGen = gen {
        let! n = Gen.length2thru12
        let! x = Gen.listInt n
        return ((PhysicistQueue.ofSeq x) :> IQueue<int>, x)
    }

    let physicistQueueIntSnocGen = gen {
        let! n = Gen.length2thru12
        let! x = Gen.listInt n
        return ((PhysicistQueue.empty() |> snocThruList x), x)
    }

    let physicistQueueObjGen = gen {
        let! n = Gen.length2thru12
        let! n2 = Gen.length1thru12
        let! x = Gen.listObj n
        let! y = Gen.listObj n2
    ...
    let physicistQueueStringGen = gen {
        let! n = Gen.length1thru12
        let! n2 = Gen.length2thru12
        let! x = Gen.listString n
        let! y = Gen.listString n2
