...
module DequeTest =
    ...
    let testDeque =
        ...
        testList "Experimental Deque" [
            ...
            test "Deque.tail of Deque.singleton empty" { Expect.isTrue "Deque.isEmpty" (len1 |> Deque.tail |> Deque.isEmpty) }
            ...
            test "initial of Deque.singleton empty" { Expect.isTrue "Deque.isEmpty" (len1 |> Deque.init |> Deque.isEmpty) }
            ...
            test "Deque.rev empty dqueue should be empty" { Deque.empty() |> Deque.rev |> Deque.isEmpty |> Expect.isTrue "" }
            ...
            test "Deque.update elements Deque.length 1" { len1 |> Deque.update 0 "aa" |> Deque.head |> Expect.equal "" "aa" }
