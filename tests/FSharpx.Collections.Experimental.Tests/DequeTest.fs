...
module DequeTest =
    ...
    let len4 = Deque.singleton "a" |> Deque.cons "b" |> Deque.cons "c" |> Deque.cons "d"
    let len5 = Deque.singleton "a" |> Deque.cons "b" |> Deque.cons "c" |> Deque.cons "d" |> Deque.cons "e"
    let len6 = Deque.singleton "a" |> Deque.cons "b" |> Deque.cons "c" |> Deque.cons "d" |> Deque.cons "e" |> Deque.cons "f"
    let len7 = Deque.singleton "a" |> Deque.cons "b" |> Deque.cons "c" |> Deque.cons "d" |> Deque.cons "e" |> Deque.cons "f" |> Deque.cons "g"
    let len8 = Deque.singleton "a" |> Deque.cons "b" |> Deque.cons "c" |> Deque.cons "d" |> Deque.cons "e" |> Deque.cons "f" |> Deque.cons "g" |> Deque.cons "h"
    let len9 = Deque.singleton "a" |> Deque.cons "b" |> Deque.cons "c" |> Deque.cons "d" |> Deque.cons "e" |> Deque.cons "f" |> Deque.cons "g" |> Deque.cons "h" |> Deque.cons "i"
    let lena = Deque.singleton "a" |> Deque.cons "b" |> Deque.cons "c" |> Deque.cons "d" |> Deque.cons "e" |> Deque.cons "f" |> Deque.cons "g" |> Deque.cons "h" |> Deque.cons "i" |> Deque.cons "j"

    let len2snoc = Deque.singleton "b" |> Deque.snoc "a"
    let len3snoc = Deque.singleton "c" |> Deque.snoc "b" |> Deque.snoc "a"
    let len4snoc = Deque.singleton "d" |> Deque.snoc "c" |> Deque.snoc "b" |> Deque.snoc "a"
    let len5snoc = Deque.singleton "e" |> Deque.snoc "d" |> Deque.snoc "c" |> Deque.snoc "b" |> Deque.snoc "a"
    let len6snoc = Deque.singleton "f" |> Deque.snoc "e" |> Deque.snoc "d" |> Deque.snoc "c" |> Deque.snoc "b" |> Deque.snoc "a"
    let len7snoc = Deque.singleton "g" |> Deque.snoc "f" |> Deque.snoc "e" |> Deque.snoc "d" |> Deque.snoc "c" |> Deque.snoc "b" |> Deque.snoc "a"
    let len8snoc = Deque.singleton "h" |> Deque.snoc "g" |> Deque.snoc "f" |> Deque.snoc "e" |> Deque.snoc "d" |> Deque.snoc "c" |> Deque.snoc "b" |> Deque.snoc "a"
    let len9snoc = Deque.singleton "i" |> Deque.snoc "h" |> Deque.snoc "g" |> Deque.snoc "f" |> Deque.snoc "e" |> Deque.snoc "d" |> Deque.snoc "c" |> Deque.snoc "b" |> Deque.snoc "a"
    let lenasnoc = Deque.singleton "j" |> Deque.snoc "i" |> Deque.snoc "h" |> Deque.snoc "g" |> Deque.snoc "f" |> Deque.snoc "e" |> Deque.snoc "d" |> Deque.snoc "c" |> Deque.snoc "b" |> Deque.snoc "a"

    [<Tests>]
    let testDeque =

        testList "Experimental Deque" [
            test "empty dqueue should be empty" {
                Expect.isTrue "empty is empty" (Deque.empty() |> Deque.isEmpty) }

            test "Deque.cons works" {
                Expect.isFalse "not empty" (len2 |> Deque.isEmpty) }

            test "Deque.snoc works" {
                Expect.isFalse "" (len2snoc |> Deque.isEmpty) }

            test "Deque.singleton Deque.head works" {
                Expect.equal "Deque.singleton" "a" (len1 |> Deque.head) }

            test "Deque.singleton Deque.last works" {
                Expect.equal "" "a" (len1 |> Deque.last) }
            ...
            test "Deque.head, Deque.tail, and Deque.length work test 1" {
                ...
                Expect.isTrue "Deque.head, Deque.tail, and Deque.length" (((Deque.length t1) = 1) && ((Deque.length t1s) = 1) && ((Deque.head t1) = "a") && ((Deque.head t1s) = "a")) }
            ...
            test "Deque.head, Deque.tail, and Deque.length work test 2" {
                ...
                (((Deque.length t1) = 2) && ((Deque.length t1s) = 2) && ((Deque.head t1) = "b") && ((Deque.head t1s) = "b") && ((Deque.length t1_1) = 1) && ((Deque.length t1_1s) = 1) 
                && ((Deque.head t1_1) = "a") && ((Deque.head t1_1s) = "a")) |> Expect.isTrue "Deque.head, Deque.tail, and Deque.length" }
            ...
            test "Deque.head, Deque.tail, and Deque.length work test 3" {
                ...
                (((Deque.length t1) = 3) && ((Deque.length t1s) = 3) && ((Deque.head t1) = "c")&& ((Deque.head t1s) = "c") && ((Deque.length t1_2) = 2) && ((Deque.length t1_2s) = 2)
                && ((Deque.head t1_2) = "b") && ((Deque.head t1_2s) = "b") && ((Deque.length t1_1) = 1) && ((Deque.length t1_1s) = 1) && ((Deque.head t1_1) = "a") 
                && ((Deque.head t1_1s) = "a")) |> Expect.isTrue "Deque.head, Deque.tail, and Deque.length" }
            ...
            test "Deque.head, Deque.tail, and Deque.length work test 4" {
                ...
                (((Deque.length t1) = 4) && ((Deque.length t1s) = 4) && ((Deque.head t1) = "d") && ((Deque.head t1s) = "d") && ((Deque.length t1_3) = 3) && ((Deque.length t1_3s) = 3)
                && ((Deque.head t1_3) = "c") && ((Deque.head t1_3s) = "c") && ((Deque.length t1_2) = 2) && ((Deque.length t1_2s) = 2) && ((Deque.head t1_2) = "b") && ((Deque.head t1_2s) = "b")
                && ((Deque.length t1_1) = 1) && ((Deque.length t1_1s) = 1) && ((Deque.head t1_1) = "a") && ((Deque.head t1_1s) = "a")) |> Expect.isTrue "Deque.head, Deque.tail, and Deque.length" }
            ...
            test "Deque.head, Deque.tail, and Deque.length work test 5" {
                ...
                (((Deque.length t1) = 5) && ((Deque.length t1s) = 5) && ((Deque.head t1) = "e") && ((Deque.head t1s) = "e") && ((Deque.length t1_4) = 4) && ((Deque.length t1_4s) = 4) 
                && ((Deque.head t1_4) = "d") && ((Deque.head t1_4s) = "d") && ((Deque.length t1_3) = 3) && ((Deque.length t1_3s) = 3) && ((Deque.head t1_3) = "c") && ((Deque.head t1_3s) = "c") 
                && ((Deque.length t1_2) = 2) && ((Deque.length t1_2s) = 2) && ((Deque.head t1_2) = "b") && ((Deque.head t1_2s) = "b") && ((Deque.length t1_1) = 1) && ((Deque.length t1_1s) = 1)
                && ((Deque.head t1_1) = "a") && ((Deque.head t1_1s) = "a")) |> Expect.isTrue "Deque.head, Deque.tail, and Deque.length" }
            ...
            test "Deque.head, Deque.tail, and Deque.length work test 6" {
                ...
                (((Deque.length t1) = 6) && ((Deque.length t1s) = 6)  
                && ((Deque.head t1) = "f") && ((Deque.head t1s) = "f") 
                && ((Deque.length t1_5) = 5) && ((Deque.length t1_5s) = 5) 
                && ((Deque.head t1_5) = "e") && ((Deque.head t1_5s) = "e") 
                && ((Deque.length t1_4) = 4) && ((Deque.length t1_4s) = 4) 
                && ((Deque.head t1_4) = "d") && ((Deque.head t1_4s) = "d") 
                && ((Deque.length t1_3) = 3) && ((Deque.length t1_3s) = 3) 
                && ((Deque.head t1_3) = "c") && ((Deque.head t1_3s) = "c") 
                && ((Deque.length t1_2) = 2) && ((Deque.length t1_2s) = 2) 
                && ((Deque.head t1_2) = "b") && ((Deque.head t1_2s) = "b") 
                && ((Deque.length t1_1) = 1) && ((Deque.length t1_1s) = 1) 
                && ((Deque.head t1_1) = "a") && ((Deque.head t1_1s) = "a") ) |> Expect.isTrue "Deque.head, Deque.tail, and Deque.length" }
            ...
            test "Deque.head, Deque.tail, and Deque.length work test 7" {
                ...
                (((Deque.length t1) = 7) && ((Deque.length t1s) = 7) 
                && ((Deque.head t1) = "g") && ((Deque.head t1s) = "g") 
                && ((Deque.length t1_6) = 6)  && ((Deque.length t1_6s) = 6) 
                && ((Deque.head t1_6) = "f")  && ((Deque.head t1_6s) = "f") 
                && ((Deque.length t1_5) = 5)  && ((Deque.length t1_5s) = 5) 
                && ((Deque.head t1_5) = "e")  && ((Deque.head t1_5s) = "e") 
                && ((Deque.length t1_4) = 4)  && ((Deque.length t1_4s) = 4) 
                && ((Deque.head t1_4) = "d")  && ((Deque.head t1_4s) = "d") 
            ...
            test "Deque.head, Deque.tail, and Deque.length work test 8" {
                ...
                (((Deque.length t1) = 8) && ((Deque.length t1s) = 8) 
                && ((Deque.head t1) = "h") && ((Deque.head t1s) = "h") 
                && ((Deque.length t1_7) = 7)  && ((Deque.length t1_7s) = 7) 
                && ((Deque.head t1_7) = "g")  && ((Deque.head t1_7s) = "g") 
                && ((Deque.length t1_6) = 6)  && ((Deque.length t1_6s) = 6) 
                && ((Deque.head t1_6) = "f")  && ((Deque.head t1_6s) = "f") 
                && ((Deque.length t1_5) = 5)  && ((Deque.length t1_5s) = 5) 
                && ((Deque.head t1_5) = "e")  && ((Deque.head t1_5s) = "e") 
            ...
            test "Deque.head, Deque.tail, and Deque.length work test 9" {
                ...
                (((Deque.length t1) = 9) && ((Deque.length t1s) = 9) && ((Deque.head t1) = "i")  && ((Deque.head t1s) = "i") 
                && ((Deque.length t1_8) = 8) && ((Deque.length t1_8s) = 8) && ((Deque.head t1_8) = "h") && ((Deque.head t1_8s) = "h") 
                && ((Deque.length t1_7) = 7) && ((Deque.length t1_7s) = 7) && ((Deque.head t1_7) = "g") && ((Deque.head t1_7s) = "g") 
                && ((Deque.length t1_6) = 6) && ((Deque.length t1_6s) = 6) && ((Deque.head t1_6) = "f") && ((Deque.head t1_6s) = "f") 
                && ((Deque.length t1_5) = 5) && ((Deque.length t1_5s) = 5) && ((Deque.head t1_5) = "e") && ((Deque.head t1_5s) = "e") 
                && ((Deque.length t1_4) = 4) && ((Deque.length t1_4s) = 4) && ((Deque.head t1_4) = "d") && ((Deque.head t1_4s) = "d") 
                && ((Deque.length t1_3) = 3) && ((Deque.length t1_3s) = 3) && ((Deque.head t1_3) = "c") && ((Deque.head t1_3s) = "c") 
                && ((Deque.length t1_2) = 2) && ((Deque.length t1_2s) = 2) && ((Deque.head t1_2) = "b") && ((Deque.head t1_2s) = "b") 
                && ((Deque.length t1_1) = 1) && ((Deque.length t1_1s) = 1) && ((Deque.head t1_1) = "a") && ((Deque.head t1_1s) = "a")) |> Expect.isTrue "Deque.head, Deque.tail, and Deque.length" } 
            ...
            test "Deque.last, Deque.init, and Deque.length work test 1" {  
                ...
                Expect.isTrue "Deque.last, Deque.init, and Deque.length" (((Deque.length t1) = 1) && ((Deque.last t1) = "b")) }

            test "Deque.last, Deque.init, and Deque.length work test 2" {
                let t1 = Deque.init len3
                let t1_1 = Deque.init t1
    
                Expect.isTrue "Deque.last, Deque.init, and Deque.length" (((Deque.length t1) = 2) && ((Deque.last t1) = "b") && ((Deque.length t1_1) = 1)  && ((Deque.last t1_1) = "c") ) }
            ...
            test "Deque.last, Deque.init, and Deque.length work test 3" {
                ...
                (((Deque.length t1) = 3) && ((Deque.last t1) = "b")
                && ((Deque.length t1_1) = 2)  && ((Deque.last t1_1) = "c") 
                && ((Deque.length t1_2) = 1)  && ((Deque.last t1_2) = "d") ) |> Expect.isTrue "Deque.last, Deque.init, and Deque.length" }
            ...
            test "Deque.last, Deque.init, and Deque.length work test 4" {
                ...
                (((Deque.length t1) = 4) && ((Deque.last t1) = "b")
                && ((Deque.length t1_1) = 3)  && ((Deque.last t1_1) = "c") 
                && ((Deque.length t1_2) = 2)  && ((Deque.last t1_2) = "d") 
                && ((Deque.length t1_3) = 1)  && ((Deque.last t1_3) = "e") ) |> Expect.isTrue "Deque.last, Deque.init, and Deque.length" }
            ...
            test "Deque.last, Deque.init, and Deque.length work test 5" {
                ...
                (((Deque.length t1) = 5) && ((Deque.last t1) = "b")
                && ((Deque.length t1_1) = 4)  && ((Deque.last t1_1) = "c") 
                && ((Deque.length t1_2) = 3)  && ((Deque.last t1_2) = "d") 
                && ((Deque.length t1_3) = 2)  && ((Deque.last t1_3) = "e") 
                && ((Deque.length t1_4) = 1)  && ((Deque.last t1_4) = "f") ) |> Expect.isTrue "Deque.last, Deque.init, and Deque.length" }
            ...
            test "Deque.last, Deque.init, and Deque.length work test 6" {
                ...
                (((Deque.length t1) = 6) && ((Deque.last t1) = "b")
                && ((Deque.length t1_1) = 5)  && ((Deque.last t1_1) = "c") 
                && ((Deque.length t1_2) = 4)  && ((Deque.last t1_2) = "d") 
                && ((Deque.length t1_3) = 3)  && ((Deque.last t1_3) = "e") 
                && ((Deque.length t1_4) = 2)  && ((Deque.last t1_4) = "f") 
                && ((Deque.length t1_5) = 1)  && ((Deque.last t1_5) = "g") ) |> Expect.isTrue "Deque.last, Deque.init, and Deque.length" }
            ...
            test "Deque.last, Deque.init, and Deque.length work test 7" {
                ...
                (((Deque.length t1) = 7) && ((Deque.last t1) = "b") 
                && ((Deque.length t1_1) = 6)  && ((Deque.last t1_1) = "c") 
                && ((Deque.length t1_2) = 5)  && ((Deque.last t1_2) = "d") 
                && ((Deque.length t1_3) = 4)  && ((Deque.last t1_3) = "e") 
                && ((Deque.length t1_4) = 3)  && ((Deque.last t1_4) = "f") 
                && ((Deque.length t1_5) = 2)  && ((Deque.last t1_5) = "g") 
                && ((Deque.length t1_6) = 1)  && ((Deque.last t1_6) = "h") ) |> Expect.isTrue "Deque.last, Deque.init, and Deque.length" }
            ...
            test "Deque.last, Deque.init, and Deque.length work test 8" {
                ...
                (((Deque.length t1) = 8) && ((Deque.last t1) = "b")
                && ((Deque.length t1_1) = 7)  && ((Deque.last t1_1) = "c") 
                && ((Deque.length t1_2) = 6)  && ((Deque.last t1_2) = "d") 
                && ((Deque.length t1_3) = 5)  && ((Deque.last t1_3) = "e") 
                && ((Deque.length t1_4) = 4)  && ((Deque.last t1_4) = "f") 
                && ((Deque.length t1_5) = 3)  && ((Deque.last t1_5) = "g") 
                && ((Deque.length t1_6) = 2)  && ((Deque.last t1_6) = "h") 
                && ((Deque.length t1_7) = 1)  && ((Deque.last t1_7) = "i") ) |> Expect.isTrue "Deque.last, Deque.init, and Deque.length" }
            ...
            test "Deque.last, Deque.init, and Deque.length work test 9" {
                ...
                (((Deque.length t1) = 9) && ((Deque.last t1) = "b")
                && ((Deque.length t1_1) = 8)  && ((Deque.last t1_1) = "c") 
                && ((Deque.length t1_2) = 7)  && ((Deque.last t1_2) = "d") 
                && ((Deque.length t1_3) = 6)  && ((Deque.last t1_3) = "e") 
                && ((Deque.length t1_4) = 5)  && ((Deque.last t1_4) = "f") 
                && ((Deque.length t1_5) = 4)  && ((Deque.last t1_5) = "g") 
                && ((Deque.length t1_6) = 3)  && ((Deque.last t1_6) = "h") 
                && ((Deque.length t1_7) = 2)  && ((Deque.last t1_7) = "i") 
                && ((Deque.length t1_8) = 1)  && ((Deque.last t1_8) = "j") ) |> Expect.isTrue "Deque.last, Deque.init, and Deque.length" }

            test "IEnumerable Seq nth" {
                Expect.equal "IEnumerable nth" "e" (lena |> Seq.item 5) }

            test "IEnumerable Seq Deque.length" {
                Expect.equal "IEnumerable Deque.length" 10 (lena |> Seq.length) }

            test "type Deque.cons works" {
            ...
            test "Deque.ofCatLists and Deque.uncons" {
                ...
                Expect.isTrue "Deque.ofCatLists and Deque.uncons" ((h1 = "a") && (h2 = "b") && (h3 = "c") && (h4 = "d") && (h5 = "e") && (h6 = "f") && (Deque.isEmpty t6)) }
            ...
            test "Deque.unsnoc works" {
                ...
                Expect.isTrue "Deque.unsnoc" ((l1 = "a") && (l2 = "b") && (l3 = "c") && (l4 = "d") && (l5 = "e") && (l6 = "f") && (Deque.isEmpty i6)) }
            ...
            test "Deque.rev deque Deque.length 1" {
                Expect.equal "Deque.length" "a" (Deque.rev len1 |> Deque.head) } 
            ...
            test "Deque.rev deque Deque.length 6" {
                ...
                Expect.isTrue "Deque.rev Deque.length" ((h1 = "a") && (h2 = "b") && (h3 = "c") && (h4 = "d") && (h5 = "e") && (h6 = "f")) }

            test "Deque.lookup Deque.length 1" {
                Expect.equal "" "a" (len1 |> Deque.lookup 0) }

            test "Deque.lookup Deque.length 2" {
                (((len2 |> Deque.lookup 0) = "b") && ((len2 |> Deque.lookup 1) = "a")) |> Expect.isTrue "" } 

            test "Deque.lookup Deque.length 3" {
                (((len3 |> Deque.lookup 0) = "c") && ((len3 |> Deque.lookup 1) = "b") && ((len3 |> Deque.lookup 2) = "a")) |> Expect.isTrue "" }

            test "Deque.lookup Deque.length 4" {
                (((len4 |> Deque.lookup 0) = "d") && ((len4 |> Deque.lookup 1) = "c") && ((len4 |> Deque.lookup 2) = "b") && ((len4 |> Deque.lookup 3) = "a")) 
                |> Expect.isTrue "" }

            test "Deque.lookup Deque.length 5" {
                (((len5 |> Deque.lookup 0) = "e") && ((len5 |> Deque.lookup 1) = "d") && ((len5 |> Deque.lookup 2) = "c") && ((len5 |> Deque.lookup 3) = "b") 
                && ((len5 |> Deque.lookup 4) = "a")) |> Expect.isTrue "" }

            test "Deque.lookup Deque.length 6" {
                (((len6 |> Deque.lookup 0) = "f") && ((len6 |> Deque.lookup 1) = "e") && ((len6 |> Deque.lookup 2) = "d") && ((len6 |> Deque.lookup 3) = "c") 
                && ((len6 |> Deque.lookup 4) = "b") && ((len6 |> Deque.lookup 5) = "a")) |> Expect.isTrue "" }

            test "Deque.lookup Deque.length 7" {
                (((len7 |> Deque.lookup 0) = "g") && ((len7 |> Deque.lookup 1) = "f") && ((len7 |> Deque.lookup 2) = "e") && ((len7 |> Deque.lookup 3) = "d") 
                && ((len7 |> Deque.lookup 4) = "c") && ((len7 |> Deque.lookup 5) = "b") && ((len7 |> Deque.lookup 6) = "a")) |> Expect.isTrue "" }

            test "Deque.lookup Deque.length 8" {
                (((len8 |> Deque.lookup 0) = "h") && ((len8 |> Deque.lookup 1) = "g") && ((len8 |> Deque.lookup 2) = "f") && ((len8 |> Deque.lookup 3) = "e") 
                && ((len8 |> Deque.lookup 4) = "d") && ((len8 |> Deque.lookup 5) = "c") && ((len8 |> Deque.lookup 6) = "b") && ((len8 |> Deque.lookup 7) = "a")) 
                |> Expect.isTrue "" }

            test "Deque.lookup Deque.length 9" {
                (((len9 |> Deque.lookup 0) = "i") && ((len9 |> Deque.lookup 1) = "h") && ((len9 |> Deque.lookup 2) = "g") && ((len9 |> Deque.lookup 3) = "f") 
                && ((len9 |> Deque.lookup 4) = "e") && ((len9 |> Deque.lookup 5) = "d") && ((len9 |> Deque.lookup 6) = "c") && ((len9 |> Deque.lookup 7) = "b")
                && ((len9 |> Deque.lookup 8) = "a")) |> Expect.isTrue "" }

            test "Deque.lookup Deque.length 10" {
                (((lena |> Deque.lookup 0) = "j") && ((lena |> Deque.lookup 1) = "i") && ((lena |> Deque.lookup 2) = "h") && ((lena |> Deque.lookup 3) = "g") 
                && ((lena |> Deque.lookup 4) = "f") && ((lena |> Deque.lookup 5) = "e") && ((lena |> Deque.lookup 6) = "d") && ((lena |> Deque.lookup 7) = "c")
                && ((lena |> Deque.lookup 8) = "b") && ((lena |> Deque.lookup 9) = "a")) |> Expect.isTrue "" }
            ...
            test "Deque.tryLookup not found" {
                lena |> Deque.tryLookup 10 |> Expect.isNone "" }

            test "Deque.remove elements Deque.length 1" {
                len1 |> Deque.remove 0 |> Deque.isEmpty |> Expect.isTrue "" }
            ...
            test "tryRemoveempty" {
                Deque.empty() |> Deque.tryRemove 0 |> Expect.isNone "" }
