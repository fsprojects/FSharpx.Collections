        ...
        BinaryRoseTree.createTree
            ...
            (BinaryRoseTree.createTree
                ...
                (BinaryRoseTree.createForest
                    ...
                    (BinaryRoseTree.createTree 4 (BinaryRoseTree.createTree 5 (BinaryRoseTree.singleton 6)))))
        ...
        BinaryRoseTree.createTree
            ...
            (BinaryRoseTree.createTree
                ...
                (BinaryRoseTree.createForest
                    4
                    BinaryRoseTree.empty
                    (BinaryRoseTree.createTree 5 (BinaryRoseTree.createTree 6 (BinaryRoseTree.singleton 7)))))
        ...
        BinaryRoseTree.createTree
            ...
            (BinaryRoseTree.createForest
                ...
                (BinaryRoseTree.createForest
                    "a"
                    BinaryRoseTree.empty
                    (BinaryRoseTree.createTree "d" (BinaryRoseTree.createForest "c" BinaryRoseTree.empty (BinaryRoseTree.singleton "e"))))

                (BinaryRoseTree.createTree "g" (BinaryRoseTree.createTree "i" (BinaryRoseTree.singleton "h"))))

    [<Tests>]
    let testBinaryRoseTree =

        testList "Experimental BinaryRoseTree" [ test "preOrder works" {
