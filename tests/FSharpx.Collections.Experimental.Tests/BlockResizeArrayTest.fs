...
module BlockResizeArrayTest =
            ...
            [
              ...
              test "fold performance" {
                  ...
                  averageTime testIters "BlockResizeArray fold" (fun () ->
                      (FSharpx.Collections.Experimental.BlockResizeArray.fold (fun x acc -> acc + x * 2UL) 0UL bra))
              }
    ...
    let testBlockResizeArrayPropeerties =
        testList
            "Experimental BlockResizeArray properties"
            [
