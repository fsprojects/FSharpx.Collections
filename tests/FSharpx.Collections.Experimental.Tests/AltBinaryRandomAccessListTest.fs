...
module AltBinaryRandomAccessListTest =
    ...
    let testAltBinaryRandomAccessList =
        ...
        testList
            "Experimental AltBinaryRandomAccessList"
            [ test "AltBinaryRandomAccessList.empty list should be AltBinaryRandomAccessList.empty" {
              ...
              test "AltBinaryRandomAccessList.lookup length 1" { len1 |> AltBinaryRandomAccessList.lookup 0 |> Expect.equal "" "a" }

              test "AltBinaryRandomAccessList.rev AltBinaryRandomAccessList.empty" {
                  AltBinaryRandomAccessList.isEmpty(AltBinaryRandomAccessList.empty |> AltBinaryRandomAccessList.rev)
                  |> Expect.isTrue ""
              }
              ...
              test "AltBinaryRandomAccessList.append 2 AltBinaryRandomAccessList.empty lists" {
                  AltBinaryRandomAccessList.isEmpty(AltBinaryRandomAccessList.append AltBinaryRandomAccessList.empty AltBinaryRandomAccessList.empty)
                  |> Expect.isTrue ""
              }
              ...
              test "AltBinaryRandomAccessList.tryLookup not found" { lena |> AltBinaryRandomAccessList.tryLookup 10 |> Expect.isNone "" }
              ...
              test "ofSeq" {
                  let x =
                      AltBinaryRandomAccessList.ofSeq [ "a"; "b"; "c"; "d"; "e"; "f"; "g"; "h"; "i"; "j" ]
