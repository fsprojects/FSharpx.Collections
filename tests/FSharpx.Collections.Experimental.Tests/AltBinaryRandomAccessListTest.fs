...
module AltBinaryRandomAccessListTest =
    ...
    let testAltBinaryRandomAccessList =
        ...
        testList "Experimental AltBinaryRandomAccessList" [
            ...
            test "cons works" {
                empty |> cons 1 |> cons 2 |> isEmpty |> Expect.isFalse "" }
            ...
            test "tryUncons empty" {
                empty |> tryUncons |> Expect.isNone "" }
    
            test "head should return" {
                empty |> cons 1 |> cons 2 |> head |> Expect.equal "" 2 } 

            test "tryGetHead should return" {
            ...
            test "tryGetTail on len 1 should return Some empty" {
                ...
                x |> isEmpty |> Expect.isTrue "" }

            test "tail on len 2 should return" {
                empty |> cons 1 |>  cons 2 |> tail |> head |> Expect.equal "" 1 } 

            test "tryGetTail on len 2 should return" {
                let a = empty |> cons 1 |>  cons 2 |> tryGetTail 
                ((head a.Value) = 1) |> Expect.isTrue "" }
            ...
            test "append 2 empty lists" {
                isEmpty (append empty empty) |> Expect.isTrue "" }

            test "append left empty right 5" {
                let a = 
            ...
            test "append left 6 right empty" {
                let a = 
            ...
            test "update length 1" {
                len1 |> update 0 "aa"|> lookup 0 |> Expect.equal "" "aa" } 

            test "update length 2" {
                (((len2 |> update 0 "bb"|> lookup 0) = "bb") && ((len2 |> update 1 "aa"|> lookup 1) = "aa")) |> Expect.isTrue "" }

            test "update length 3" {
                (((len3 |> update 0 "cc"|> lookup 0) = "cc") && ((len3 |> update 1 "bb"|> lookup 1) = "bb") 
                && ((len3 |> update 2 "aa"|> lookup 2) = "aa")) |> Expect.isTrue "" }
            ...
            test "update length 5" {
                ...
                && ((len5 |> update 4 "aa"|> lookup 4) = "aa")) |> Expect.isTrue "" }
            ...
            test "update length 6" {
                ...
                && ((len6 |> update 4 "bb"|> lookup 4) = "bb") && ((len6 |> update 5 "aa"|> lookup 5) = "aa")) |> Expect.isTrue "" }
            ...
            test "update length 7" {
                ...
                && ((len7 |> update 6 "aa"|> lookup 6) = "aa")) |> Expect.isTrue "" }
            ...
            test "update length 9" {
                ...
                && ((len9 |> update 8 "aa"|> lookup 8) = "aa")) |> Expect.isTrue "" }
            ...
            test "update length 10" {
                ...
                && ((lena |> update 8 "bb"|> lookup 8) = "bb") && ((lena |> update 9 "aa"|> lookup 9) = "aa")) |> Expect.isTrue "" }

            test "tryUpdate length 1" {
                let a = len1 |> tryUpdate 0 "aa"
                ((a.Value |> lookup 0) = "aa") |> Expect.isTrue "" }

            test "tryUpdate length 2" {
                let b = len2 |> tryUpdate 0 "bb"
                let a = len2 |> tryUpdate 1 "aa"
                (((b.Value |> lookup 0) = "bb") && ((a.Value |> lookup 1) = "aa")) |> Expect.isTrue "" }

            test "tryUpdate length 3" {
                let c = len3 |> tryUpdate 0 "cc"
                let b = len3 |> tryUpdate 1 "bb"
                let a = len3 |> tryUpdate 2 "aa"
                (((c.Value |> lookup 0) = "cc") && ((b.Value |> lookup 1) = "bb") && ((a.Value |> lookup 2) = "aa")) |> Expect.isTrue "" }
            ...
            test "tryUpdate length 4" {
                ...
                && ((a.Value |> lookup 3) = "aa")) |> Expect.isTrue "" } 
            ...
            test "tryUpdate length 5" {
                ...
                && ((b.Value |> lookup 3) = "bb") && ((a.Value |> lookup 4) = "aa")) |> Expect.isTrue "" }
            ...
            test "tryUpdate length 7" {
                ...
                && ((a.Value |> lookup 6) = "aa")) |> Expect.isTrue "" }
            ...
            test "tryUpdate length 8" {
                ...
                && ((b.Value |> lookup 6) = "bb")&& ((a.Value |> lookup 7) = "aa")) |> Expect.isTrue "" }
            ...
            test "tryUpdate length 9" {
                ...
                && ((c.Value |> lookup 6) = "cc") && ((b.Value |> lookup 7) = "bb")&& ((a.Value |> lookup 8) = "aa")) |> Expect.isTrue "" }
            ...
            test "tryUpdate length 10" {
                ...
                && ((a.Value |> lookup 9) = "aa")) |> Expect.isTrue "" }

            test "remove elements length 1" {
                isEmpty (len1 |> remove 0) |> Expect.isTrue "" }
            ...
            test "remove elements length 10" {
                let a = 
            ...
            test "tryRemove elements length 7" {
                let a = 
            ...
            test "tryRemove elements length 8" {
                let a = 
            ...
            test "tryRemove elements length 9" {
                let a = 
            ...
            test "tryRemove elements length 10" {
                let a = 
            ...
            test "length of 1 - 10 good" {
                ...
                && ((length len9) = 9) && ((length lena) = 10)) |> Expect.isTrue "" }
            ...
            test "ofSeq" {
                ...
                && ((x |> lookup 8) = "i") && ((x |> lookup 9) = "j")) |> Expect.isTrue "" }

            test "IRandomAccessList cons works" {
