    ...
    let testAltBinaryRandomAccessList =
        ...
        testList "Experimental AltBinaryRandomAccessList" [
            ...
            test "AltBinaryRandomAccessList.append 2 AltBinaryRandomAccessList.empty lists" {
                AltBinaryRandomAccessList.isEmpty (AltBinaryRandomAccessList.append AltBinaryRandomAccessList.empty AltBinaryRandomAccessList.empty) |> Expect.isTrue "" }
            ...
            test "AltBinaryRandomAccessList.append left 6 right3" {
                let a = 
                    match (AltBinaryRandomAccessList.append len6 (AltBinaryRandomAccessList.empty |> AltBinaryRandomAccessList.cons "3" |> AltBinaryRandomAccessList.cons "2" |> AltBinaryRandomAccessList.cons "1")) with
            ...
            test "AltBinaryRandomAccessList.lookup length 2" {
                (((len2 |> AltBinaryRandomAccessList.lookup 0) = "b") && ((len2 |> AltBinaryRandomAccessList.lookup 1) = "a")) |> Expect.isTrue "" }

            test "AltBinaryRandomAccessList.lookup length 3" {
                (((len3 |> AltBinaryRandomAccessList.lookup 0) = "c") && ((len3 |> AltBinaryRandomAccessList.lookup 1) = "b") && ((len3 |> AltBinaryRandomAccessList.lookup 2) = "a")) |> Expect.isTrue "" }

            test "AltBinaryRandomAccessList.lookup length 4" {
                (((len4 |> AltBinaryRandomAccessList.lookup 0) = "d") && ((len4 |> AltBinaryRandomAccessList.lookup 1) = "c") && ((len4 |> AltBinaryRandomAccessList.lookup 2) = "b") && ((len4 |> AltBinaryRandomAccessList.lookup 3) = "a")) 
                |> Expect.isTrue "" }

            test "AltBinaryRandomAccessList.lookup length 5" {
                (((len5 |> AltBinaryRandomAccessList.lookup 0) = "e") && ((len5 |> AltBinaryRandomAccessList.lookup 1) = "d") && ((len5 |> AltBinaryRandomAccessList.lookup 2) = "c") && ((len5 |> AltBinaryRandomAccessList.lookup 3) = "b") 
                && ((len5 |> AltBinaryRandomAccessList.lookup 4) = "a")) |> Expect.isTrue "" }

            test "AltBinaryRandomAccessList.lookup length 6" {
                (((len6 |> AltBinaryRandomAccessList.lookup 0) = "f") && ((len6 |> AltBinaryRandomAccessList.lookup 1) = "e") && ((len6 |> AltBinaryRandomAccessList.lookup 2) = "d") && ((len6 |> AltBinaryRandomAccessList.lookup 3) = "c") 
                && ((len6 |> AltBinaryRandomAccessList.lookup 4) = "b") && ((len6 |> AltBinaryRandomAccessList.lookup 5) = "a")) |> Expect.isTrue "" }

            test "AltBinaryRandomAccessList.lookup length 7" {
                (((len7 |> AltBinaryRandomAccessList.lookup 0) = "g") && ((len7 |> AltBinaryRandomAccessList.lookup 1) = "f") && ((len7 |> AltBinaryRandomAccessList.lookup 2) = "e") && ((len7 |> AltBinaryRandomAccessList.lookup 3) = "d") 
                && ((len7 |> AltBinaryRandomAccessList.lookup 4) = "c") && ((len7 |> AltBinaryRandomAccessList.lookup 5) = "b") && ((len7 |> AltBinaryRandomAccessList.lookup 6) = "a")) |> Expect.isTrue "" }

            test "AltBinaryRandomAccessList.lookup length 8" {
                (((len8 |> AltBinaryRandomAccessList.lookup 0) = "h") && ((len8 |> AltBinaryRandomAccessList.lookup 1) = "g") && ((len8 |> AltBinaryRandomAccessList.lookup 2) = "f") && ((len8 |> AltBinaryRandomAccessList.lookup 3) = "e") 
                && ((len8 |> AltBinaryRandomAccessList.lookup 4) = "d") && ((len8 |> AltBinaryRandomAccessList.lookup 5) = "c") && ((len8 |> AltBinaryRandomAccessList.lookup 6) = "b") && ((len8 |> AltBinaryRandomAccessList.lookup 7) = "a")) 
                |> Expect.isTrue "" }

            test "AltBinaryRandomAccessList.lookup length 9" {
                (((len9 |> AltBinaryRandomAccessList.lookup 0) = "i") && ((len9 |> AltBinaryRandomAccessList.lookup 1) = "h") && ((len9 |> AltBinaryRandomAccessList.lookup 2) = "g") && ((len9 |> AltBinaryRandomAccessList.lookup 3) = "f") 
                && ((len9 |> AltBinaryRandomAccessList.lookup 4) = "e") && ((len9 |> AltBinaryRandomAccessList.lookup 5) = "d") && ((len9 |> AltBinaryRandomAccessList.lookup 6) = "c") && ((len9 |> AltBinaryRandomAccessList.lookup 7) = "b")
                && ((len9 |> AltBinaryRandomAccessList.lookup 8) = "a")) |> Expect.isTrue "" }

            test "AltBinaryRandomAccessList.lookup length 10" {
                (((lena |> AltBinaryRandomAccessList.lookup 0) = "j") && ((lena |> AltBinaryRandomAccessList.lookup 1) = "i") && ((lena |> AltBinaryRandomAccessList.lookup 2) = "h") && ((lena |> AltBinaryRandomAccessList.lookup 3) = "g") 
                && ((lena |> AltBinaryRandomAccessList.lookup 4) = "f") && ((lena |> AltBinaryRandomAccessList.lookup 5) = "e") && ((lena |> AltBinaryRandomAccessList.lookup 6) = "d") && ((lena |> AltBinaryRandomAccessList.lookup 7) = "c")
                && ((lena |> AltBinaryRandomAccessList.lookup 8) = "b") && ((lena |> AltBinaryRandomAccessList.lookup 9) = "a")) |> Expect.isTrue "" }
            ...
            test "AltBinaryRandomAccessList.update length 1" {
                len1 |> AltBinaryRandomAccessList.update 0 "aa"|> AltBinaryRandomAccessList.lookup 0 |> Expect.equal "" "aa" } 

            test "AltBinaryRandomAccessList.update length 2" {
                (((len2 |> AltBinaryRandomAccessList.update 0 "bb"|> AltBinaryRandomAccessList.lookup 0) = "bb") && ((len2 |> AltBinaryRandomAccessList.update 1 "aa"|> AltBinaryRandomAccessList.lookup 1) = "aa")) |> Expect.isTrue "" }

            test "AltBinaryRandomAccessList.update length 3" {
                (((len3 |> AltBinaryRandomAccessList.update 0 "cc"|> AltBinaryRandomAccessList.lookup 0) = "cc") && ((len3 |> AltBinaryRandomAccessList.update 1 "bb"|> AltBinaryRandomAccessList.lookup 1) = "bb") 
                && ((len3 |> AltBinaryRandomAccessList.update 2 "aa"|> AltBinaryRandomAccessList.lookup 2) = "aa")) |> Expect.isTrue "" }

            test "AltBinaryRandomAccessList.update length 4" {
                (((len4 |> AltBinaryRandomAccessList.update 0 "dd"|> AltBinaryRandomAccessList.lookup 0) = "dd") && ((len4 |> AltBinaryRandomAccessList.update 1 "cc"|> AltBinaryRandomAccessList.lookup 1) = "cc") 
                && ((len4 |> AltBinaryRandomAccessList.update 2 "bb"|> AltBinaryRandomAccessList.lookup 2) = "bb") && ((len4 |> AltBinaryRandomAccessList.update 3 "aa"|> AltBinaryRandomAccessList.lookup 3) = "aa")) 
                |> Expect.isTrue "" }

            test "AltBinaryRandomAccessList.update length 5" {
                (((len5 |> AltBinaryRandomAccessList.update 0 "ee"|> AltBinaryRandomAccessList.lookup 0) = "ee") && ((len5 |> AltBinaryRandomAccessList.update 1 "dd"|> AltBinaryRandomAccessList.lookup 1) = "dd") 
                && ((len5 |> AltBinaryRandomAccessList.update 2 "cc"|> AltBinaryRandomAccessList.lookup 2) = "cc") && ((len5 |> AltBinaryRandomAccessList.update 3 "bb"|> AltBinaryRandomAccessList.lookup 3) = "bb") 
                && ((len5 |> AltBinaryRandomAccessList.update 4 "aa"|> AltBinaryRandomAccessList.lookup 4) = "aa")) |> Expect.isTrue "" }

            test "AltBinaryRandomAccessList.update length 6" {
                (((len6 |> AltBinaryRandomAccessList.update 0 "ff"|> AltBinaryRandomAccessList.lookup 0) = "ff") && ((len6 |> AltBinaryRandomAccessList.update 1 "ee"|> AltBinaryRandomAccessList.lookup 1) = "ee") 
                && ((len6 |> AltBinaryRandomAccessList.update 2 "dd"|> AltBinaryRandomAccessList.lookup 2) = "dd") && ((len6 |> AltBinaryRandomAccessList.update 3 "cc"|> AltBinaryRandomAccessList.lookup 3) = "cc") 
                && ((len6 |> AltBinaryRandomAccessList.update 4 "bb"|> AltBinaryRandomAccessList.lookup 4) = "bb") && ((len6 |> AltBinaryRandomAccessList.update 5 "aa"|> AltBinaryRandomAccessList.lookup 5) = "aa")) |> Expect.isTrue "" }

            test "AltBinaryRandomAccessList.update length 7" {
                (((len7 |> AltBinaryRandomAccessList.update 0 "gg"|> AltBinaryRandomAccessList.lookup 0) = "gg") && ((len7 |> AltBinaryRandomAccessList.update 1 "ff"|> AltBinaryRandomAccessList.lookup 1) = "ff") 
                && ((len7 |> AltBinaryRandomAccessList.update 2 "ee"|> AltBinaryRandomAccessList.lookup 2) = "ee") && ((len7 |> AltBinaryRandomAccessList.update 3 "dd"|> AltBinaryRandomAccessList.lookup 3) = "dd") 
                && ((len7 |> AltBinaryRandomAccessList.update 4 "cc"|> AltBinaryRandomAccessList.lookup 4) = "cc") && ((len7 |> AltBinaryRandomAccessList.update 5 "bb"|> AltBinaryRandomAccessList.lookup 5) = "bb") 
                && ((len7 |> AltBinaryRandomAccessList.update 6 "aa"|> AltBinaryRandomAccessList.lookup 6) = "aa")) |> Expect.isTrue "" }

            test "AltBinaryRandomAccessList.update length 8" {
                (((len8 |> AltBinaryRandomAccessList.update 0 "hh"|> AltBinaryRandomAccessList.lookup 0) = "hh") && ((len8 |> AltBinaryRandomAccessList.update 1 "gg"|> AltBinaryRandomAccessList.lookup 1) = "gg") 
                && ((len8 |> AltBinaryRandomAccessList.update 2 "ff"|> AltBinaryRandomAccessList.lookup 2) = "ff") && ((len8 |> AltBinaryRandomAccessList.update 3 "ee"|> AltBinaryRandomAccessList.lookup 3) = "ee") 
                && ((len8 |> AltBinaryRandomAccessList.update 4 "dd"|> AltBinaryRandomAccessList.lookup 4) = "dd") && ((len8 |> AltBinaryRandomAccessList.update 5 "cc"|> AltBinaryRandomAccessList.lookup 5) = "cc") 
                && ((len8 |> AltBinaryRandomAccessList.update 6 "bb"|> AltBinaryRandomAccessList.lookup 6) = "bb") && ((len8 |> AltBinaryRandomAccessList.update 7 "aa"|> AltBinaryRandomAccessList.lookup 7) = "aa")) 
                |> Expect.isTrue "" }

            test "AltBinaryRandomAccessList.update length 9" {
                (((len9 |> AltBinaryRandomAccessList.update 0 "ii"|> AltBinaryRandomAccessList.lookup 0) = "ii") && ((len9 |> AltBinaryRandomAccessList.update 1 "hh"|> AltBinaryRandomAccessList.lookup 1) = "hh") 
                && ((len9 |> AltBinaryRandomAccessList.update 2 "gg"|> AltBinaryRandomAccessList.lookup 2) = "gg") && ((len9 |> AltBinaryRandomAccessList.update 3 "ff"|> AltBinaryRandomAccessList.lookup 3) = "ff") 
                && ((len9 |> AltBinaryRandomAccessList.update 4 "ee"|> AltBinaryRandomAccessList.lookup 4) = "ee") && ((len9 |> AltBinaryRandomAccessList.update 5 "dd"|> AltBinaryRandomAccessList.lookup 5) = "dd") 
                && ((len9 |> AltBinaryRandomAccessList.update 6 "cc"|> AltBinaryRandomAccessList.lookup 6) = "cc") && ((len9 |> AltBinaryRandomAccessList.update 7 "bb"|> AltBinaryRandomAccessList.lookup 7) = "bb")
                && ((len9 |> AltBinaryRandomAccessList.update 8 "aa"|> AltBinaryRandomAccessList.lookup 8) = "aa")) |> Expect.isTrue "" }

            test "AltBinaryRandomAccessList.update length 10" {
                (((lena |> AltBinaryRandomAccessList.update 0 "jj"|> AltBinaryRandomAccessList.lookup 0) = "jj") && ((lena |> AltBinaryRandomAccessList.update 1 "ii"|> AltBinaryRandomAccessList.lookup 1) = "ii") 
                && ((lena |> AltBinaryRandomAccessList.update 2 "hh"|> AltBinaryRandomAccessList.lookup 2) = "hh") && ((lena |> AltBinaryRandomAccessList.update 3 "gg"|> AltBinaryRandomAccessList.lookup 3) = "gg") 
                && ((lena |> AltBinaryRandomAccessList.update 4 "ff"|> AltBinaryRandomAccessList.lookup 4) = "ff") && ((lena |> AltBinaryRandomAccessList.update 5 "ee"|> AltBinaryRandomAccessList.lookup 5) = "ee") 
                && ((lena |> AltBinaryRandomAccessList.update 6 "dd"|> AltBinaryRandomAccessList.lookup 6) = "dd") && ((lena |> AltBinaryRandomAccessList.update 7 "cc"|> AltBinaryRandomAccessList.lookup 7) = "cc")
                && ((lena |> AltBinaryRandomAccessList.update 8 "bb"|> AltBinaryRandomAccessList.lookup 8) = "bb") && ((lena |> AltBinaryRandomAccessList.update 9 "aa"|> AltBinaryRandomAccessList.lookup 9) = "aa")) |> Expect.isTrue "" }

            test "AltBinaryRandomAccessList.tryUpdate length 1" {
                let a = len1 |> AltBinaryRandomAccessList.tryUpdate 0 "aa"
                ((a.Value |> AltBinaryRandomAccessList.lookup 0) = "aa") |> Expect.isTrue "" }
            ...
            test "AltBinaryRandomAccessList.tryUpdate length 2" {
                ...
                (((b.Value |> AltBinaryRandomAccessList.lookup 0) = "bb") && ((a.Value |> AltBinaryRandomAccessList.lookup 1) = "aa")) |> Expect.isTrue "" }
            ...
            test "AltBinaryRandomAccessList.tryUpdate length 3" {
                ...
                (((c.Value |> AltBinaryRandomAccessList.lookup 0) = "cc") && ((b.Value |> AltBinaryRandomAccessList.lookup 1) = "bb") && ((a.Value |> AltBinaryRandomAccessList.lookup 2) = "aa")) |> Expect.isTrue "" }
            ...
            test "AltBinaryRandomAccessList.tryUpdate length 4" {
                ...
                (((d.Value |> AltBinaryRandomAccessList.lookup 0) = "dd") && ((c.Value |> AltBinaryRandomAccessList.lookup 1) = "cc") && ((b.Value |> AltBinaryRandomAccessList.lookup 2) = "bb") 
                && ((a.Value |> AltBinaryRandomAccessList.lookup 3) = "aa")) |> Expect.isTrue "" } 
            ...
            test "AltBinaryRandomAccessList.tryUpdate length 5" {
                ...
                (((e.Value |> AltBinaryRandomAccessList.lookup 0) = "ee") && ((d.Value |> AltBinaryRandomAccessList.lookup 1) = "dd") && ((c.Value |> AltBinaryRandomAccessList.lookup 2) = "cc") 
                && ((b.Value |> AltBinaryRandomAccessList.lookup 3) = "bb") && ((a.Value |> AltBinaryRandomAccessList.lookup 4) = "aa")) |> Expect.isTrue "" }
            ...
            test "AltBinaryRandomAccessList.tryUpdate length 6" {
                ...
                (((f.Value |> AltBinaryRandomAccessList.lookup 0) = "ff") && ((e.Value |> AltBinaryRandomAccessList.lookup 1) = "ee") && ((d.Value |> AltBinaryRandomAccessList.lookup 2) = "dd") 
                && ((c.Value |> AltBinaryRandomAccessList.lookup 3) = "cc") && ((b.Value |> AltBinaryRandomAccessList.lookup 4) = "bb") && ((a.Value |> AltBinaryRandomAccessList.lookup 5) = "aa")) 
                |> Expect.isTrue "" }
            ...
            test "AltBinaryRandomAccessList.tryUpdate length 7" {
                ...
                (((g.Value |> AltBinaryRandomAccessList.lookup 0) = "gg") && ((f.Value |> AltBinaryRandomAccessList.lookup 1) = "ff") && ((e.Value |> AltBinaryRandomAccessList.lookup 2) = "ee") 
                && ((d.Value |> AltBinaryRandomAccessList.lookup 3) = "dd") && ((c.Value |> AltBinaryRandomAccessList.lookup 4) = "cc") && ((b.Value |> AltBinaryRandomAccessList.lookup 5) = "bb") 
                && ((a.Value |> AltBinaryRandomAccessList.lookup 6) = "aa")) |> Expect.isTrue "" }
            ...
            test "AltBinaryRandomAccessList.tryUpdate length 8" {
                ...
                (((h.Value |> AltBinaryRandomAccessList.lookup 0) = "hh") && ((g.Value |> AltBinaryRandomAccessList.lookup 1) = "gg") && ((f.Value |> AltBinaryRandomAccessList.lookup 2) = "ff") 
                && ((e.Value |> AltBinaryRandomAccessList.lookup 3) = "ee") && ((d.Value |> AltBinaryRandomAccessList.lookup 4) = "dd") && ((c.Value |> AltBinaryRandomAccessList.lookup 5) = "cc")  
                && ((b.Value |> AltBinaryRandomAccessList.lookup 6) = "bb")&& ((a.Value |> AltBinaryRandomAccessList.lookup 7) = "aa")) |> Expect.isTrue "" }
            ...
            test "AltBinaryRandomAccessList.tryUpdate length 9" {
                ...
                (((i.Value |> AltBinaryRandomAccessList.lookup 0) = "ii") && ((h.Value |> AltBinaryRandomAccessList.lookup 1) = "hh") && ((g.Value |> AltBinaryRandomAccessList.lookup 2) = "gg") 
                && ((f.Value |> AltBinaryRandomAccessList.lookup 3) = "ff") && ((e.Value |> AltBinaryRandomAccessList.lookup 4) = "ee") && ((d.Value |> AltBinaryRandomAccessList.lookup 5) = "dd") 
                && ((c.Value |> AltBinaryRandomAccessList.lookup 6) = "cc") && ((b.Value |> AltBinaryRandomAccessList.lookup 7) = "bb")&& ((a.Value |> AltBinaryRandomAccessList.lookup 8) = "aa")) |> Expect.isTrue "" }
            ...
            test "AltBinaryRandomAccessList.tryUpdate length 10" {
                ...
                (((j.Value |> AltBinaryRandomAccessList.lookup 0) = "jj") && ((i.Value |> AltBinaryRandomAccessList.lookup 1) = "ii") && ((h.Value |> AltBinaryRandomAccessList.lookup 2) = "hh") 
                && ((g.Value |> AltBinaryRandomAccessList.lookup 3) = "gg") && ((f.Value |> AltBinaryRandomAccessList.lookup 4) = "ff") && ((e.Value |> AltBinaryRandomAccessList.lookup 5) = "ee") 
                && ((d.Value |> AltBinaryRandomAccessList.lookup 6) = "dd") && ((c.Value |> AltBinaryRandomAccessList.lookup 7) = "cc") && ((b.Value |> AltBinaryRandomAccessList.lookup 8) = "bb")
                && ((a.Value |> AltBinaryRandomAccessList.lookup 9) = "aa")) |> Expect.isTrue "" }

            test "AltBinaryRandomAccessList.remove elements length 1" {
                AltBinaryRandomAccessList.isEmpty (len1 |> AltBinaryRandomAccessList.remove 0) |> Expect.isTrue "" }
            ...
            test "length of AltBinaryRandomAccessList.empty is 0" {
                ((AltBinaryRandomAccessList.length AltBinaryRandomAccessList.empty) = 0) |> Expect.isTrue "" }

            test "length of 1 - 10 good" {
                (((AltBinaryRandomAccessList.length len1) = 1) && ((AltBinaryRandomAccessList.length len2) = 2) && ((AltBinaryRandomAccessList.length len3) = 3) && ((AltBinaryRandomAccessList.length len4) = 4) 
                && ((AltBinaryRandomAccessList.length len5) = 5) && ((AltBinaryRandomAccessList.length len6) = 6) && ((AltBinaryRandomAccessList.length len7) = 7) && ((AltBinaryRandomAccessList.length len8) = 8) 
                && ((AltBinaryRandomAccessList.length len9) = 9) && ((AltBinaryRandomAccessList.length lena) = 10)) |> Expect.isTrue "" }

            test "ofSeq" {
                let x = AltBinaryRandomAccessList.ofSeq ["a";"b";"c";"d";"e";"f";"g";"h";"i";"j"]

                (((x |> AltBinaryRandomAccessList.lookup 0) = "a") && ((x |> AltBinaryRandomAccessList.lookup 1) = "b") && ((x |> AltBinaryRandomAccessList.lookup 2) = "c") && ((x |> AltBinaryRandomAccessList.lookup 3) = "d") 
                && ((x |> AltBinaryRandomAccessList.lookup 4) = "e") && ((x |> AltBinaryRandomAccessList.lookup 5) = "f") && ((x |> AltBinaryRandomAccessList.lookup 6) = "g") && ((x |> AltBinaryRandomAccessList.lookup 7) = "h")
                && ((x |> AltBinaryRandomAccessList.lookup 8) = "i") && ((x |> AltBinaryRandomAccessList.lookup 9) = "j")) |> Expect.isTrue "" }
