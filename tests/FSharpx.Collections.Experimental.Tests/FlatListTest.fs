...
module FlatListTest =
    ...
    let testFlatListProperties =
        ...
        testList "Experimental FlatList Properties" [ testPropertyWithConfig
                                                          config10k
                                                      ...
                                                      testPropertyWithConfig
                                                          ...
                                                          (Prop.forAll(Arb.fromGen flatlistIntGen)
                                                           <| fun (v, l) ->
                                                               v |> FlatList.exists(fun elem -> elem = 6) = (l
                                                                                                             |> Array.ofList
                                                      ...
                                                      testPropertyWithConfig
                                                          ...
                                                          (Prop.forAll(Arb.fromGen flatlistIntGen)
                                                           <| fun (v, l) ->
                                                               v |> FlatList.fold (fun (l': int list) (elem: int) -> elem :: l') [] = (List.rev l))
                                                      ...
                                                      testPropertyWithConfig
                                                          ...
                                                          (Prop.forAll(Arb.fromGen flatlistObjGen)
                                                           <| fun (v, l) ->
                                                               v |> FlatList.fold (fun (l': obj list) (elem: obj) -> elem :: l') [] = (List.rev l))
                                                      ...
                                                      testPropertyWithConfig
                                                          ...
                                                          (Prop.forAll(Arb.fromGen flatlistStringGen)
                                                           <| fun (v, l) ->
                                                               FlatList.foldBack (fun (elem: string) (l': string list) -> elem :: l') v [] = l)
                                                      ...
                                                      testPropertyWithConfig
                                                          ...
                                                          (Prop.forAll(Arb.fromGen flatlistStringGen)
                                                           <| fun (v, l) ->
                                                               let stringFun =
                                                                   fun (elem1: string) (elem2: string) (l': (string * string) list) ->
                                                                       (elem1, elem2) :: l'
                                                      ...
                                                      testPropertyWithConfig
                                                          ...
                                                          (Prop.forAll(Arb.fromGen flatlistIntGen)
                                                           <| fun (v, l) ->
                                                               FlatList.forall2 (fun (elem1: int) (elem2: int) -> (elem1 < 1000 && elem2 < 1000)) v v = true)
