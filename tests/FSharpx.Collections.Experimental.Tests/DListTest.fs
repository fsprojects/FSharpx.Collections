...
module DListTest =
    ...
    let testDList =
        ...
        testList "Experimental DList" [ test "test should verify DList.empty is Nil" { DList.empty<_> |> Expect.equal "" DList.Nil }
                                        ...
                                        test "test tail should return all items except the head" {
                                            ...
                                            |> Expect.equal
                                                ""
                                                (Join(DList.cons 1 (DList.cons 2 (DList.cons 3 (DList.cons 4 DList.empty))), expected, 9))
                                        }
