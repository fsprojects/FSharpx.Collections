...
module HeapPriorityQueueTest =
    ...
    let testHeapPriorityQueue =
        ...
        testList "Experimental HeapPriorityQueue" [
            test "HeapPriorityQueue.empty queue should be HeapPriorityQueue.empty" {
            ...
            test "Adding multiple elements to the PQ should allow to HeapPriorityQueue.pop the smallest" {
                let pq = HeapPriorityQueue.empty false |> HeapPriorityQueue.insert 1 |> HeapPriorityQueue.insert 3 |> HeapPriorityQueue.insert 0 |> HeapPriorityQueue.insert 4 |> HeapPriorityQueue.insert -3
            ...
            test "Adding multiple elements to a MaxPriorityQueue should allow to HeapPriorityQueue.pop the smallest" {
                let pq = HeapPriorityQueue.empty true |> HeapPriorityQueue.insert 1 |> HeapPriorityQueue.insert 3 |> HeapPriorityQueue.insert 0 |> HeapPriorityQueue.insert 4 |> HeapPriorityQueue.insert -3
            ...
            test "Can use a PQ as a seq" {
                let pq = HeapPriorityQueue.empty false |> HeapPriorityQueue.insert 15 |> HeapPriorityQueue.insert 3 |> HeapPriorityQueue.insert 0 |> HeapPriorityQueue.insert 4 |> HeapPriorityQueue.insert -3
