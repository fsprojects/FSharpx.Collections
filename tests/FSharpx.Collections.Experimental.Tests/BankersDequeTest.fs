...
module BankersDequeTest =
    ...
    let len3snoc =
        BankersDeque.singleton "c"
        |> BankersDeque.snoc "b"
        |> BankersDeque.snoc "a"

    let len4snoc =
        BankersDeque.singleton "d"
        |> BankersDeque.snoc "c"
        |> BankersDeque.snoc "b"
        |> BankersDeque.snoc "a"

    let len5snoc =
        BankersDeque.singleton "e"
        |> BankersDeque.snoc "d"
        |> BankersDeque.snoc "c"
        |> BankersDeque.snoc "b"
        |> BankersDeque.snoc "a"
    ...
    let len2C3snoc =
        BankersDeque.empty 3 |> BankersDeque.snoc "b" |> BankersDeque.snoc "a"
        ...
        testList
            ...
            [ test "BankersDeque.empty dqueue should be BankersDeque.empty" {
              ...
              test "BankersDeque.cons works" {
                  ((len2 |> BankersDeque.isEmpty) && (len2C3 |> BankersDeque.isEmpty))
                  |> Expect.isFalse ""
              }

              test "BankersDeque.snoc works" {
                  ((len2snoc |> BankersDeque.isEmpty)
                   && (len2C3snoc |> BankersDeque.isEmpty))
                  |> Expect.isFalse ""
              }

              test "BankersDeque.singleton BankersDeque.head works" {
                  (((BankersDeque.head len1) = "a")
                   && ((len1C3 |> BankersDeque.isEmpty)) = false)
                  |> Expect.isTrue ""
              }

              test "BankersDeque.singleton BankersDeque.last works" { len1 |> BankersDeque.last |> Expect.equal "" "a" }
              ...
              test "BankersDeque.tail of BankersDeque.tail of 2 BankersDeque.empty" {
                  (len2 |> BankersDeque.tail |> BankersDeque.tail |> BankersDeque.isEmpty)
                  |> Expect.isTrue ""
              }
              ...
              test "BankersDeque.head, BankersDeque.tail, and BankersDeque.length work test 1" {
                  ...
                  (((BankersDeque.length t1) = 1)
                   && ((BankersDeque.length t1C) = 1)
                   && ((BankersDeque.length t1s) = 1)
                   && ((BankersDeque.length t1Cs) = 1)
                   && ((BankersDeque.head t1) = "a")
                   && ((BankersDeque.head t1C) = "a")
                   && ((BankersDeque.head t1s) = "a")
                   && ((BankersDeque.head t1Cs) = "a"))
                  |> Expect.isTrue ""
              }
              ...
              test "BankersDeque.head, BankersDeque.tail, and BankersDeque.length work test 2" {
                  ...
                  (((BankersDeque.length t1) = 2)
                   && ((BankersDeque.length t1C) = 2)
                   && ((BankersDeque.length t1s) = 2)
                   && ((BankersDeque.length t1Cs) = 2)
                   && ((BankersDeque.head t1) = "b")
                   && ((BankersDeque.head t1C) = "b")
                   && ((BankersDeque.head t1s) = "b")
                   && ((BankersDeque.head t1Cs) = "b")
                   && ((BankersDeque.length t1_1) = 1)
                   && ((BankersDeque.length t1C_1) = 1)
                   && ((BankersDeque.length t1_1s) = 1)
                   && ((BankersDeque.length t1C_1s) = 1)
                   && ((BankersDeque.head t1_1) = "a")
                   && ((BankersDeque.head t1C_1) = "a")
                   && ((BankersDeque.head t1_1s) = "a")
                   && ((BankersDeque.head t1C_1s) = "a"))
                  |> Expect.isTrue ""
              }
              ...
              test "BankersDeque.head, BankersDeque.tail, and BankersDeque.length work test 3" {
                  ...
                  (((BankersDeque.length t1) = 3)
                   && ((BankersDeque.length t1C) = 3)
                   && ((BankersDeque.length t1s) = 3)
                   && ((BankersDeque.length t1Cs) = 3)
                   && ((BankersDeque.head t1) = "c")
                   && ((BankersDeque.head t1C) = "c")
                   && ((BankersDeque.head t1s) = "c")
                   && ((BankersDeque.head t1Cs) = "c")
                   && ((BankersDeque.length t1_2) = 2)
                   && ((BankersDeque.length t1C_2) = 2)
                   && ((BankersDeque.length t1_2s) = 2)
                   && ((BankersDeque.length t1C_2s) = 2)
                   && ((BankersDeque.head t1_2) = "b")
                   && ((BankersDeque.head t1C_2) = "b")
                   && ((BankersDeque.head t1_2s) = "b")
                   && ((BankersDeque.head t1C_2s) = "b")
                   && ((BankersDeque.length t1_1) = 1)
                   && ((BankersDeque.length t1C_1) = 1)
                   && ((BankersDeque.length t1_1s) = 1)
                   && ((BankersDeque.length t1C_1s) = 1)
              ...
              test "BankersDeque.head, BankersDeque.tail, and BankersDeque.length work test 4" {
                  ...
                  (((BankersDeque.length t1) = 4)
                   && ((BankersDeque.length t1C) = 4)
                   && ((BankersDeque.length t1s) = 4)
                   && ((BankersDeque.length t1Cs) = 4)
                   && ((BankersDeque.head t1) = "d")
                   && ((BankersDeque.head t1C) = "d")
                   && ((BankersDeque.head t1s) = "d")
                   && ((BankersDeque.head t1Cs) = "d")
                   && ((BankersDeque.length t1_3) = 3)
                   && ((BankersDeque.length t1C_3) = 3)
                   && ((BankersDeque.length t1_3s) = 3)
                   && ((BankersDeque.length t1C_3s) = 3)
                   && ((BankersDeque.head t1_3) = "c")
                   && ((BankersDeque.head t1C_3) = "c")
                   && ((BankersDeque.head t1_3s) = "c")
                   && ((BankersDeque.head t1C_3s) = "c")
                   && ((BankersDeque.length t1_2) = 2)
                   && ((BankersDeque.length t1C_2) = 2)
                   && ((BankersDeque.length t1_2s) = 2)
                   && ((BankersDeque.length t1C_2s) = 2)
              ...
              test "BankersDeque.head, BankersDeque.tail, and BankersDeque.length work test 5" {
                  ...
                  (((BankersDeque.length t1) = 5)
                   && ((BankersDeque.length t1C) = 5)
                   && ((BankersDeque.length t1s) = 5)
                   && ((BankersDeque.length t1Cs) = 5)
                   && ((BankersDeque.head t1) = "e")
                   && ((BankersDeque.head t1C) = "e")
                   && ((BankersDeque.head t1s) = "e")
                   && ((BankersDeque.head t1Cs) = "e")
                   && ((BankersDeque.length t1_4) = 4)
                   && ((BankersDeque.length t1C_4) = 4)
                   && ((BankersDeque.length t1_4s) = 4)
                   && ((BankersDeque.length t1C_4s) = 4)
                   && ((BankersDeque.head t1_4) = "d")
                   && ((BankersDeque.head t1C_4) = "d")
                   && ((BankersDeque.head t1_4s) = "d")
                   && ((BankersDeque.head t1C_4s) = "d")
                   && ((BankersDeque.length t1_3) = 3)
                   && ((BankersDeque.length t1C_3) = 3)
                   && ((BankersDeque.length t1_3s) = 3)
                   && ((BankersDeque.length t1C_3s) = 3)
              ...
              test "BankersDeque.head, BankersDeque.tail, and BankersDeque.length work test 6" {
                  ...
                  (((BankersDeque.length t1) = 6)
                   && ((BankersDeque.length t1C) = 6)
                   && ((BankersDeque.length t1s) = 6)
                   && ((BankersDeque.length t1Cs) = 6)
                   && ((BankersDeque.head t1) = "f")
                   && ((BankersDeque.head t1C) = "f")
                   && ((BankersDeque.head t1s) = "f")
                   && ((BankersDeque.head t1Cs) = "f")
                   && ((BankersDeque.length t1_5) = 5)
                   && ((BankersDeque.length t1C_5) = 5)
                   && ((BankersDeque.length t1_5s) = 5)
                   && ((BankersDeque.length t1C_5s) = 5)
                   && ((BankersDeque.head t1_5) = "e")
                   && ((BankersDeque.head t1C_5) = "e")
                   && ((BankersDeque.head t1_5s) = "e")
                   && ((BankersDeque.head t1C_5s) = "e")
                   && ((BankersDeque.length t1_4) = 4)
                   && ((BankersDeque.length t1C_4) = 4)
                   && ((BankersDeque.length t1_4s) = 4)
                   && ((BankersDeque.length t1C_4s) = 4)
              ...
              test "BankersDeque.head, BankersDeque.tail, and BankersDeque.length work test 7" {
                  ...
                  (((BankersDeque.length t1) = 7)
                   && ((BankersDeque.length t1C) = 7)
                   && ((BankersDeque.length t1s) = 7)
                   && ((BankersDeque.length t1Cs) = 7)
                   && ((BankersDeque.head t1) = "g")
                   && ((BankersDeque.head t1C) = "g")
                   && ((BankersDeque.head t1s) = "g")
                   && ((BankersDeque.head t1Cs) = "g")
                   && ((BankersDeque.length t1_6) = 6)
                   && ((BankersDeque.length t1C_6) = 6)
                   && ((BankersDeque.length t1_6s) = 6)
                   && ((BankersDeque.length t1C_6s) = 6)
                   && ((BankersDeque.head t1_6) = "f")
                   && ((BankersDeque.head t1C_6) = "f")
                   && ((BankersDeque.head t1_6s) = "f")
                   && ((BankersDeque.head t1C_6s) = "f")
                   && ((BankersDeque.length t1_5) = 5)
                   && ((BankersDeque.length t1C_5) = 5)
                   && ((BankersDeque.length t1_5s) = 5)
                   && ((BankersDeque.length t1C_5s) = 5)
              ...
              test "BankersDeque.head, BankersDeque.tail, and BankersDeque.length work test 8" {
                  ...
                  (((BankersDeque.length t1) = 8)
                   && ((BankersDeque.length t1C) = 8)
                   && ((BankersDeque.length t1s) = 8)
                   && ((BankersDeque.length t1Cs) = 8)
                   && ((BankersDeque.head t1) = "h")
                   && ((BankersDeque.head t1C) = "h")
                   && ((BankersDeque.head t1s) = "h")
                   && ((BankersDeque.head t1Cs) = "h")
                   && ((BankersDeque.length t1_7) = 7)
                   && ((BankersDeque.length t1C_7) = 7)
                   && ((BankersDeque.length t1_7s) = 7)
                   && ((BankersDeque.length t1C_7s) = 7)
                   && ((BankersDeque.head t1_7) = "g")
                   && ((BankersDeque.head t1C_7) = "g")
                   && ((BankersDeque.head t1_7s) = "g")
                   && ((BankersDeque.head t1C_7s) = "g")
                   && ((BankersDeque.length t1_6) = 6)
                   && ((BankersDeque.length t1C_6) = 6)
                   && ((BankersDeque.length t1_6s) = 6)
                   && ((BankersDeque.length t1C_6s) = 6)
              ...
              test "BankersDeque.head, BankersDeque.tail, and BankersDeque.length work test 9" {
                  ...
                  (((BankersDeque.length t1) = 9)
                   && ((BankersDeque.length t1C) = 9)
                   && ((BankersDeque.length t1s) = 9)
                   && ((BankersDeque.length t1Cs) = 9)
                   && ((BankersDeque.head t1) = "i")
                   && ((BankersDeque.head t1C) = "i")
                   && ((BankersDeque.head t1s) = "i")
                   && ((BankersDeque.head t1Cs) = "i")
                   && ((BankersDeque.length t1_8) = 8)
                   && ((BankersDeque.length t1C_8) = 8)
                   && ((BankersDeque.length t1_8s) = 8)
                   && ((BankersDeque.length t1C_8s) = 8)
                   && ((BankersDeque.head t1_8) = "h")
                   && ((BankersDeque.head t1C_8) = "h")
                   && ((BankersDeque.head t1_8s) = "h")
                   && ((BankersDeque.head t1C_8s) = "h")
                   && ((BankersDeque.length t1_7) = 7)
                   && ((BankersDeque.length t1C_7) = 7)
                   && ((BankersDeque.length t1_7s) = 7)
                   && ((BankersDeque.length t1C_7s) = 7)
              ...
              test "BankersDeque.last, BankersDeque.init, and BankersDeque.length work test 1" {
                  ...
                  (((BankersDeque.length t1) = 1)
                   && ((BankersDeque.length t1C) = 1)
                   && ((BankersDeque.last t1) = "b")
                   && ((BankersDeque.last t1C) = "b"))
                  |> Expect.isTrue ""
              }
              ...
              test "BankersDeque.last, BankersDeque.init, and BankersDeque.length work test 2" {
                  ...
                  (((BankersDeque.length t1) = 2)
                   ...
                   && ((BankersDeque.length t1_1) = 1)
                   && ((BankersDeque.length t1C_1) = 1)
                   && ((BankersDeque.last t1_1) = "c")
                   && ((BankersDeque.last t1C_1) = "c"))
                  |> Expect.isTrue ""
              }
              ...
              test "BankersDeque.last, BankersDeque.init, and BankersDeque.length work test 3" {
                  ...
                  (((BankersDeque.length t1) = 3)
                   ...
                   && ((BankersDeque.last t1) = "b")
                   && ((BankersDeque.last t1C) = "b")
                   && ((BankersDeque.length t1_1) = 2)
                   && ((BankersDeque.length t1C_1) = 2)
                   && ((BankersDeque.last t1_1) = "c")
                   && ((BankersDeque.last t1C_1) = "c")
                   && ((BankersDeque.length t1_2) = 1)
                   && ((BankersDeque.length t1C_2) = 1)
                   && ((BankersDeque.last t1_2) = "d")
                   && ((BankersDeque.last t1C_2) = "d"))
                  |> Expect.isTrue ""
              }
              ...
              test "BankersDeque.last, BankersDeque.init, and BankersDeque.length work test 4" {
                  ...
                  (((BankersDeque.length t1) = 4)
                   ...
                   && ((BankersDeque.last t1) = "b")
                   && ((BankersDeque.last t1C) = "b")
                   && ((BankersDeque.length t1_1) = 3)
                   && ((BankersDeque.length t1C_1) = 3)
                   && ((BankersDeque.last t1_1) = "c")
                   && ((BankersDeque.last t1C_1) = "c")
                   && ((BankersDeque.length t1_2) = 2)
                   && ((BankersDeque.length t1C_2) = 2)
                   && ((BankersDeque.last t1_2) = "d")
                   && ((BankersDeque.last t1C_2) = "d")
                   && ((BankersDeque.length t1_3) = 1)
                   && ((BankersDeque.length t1C_3) = 1)
                   && ((BankersDeque.last t1_3) = "e")
                   && ((BankersDeque.last t1C_3) = "e"))
                  |> Expect.isTrue ""
              }
              ...
              test "BankersDeque.last, BankersDeque.init, and BankersDeque.length work test 5" {
                  ...
                  (((BankersDeque.length t1) = 5)
                   ...
                   && ((BankersDeque.last t1) = "b")
                   && ((BankersDeque.last t1C) = "b")
                   && ((BankersDeque.length t1_1) = 4)
                   && ((BankersDeque.length t1C_1) = 4)
                   && ((BankersDeque.last t1_1) = "c")
                   && ((BankersDeque.last t1C_1) = "c")
                   && ((BankersDeque.length t1_2) = 3)
                   && ((BankersDeque.length t1C_2) = 3)
                   && ((BankersDeque.last t1_2) = "d")
                   && ((BankersDeque.last t1C_2) = "d")
                   && ((BankersDeque.length t1_3) = 2)
                   && ((BankersDeque.length t1C_3) = 2)
                   && ((BankersDeque.last t1_3) = "e")
                   && ((BankersDeque.last t1C_3) = "e")
                   && ((BankersDeque.length t1_4) = 1)
                   && ((BankersDeque.length t1C_4) = 1)
                   && ((BankersDeque.last t1_4) = "f")
                   && ((BankersDeque.last t1C_4) = "f"))
                  |> Expect.isTrue ""
              }
              ...
              test "BankersDeque.last, BankersDeque.init, and BankersDeque.length work test 6" {
                  ...
                  (((BankersDeque.length t1) = 6)
                   ...
                   && ((BankersDeque.last t1) = "b")
                   && ((BankersDeque.last t1C) = "b")
                   && ((BankersDeque.length t1_1) = 5)
                   && ((BankersDeque.length t1C_1) = 5)
                   && ((BankersDeque.last t1_1) = "c")
                   && ((BankersDeque.last t1C_1) = "c")
                   && ((BankersDeque.length t1_2) = 4)
                   && ((BankersDeque.length t1C_2) = 4)
                   && ((BankersDeque.last t1_2) = "d")
                   && ((BankersDeque.last t1C_2) = "d")
                   && ((BankersDeque.length t1_3) = 3)
                   && ((BankersDeque.length t1C_3) = 3)
                   && ((BankersDeque.last t1_3) = "e")
                   && ((BankersDeque.last t1C_3) = "e")
                   && ((BankersDeque.length t1_4) = 2)
                   && ((BankersDeque.length t1C_4) = 2)
                   && ((BankersDeque.last t1_4) = "f")
                   && ((BankersDeque.last t1C_4) = "f")
                   && ((BankersDeque.length t1_5) = 1)
                   && ((BankersDeque.length t1C_5) = 1)
                   && ((BankersDeque.last t1_5) = "g")
                   && ((BankersDeque.last t1C_5) = "g"))
                  |> Expect.isTrue ""
              }
              ...
              test "BankersDeque.last, BankersDeque.init, and BankersDeque.length work test 7" {
                  ...
                  (((BankersDeque.length t1) = 7)
                   ...
                   && ((BankersDeque.last t1) = "b")
                   && ((BankersDeque.last t1C) = "b")
                   && ((BankersDeque.length t1_1) = 6)
                   && ((BankersDeque.length t1C_1) = 6)
                   && ((BankersDeque.last t1_1) = "c")
                   && ((BankersDeque.last t1C_1) = "c")
                   && ((BankersDeque.length t1_2) = 5)
                   && ((BankersDeque.length t1C_2) = 5)
                   && ((BankersDeque.last t1_2) = "d")
                   && ((BankersDeque.last t1C_2) = "d")
                   && ((BankersDeque.length t1_3) = 4)
                   && ((BankersDeque.length t1C_3) = 4)
                   && ((BankersDeque.last t1_3) = "e")
                   && ((BankersDeque.last t1C_3) = "e")
                   && ((BankersDeque.length t1_4) = 3)
                   && ((BankersDeque.length t1C_4) = 3)
                   && ((BankersDeque.last t1_4) = "f")
                   && ((BankersDeque.last t1C_4) = "f")
                   && ((BankersDeque.length t1_5) = 2)
                   && ((BankersDeque.length t1C_5) = 2)
                   && ((BankersDeque.last t1_5) = "g")
                   && ((BankersDeque.last t1C_5) = "g")
                   && ((BankersDeque.length t1_6) = 1)
                   && ((BankersDeque.length t1C_6) = 1)
                   && ((BankersDeque.last t1_6) = "h")
                   && ((BankersDeque.last t1C_6) = "h"))
                  |> Expect.isTrue ""
              }
              ...
              test "BankersDeque.last, BankersDeque.init, and BankersDeque.length work test 8" {
                  ...
                  (((BankersDeque.length t1) = 8)
                   ...
                   && ((BankersDeque.last t1) = "b")
                   && ((BankersDeque.last t1C) = "b")
                   && ((BankersDeque.length t1_1) = 7)
                   && ((BankersDeque.length t1C_1) = 7)
                   && ((BankersDeque.last t1_1) = "c")
                   && ((BankersDeque.last t1C_1) = "c")
                   && ((BankersDeque.length t1_2) = 6)
                   && ((BankersDeque.length t1C_2) = 6)
                   && ((BankersDeque.last t1_2) = "d")
                   && ((BankersDeque.last t1C_2) = "d")
                   && ((BankersDeque.length t1_3) = 5)
                   && ((BankersDeque.length t1C_3) = 5)
                   && ((BankersDeque.last t1_3) = "e")
                   && ((BankersDeque.last t1C_3) = "e")
                   && ((BankersDeque.length t1_4) = 4)
                   && ((BankersDeque.length t1C_4) = 4)
                   && ((BankersDeque.last t1_4) = "f")
                   && ((BankersDeque.last t1C_4) = "f")
                   && ((BankersDeque.length t1_5) = 3)
                   && ((BankersDeque.length t1C_5) = 3)
                   && ((BankersDeque.last t1_5) = "g")
                   && ((BankersDeque.last t1C_5) = "g")
                   && ((BankersDeque.length t1_6) = 2)
                   && ((BankersDeque.length t1C_6) = 2)
                   && ((BankersDeque.last t1_6) = "h")
                   && ((BankersDeque.last t1C_6) = "h")
                   && ((BankersDeque.length t1_7) = 1)
                   && ((BankersDeque.length t1C_7) = 1)
                   && ((BankersDeque.last t1_7) = "i")
                   && ((BankersDeque.last t1C_7) = "i"))
                  |> Expect.isTrue ""
              }
              ...
              test "BankersDeque.last, BankersDeque.init, and BankersDeque.length work test 9" {
                  ...
                  (((BankersDeque.length t1) = 9)
                   ...
                   && ((BankersDeque.last t1) = "b")
                   && ((BankersDeque.last t1C) = "b")
                   && ((BankersDeque.length t1_1) = 8)
                   && ((BankersDeque.length t1C_1) = 8)
                   && ((BankersDeque.last t1_1) = "c")
                   && ((BankersDeque.last t1C_1) = "c")
                   && ((BankersDeque.length t1_2) = 7)
                   && ((BankersDeque.length t1C_2) = 7)
                   && ((BankersDeque.last t1_2) = "d")
                   && ((BankersDeque.last t1C_2) = "d")
                   && ((BankersDeque.length t1_3) = 6)
                   && ((BankersDeque.length t1C_3) = 6)
                   && ((BankersDeque.last t1_3) = "e")
                   && ((BankersDeque.last t1C_3) = "e")
                   && ((BankersDeque.length t1_4) = 5)
                   && ((BankersDeque.length t1C_4) = 5)
                   && ((BankersDeque.last t1_4) = "f")
                   && ((BankersDeque.last t1C_4) = "f")
                   && ((BankersDeque.length t1_5) = 4)
                   && ((BankersDeque.length t1C_5) = 4)
                   && ((BankersDeque.last t1_5) = "g")
                   && ((BankersDeque.last t1C_5) = "g")
                   && ((BankersDeque.length t1_6) = 3)
                   && ((BankersDeque.length t1C_6) = 3)
                   && ((BankersDeque.last t1_6) = "h")
                   && ((BankersDeque.last t1C_6) = "h")
                   && ((BankersDeque.length t1_7) = 2)
                   && ((BankersDeque.length t1C_7) = 2)
                   && ((BankersDeque.last t1_7) = "i")
                   && ((BankersDeque.last t1C_7) = "i")
                   && ((BankersDeque.length t1_8) = 1)
                   && ((BankersDeque.length t1C_8) = 1)
                   && ((BankersDeque.last t1_8) = "j")
                   && ((BankersDeque.last t1C_8) = "j"))
                  |> Expect.isTrue ""
              }

              test "IEnumerable Seq" { (lena |> Seq.toArray).[5] |> Expect.equal "" "e" }

              test "IEnumerable Seq BankersDeque.length" { lena |> Seq.length |> Expect.equal "" 10 }

              test "type BankersDeque.cons works" { lena.Cons "zz" |> BankersDeque.head |> Expect.equal "" "zz" }

              test "IDeque BankersDeque.cons works" { ((lena :> IDeque<string>).Cons "zz").Head |> Expect.equal "" "zz" }
              ...
              test "BankersDeque.rev BankersDeque.empty dqueue should be BankersDeque.empty" {
                  BankersDeque.isEmpty(BankersDeque.rev(BankersDeque.empty 2))
                  |> Expect.isTrue ""
              }

              test "BankersDeque.rev dqueue BankersDeque.length 1" {
                  ((BankersDeque.head(BankersDeque.rev len1) = "a")
                   && (BankersDeque.head(BankersDeque.rev len1C3) = "a"))
                  |> Expect.isTrue ""
              }
              ...
              test "BankersDeque.ofSeq and BankersDeque.ofSeqC BankersDeque.empty" {
                  ((BankersDeque.isEmpty(BankersDeque.ofSeq []))
                   && (BankersDeque.isEmpty(BankersDeque.ofSeqC 3 [])))
                  |> Expect.isTrue ""
              }

              test "BankersDeque.ofSeq and BankersDeque.ofSeqC BankersDeque.length 1" {
                  ((BankersDeque.head(BankersDeque.ofSeq [ "a" ]) = "a")
                   && (BankersDeque.head(BankersDeque.ofSeqC 3 [ "a" ]) = "a"))
                  |> Expect.isTrue ""
              }
              ...
              test "appending BankersDeque.empty dqueus" {
                  ((BankersDeque.isEmpty(BankersDeque.append (BankersDeque.ofSeq []) (BankersDeque.ofSeq [])))
                   && (BankersDeque.isEmpty(BankersDeque.append (BankersDeque.empty 3) (BankersDeque.empty 3))))
                  |> Expect.isTrue ""
              }

              test "appending BankersDeque.empty and BankersDeque.length 1" {
                  ((BankersDeque.head(BankersDeque.append (BankersDeque.ofSeq []) len1) = "a")
                   && (BankersDeque.head(BankersDeque.append len1 (BankersDeque.empty 3)) = "a"))
                  |> Expect.isTrue ""
              }

              test "appending BankersDeque.empty and BankersDeque.length 2" {
                  let r1 =
                      BankersDeque.append (BankersDeque.ofSeq []) (BankersDeque.ofSeq [ "a"; "b" ])

                  let r1c =
                      BankersDeque.append (BankersDeque.empty 3) (BankersDeque.ofSeqC 3 [ "a"; "b" ])
                  ...
                  let r1r =
                      BankersDeque.append (BankersDeque.ofSeq [ "a"; "b" ]) (BankersDeque.ofSeq [])

                  let r1cr =
                      BankersDeque.append (BankersDeque.ofSeqC 3 [ "a"; "b" ]) (BankersDeque.empty 3)
              ...
              test "appending BankersDeque.length 1 and BankersDeque.length 2" {
                  let r1 =
                      BankersDeque.append (BankersDeque.ofSeq [ "a" ]) (BankersDeque.ofSeq [ "b"; "c" ])

                  let r1c =
                      BankersDeque.append (BankersDeque.ofSeqC 3 [ "a" ]) (BankersDeque.ofSeqC 3 [ "b"; "c" ])
                  ...
                  let r1r =
                      BankersDeque.append (BankersDeque.ofSeq [ "a"; "b" ]) (BankersDeque.ofSeq [ "c" ])

                  let r1cr =
                      BankersDeque.append (BankersDeque.ofSeqC 3 [ "a"; "b" ]) (BankersDeque.ofSeqC 3 [ "c" ])
              ...
              test "appending BankersDeque.length 1 and BankersDeque.length 3" {
                  let r1 =
                      BankersDeque.append (BankersDeque.ofSeq [ "a" ]) (BankersDeque.ofSeq [ "b"; "c"; "d" ])

                  let r1c =
                      BankersDeque.append (BankersDeque.ofSeqC 3 [ "a" ]) (BankersDeque.ofSeqC 3 [ "b"; "c"; "d" ])
                  ...
                  let r1r =
                      BankersDeque.append (BankersDeque.ofSeq [ "a"; "b"; "c" ]) (BankersDeque.ofSeq [ "d" ])

                  let r1cr =
                      BankersDeque.append (BankersDeque.ofSeqC 3 [ "a"; "b"; "c" ]) (BankersDeque.ofSeqC 3 [ "d" ])
              ...
              test "appending BankersDeque.length 1 and BankersDeque.length 4" {
                  let r1 =
                      BankersDeque.append (BankersDeque.ofSeq [ "a" ]) (BankersDeque.ofSeq [ "b"; "c"; "d"; "e" ])

                  let r1c =
                      BankersDeque.append (BankersDeque.ofSeqC 3 [ "a" ]) (BankersDeque.ofSeqC 3 [ "b"; "c"; "d"; "e" ])
                  ...
                  let r1r =
                      BankersDeque.append (BankersDeque.ofSeq [ "a"; "b"; "c"; "d" ]) (BankersDeque.ofSeq [ "e" ])

                  let r1cr =
                      BankersDeque.append (BankersDeque.ofSeqC 3 [ "a"; "b"; "c"; "d" ]) (BankersDeque.ofSeqC 3 [ "e" ])
              ...
              test "appending BankersDeque.length 1 and BankersDeque.length 5" {
                  let r1 =
                      BankersDeque.append (BankersDeque.ofSeq [ "a" ]) (BankersDeque.ofSeq [ "b"; "c"; "d"; "e"; "f" ])

                  let r1c =
                      BankersDeque.append (BankersDeque.ofSeqC 3 [ "a" ]) (BankersDeque.ofSeqC 3 [ "b"; "c"; "d"; "e"; "f" ])
                  ...
                  let r1r =
                      BankersDeque.append (BankersDeque.ofSeq [ "a"; "b"; "c"; "d"; "e" ]) (BankersDeque.ofSeq [ "f" ])

                  let r1cr =
                      BankersDeque.append (BankersDeque.ofSeqC 3 [ "a"; "b"; "c"; "d"; "e" ]) (BankersDeque.ofSeqC 3 [ "f" ])
              ...
              test "appending BankersDeque.length 6 and BankersDeque.length 7" {
                  let r1 =
                      BankersDeque.append
                          (BankersDeque.ofSeq [ "a"; "b"; "c"; "d"; "e"; "f" ])
                          (BankersDeque.ofSeq [ "g"; "h"; "i"; "j"; "k"; "l"; "m" ])

                  let r1c =
                      BankersDeque.append
                          (BankersDeque.ofSeqC 3 [ "a"; "b"; "c"; "d"; "e"; "f" ])
                          (BankersDeque.ofSeqC 3 [ "g"; "h"; "i"; "j"; "k"; "l"; "m" ])
                  ...
                  let r1r =
                      BankersDeque.append
                          (BankersDeque.ofSeq [ "a"; "b"; "c"; "d"; "e"; "f"; "g" ])
                          (BankersDeque.ofSeq [ "h"; "i"; "j"; "k"; "l"; "m" ])

                  let r1cr =
                      BankersDeque.append
                          (BankersDeque.ofSeqC 3 [ "a"; "b"; "c"; "d"; "e"; "f"; "g" ])
                          (BankersDeque.ofSeqC 3 [ "h"; "i"; "j"; "k"; "l"; "m" ])
              ...
              test "appending BankersDeque.length 2 and BankersDeque.length 2" {
                  let r1 =
                      BankersDeque.append (BankersDeque.ofSeq [ "a"; "b" ]) (BankersDeque.ofSeq [ "c"; "d" ])

                  let r1c =
                      BankersDeque.append (BankersDeque.ofSeqC 3 [ "a"; "b" ]) (BankersDeque.ofSeqC 3 [ "c"; "d" ])
              ...
              test "appending BankersDeque.length 2 and BankersDeque.length 3" {
                  let r1 =
                      BankersDeque.append (BankersDeque.ofSeq [ "a"; "b" ]) (BankersDeque.ofSeq [ "c"; "d"; "e" ])

                  let r1c =
                      BankersDeque.append (BankersDeque.ofSeqC 3 [ "a"; "b" ]) (BankersDeque.ofSeqC 3 [ "c"; "d"; "e" ])
                  ...
                  let r1r =
                      BankersDeque.append (BankersDeque.ofSeq [ "a"; "b"; "c" ]) (BankersDeque.ofSeq [ "d"; "e" ])

                  let r1cr =
                      BankersDeque.append (BankersDeque.ofSeqC 3 [ "a"; "b"; "c" ]) (BankersDeque.ofSeqC 3 [ "d"; "e" ])
              ...
              test "appending BankersDeque.length 2 and BankersDeque.length 4" {
                  let r1 =
                      BankersDeque.append (BankersDeque.ofSeq [ "a"; "b" ]) (BankersDeque.ofSeq [ "c"; "d"; "e"; "f" ])

                  let r1c =
                      BankersDeque.append (BankersDeque.ofSeqC 3 [ "a"; "b" ]) (BankersDeque.ofSeqC 3 [ "c"; "d"; "e"; "f" ])
                  ...
                  let r1r =
                      BankersDeque.append (BankersDeque.ofSeq [ "a"; "b"; "c"; "d" ]) (BankersDeque.ofSeq [ "e"; "f" ])

                  let r1cr =
                      BankersDeque.append (BankersDeque.ofSeqC 3 [ "a"; "b"; "c"; "d" ]) (BankersDeque.ofSeqC 3 [ "e"; "f" ])
              ...
              test "appending BankersDeque.length 2 and BankersDeque.length 5" {
                  let r1 =
                      BankersDeque.append (BankersDeque.ofSeq [ "a"; "b" ]) (BankersDeque.ofSeq [ "c"; "d"; "e"; "f"; "g" ])

                  let r1c =
                      BankersDeque.append (BankersDeque.ofSeqC 3 [ "a"; "b" ]) (BankersDeque.ofSeqC 3 [ "c"; "d"; "e"; "f"; "g" ])
                  ...
                  let r1r =
                      BankersDeque.append (BankersDeque.ofSeq [ "a"; "b"; "c"; "d"; "e" ]) (BankersDeque.ofSeq [ "f"; "g" ])

                  let r1cr =
                      BankersDeque.append (BankersDeque.ofSeqC 3 [ "a"; "b"; "c"; "d"; "e" ]) (BankersDeque.ofSeqC 3 [ "f"; "g" ])
              ...
              test "appending BankersDeque.length 3 and BankersDeque.length 3" {
                  let r1 =
                      BankersDeque.append (BankersDeque.ofSeq [ "a"; "b"; "c" ]) (BankersDeque.ofSeq [ "d"; "e"; "f" ])

                  let r1c =
                      BankersDeque.append (BankersDeque.ofSeqC 3 [ "a"; "b"; "c" ]) (BankersDeque.ofSeqC 3 [ "d"; "e"; "f" ])
              ...
              test "BankersDeque.lookup BankersDeque.length 1" { len1 |> BankersDeque.lookup 0 |> Expect.equal "" "a" }

              test "BankersDeque.lookup BankersDeque.length 2" {
                  (((len2 |> BankersDeque.lookup 0) = "b")
                   && ((len2 |> BankersDeque.lookup 1) = "a"))
                  |> Expect.isTrue ""
              }

              test "BankersDeque.lookup BankersDeque.length 3" {
                  (((len3 |> BankersDeque.lookup 0) = "c")
                   && ((len3 |> BankersDeque.lookup 1) = "b")
                   && ((len3 |> BankersDeque.lookup 2) = "a"))
                  |> Expect.isTrue ""
              }

              test "BankersDeque.lookup BankersDeque.length 4" {
                  (((len4 |> BankersDeque.lookup 0) = "d")
                   && ((len4 |> BankersDeque.lookup 1) = "c")
                   && ((len4 |> BankersDeque.lookup 2) = "b")
                   && ((len4 |> BankersDeque.lookup 3) = "a"))
                  |> Expect.isTrue ""
              }

              test "BankersDeque.lookup BankersDeque.length 5" {
                  (((len5 |> BankersDeque.lookup 0) = "e")
                   && ((len5 |> BankersDeque.lookup 1) = "d")
                   && ((len5 |> BankersDeque.lookup 2) = "c")
                   && ((len5 |> BankersDeque.lookup 3) = "b")
                   && ((len5 |> BankersDeque.lookup 4) = "a"))
                  |> Expect.isTrue ""
              }

              test "BankersDeque.lookup BankersDeque.length 6" {
                  (((len6 |> BankersDeque.lookup 0) = "f")
                   && ((len6 |> BankersDeque.lookup 1) = "e")
                   && ((len6 |> BankersDeque.lookup 2) = "d")
                   && ((len6 |> BankersDeque.lookup 3) = "c")
                   && ((len6 |> BankersDeque.lookup 4) = "b")
                   && ((len6 |> BankersDeque.lookup 5) = "a"))
                  |> Expect.isTrue ""
              }

              test "BankersDeque.lookup BankersDeque.length 7" {
                  (((len7 |> BankersDeque.lookup 0) = "g")
                   && ((len7 |> BankersDeque.lookup 1) = "f")
                   && ((len7 |> BankersDeque.lookup 2) = "e")
                   && ((len7 |> BankersDeque.lookup 3) = "d")
                   && ((len7 |> BankersDeque.lookup 4) = "c")
                   && ((len7 |> BankersDeque.lookup 5) = "b")
                   && ((len7 |> BankersDeque.lookup 6) = "a"))
                  |> Expect.isTrue ""
              }

              test "BankersDeque.lookup BankersDeque.length 8" {
                  (((len8 |> BankersDeque.lookup 0) = "h")
                   && ((len8 |> BankersDeque.lookup 1) = "g")
                   && ((len8 |> BankersDeque.lookup 2) = "f")
                   && ((len8 |> BankersDeque.lookup 3) = "e")
                   && ((len8 |> BankersDeque.lookup 4) = "d")
                   && ((len8 |> BankersDeque.lookup 5) = "c")
                   && ((len8 |> BankersDeque.lookup 6) = "b")
                   && ((len8 |> BankersDeque.lookup 7) = "a"))
                  |> Expect.isTrue ""
              }

              test "BankersDeque.lookup BankersDeque.length 9" {
                  (((len9 |> BankersDeque.lookup 0) = "i")
                   && ((len9 |> BankersDeque.lookup 1) = "h")
                   && ((len9 |> BankersDeque.lookup 2) = "g")
                   && ((len9 |> BankersDeque.lookup 3) = "f")
                   && ((len9 |> BankersDeque.lookup 4) = "e")
                   && ((len9 |> BankersDeque.lookup 5) = "d")
                   && ((len9 |> BankersDeque.lookup 6) = "c")
                   && ((len9 |> BankersDeque.lookup 7) = "b")
                   && ((len9 |> BankersDeque.lookup 8) = "a"))
                  |> Expect.isTrue ""
              }

              test "BankersDeque.lookup BankersDeque.length 10" {
                  (((lena |> BankersDeque.lookup 0) = "j")
                   && ((lena |> BankersDeque.lookup 1) = "i")
                   && ((lena |> BankersDeque.lookup 2) = "h")
                   && ((lena |> BankersDeque.lookup 3) = "g")
                   && ((lena |> BankersDeque.lookup 4) = "f")
                   && ((lena |> BankersDeque.lookup 5) = "e")
                   && ((lena |> BankersDeque.lookup 6) = "d")
                   && ((lena |> BankersDeque.lookup 7) = "c")
                   && ((lena |> BankersDeque.lookup 8) = "b")
                   && ((lena |> BankersDeque.lookup 9) = "a"))
                  |> Expect.isTrue ""
              }
              ...
              test "BankersDeque.tryLookup not found" { lena |> BankersDeque.tryLookup 10 |> Expect.isNone "" }

              test "BankersDeque.remove elements BankersDeque.length 1" {
                  len1
                  |> BankersDeque.remove 0
              ...
              test "tryRemoveempty" { (BankersDeque.empty 3) |> BankersDeque.tryRemove 0 |> Expect.isNone "" }
              ...
              test "BankersDeque.tryRemove elements BankersDeque.length 4" {
                  let x0 =
                      (BankersDeque.ofSeq [ "a"; "b"; "c"; "d" ])
                      |> BankersDeque.tryRemove 0
              ...
              test "BankersDeque.tryUpdate elements BankersDeque.length 3" {
                  let x0 =
                      (BankersDeque.ofSeq [ "a"; "b"; "c" ])
                      |> BankersDeque.tryUpdate 0 "zz"
              ...
              test "BankersDeque.tryGetTail on q" {
                  ...
                  (BankersDeque.tryGetTail q).Value
                  |> BankersDeque.head
                  |> Expect.equal "" "b"
              } ]
