    ...
    let testBankersDeque =
        ...
        testList "Experimental BankersDeque" [
            test "empty dqueue should be empty" {
                ...
                isEmpty (empty 2) |> Expect.isTrue "" }

            test "cons works" {
                ((len2 |> isEmpty) && (len2C3 |> isEmpty)) |> Expect.isFalse "" }

            test "snoc works" {
                ((len2snoc |> isEmpty) && (len2C3snoc |> isEmpty)) |> Expect.isFalse "" }

            test "singleton head works" {
                (((head len1) = "a") && ((len1C3 |> isEmpty)) = false) |> Expect.isTrue "" }

            test "singleton last works" {
                len1 |> last |> Expect.equal "" "a" } 

            test "tail of singleton empty" {
                len1 |> tail |> isEmpty |> Expect.isTrue "" }

            test "tail of tail of 2 empty" {
                 ( len2 |> tail |> tail |> isEmpty) |> Expect.isTrue "" }

            test "init of singleton empty" {
                ((init len1)  |> isEmpty) |> Expect.isTrue "" }
            ...
            test "head, tail, and length work test 1" {
                ...
                && ((head t1) = "a") && ((head t1C) = "a") && ((head t1s) = "a") && ((head t1Cs) = "a")) |> Expect.isTrue "" }
            ...
            test "head, tail, and length work test 2" {
                ...
                && ((head t1_1) = "a") && ((head t1C_1) = "a") && ((head t1_1s) = "a") && ((head t1C_1s) = "a")) |> Expect.isTrue "" }
            ...
            test "last, init, and length work test 1" {  
                ...
                (((length t1) = 1) && ((length t1C) = 1) && ((last t1) = "b") && ((last t1C) = "b")) |> Expect.isTrue "" }
            ...
            test "last, init, and length work test 2" {
                ...
                && ((length t1_1) = 1) && ((length t1C_1) = 1) && ((last t1_1) = "c") && ((last t1C_1) = "c")) |> Expect.isTrue "" }
            ...
            test "last, init, and length work test 3" {
                ...
                && ((length t1_2) = 1) && ((length t1C_2) = 1) && ((last t1_2) = "d") && ((last t1C_2) = "d")) |> Expect.isTrue "" }
            ...
            test "last, init, and length work test 4" {
                ...
                && ((length t1_3) = 1) && ((length t1C_3) = 1) && ((last t1_3) = "e") && ((last t1C_3) = "e")) |> Expect.isTrue "" }
            ...
            test "last, init, and length work test 5" {
                ...
                && ((length t1_4) = 1) && ((length t1C_4) = 1) && ((last t1_4) = "f") && ((last t1C_4) = "f")) |> Expect.isTrue "" }
            ...
            test "last, init, and length work test 6" {
                ...
                && ((length t1_5) = 1) && ((length t1C_5) = 1) && ((last t1_5) = "g") && ((last t1C_5) = "g")) |> Expect.isTrue "" }
            ...
            test "last, init, and length work test 7" {
                ...
                && ((length t1_6) = 1) && ((length t1C_6) = 1) && ((last t1_6) = "h") && ((last t1C_6) = "h")) |> Expect.isTrue "" }
            ...
            test "last, init, and length work test 8" {
                ...
                && ((length t1_7) = 1) && ((length t1C_7) = 1) && ((last t1_7) = "i") && ((last t1C_7) = "i")) |> Expect.isTrue "" }
            ...
            test "last, init, and length work test 9" {
                ...
                && ((length t1_8) = 1) && ((length t1C_8) = 1) && ((last t1_8) = "j") && ((last t1C_8) = "j")) |> Expect.isTrue "" }
            ...
            test "type cons works" {
                lena.Cons "zz" |> head |> Expect.equal "" "zz" } 

            test "IDeque cons works" {
            ...
            test "ofCatLists and uncons" {
                ...
                ((h1 = "a") && (h2 = "b") && (h3 = "c") && (h4 = "d") && (h5 = "e") && (h6 = "f") && (isEmpty t6)) |> Expect.isTrue "" }

            test "ofCatSeqs and uncons" {
            ...
            test "unsnoc works" {
                ...
                ((l1 = "a") && (l2 = "b") && (l3 = "c") && (l4 = "d") && (l5 = "e") && (l6 = "f") && (isEmpty i6)) |> Expect.isTrue "" }

            test "snoc pattern discriminator" {
                let d = (ofCatLists ["f";"e";"d"] ["c";"b";"a"]) 
                let i1, l1 = unsnoc d 
                ...
                ((l2 = "b") && ((length i2) = 4)) |> Expect.isTrue "" }
            ...
            test "cons and snoc pattern discriminator" {
                let d = (ofCatLists ["f";"e";"d"] ["c";"b";"a"]) 
            ...
            test "rev empty dqueue should be empty" {
                isEmpty (rev (empty 2)) |> Expect.isTrue "" }

            test "rev dqueue length 1" {
                ((head (rev len1) = "a") && (head (rev len1C3) = "a")) |> Expect.isTrue "" }

            test "rev dqueue length 2" {
                let r1 = rev len2
                let r1c = rev len2C3
                let h1 = head r1
                let h1c = head r1c
            ...
            test "ofSeq and ofSeqC empty" {
                ((isEmpty (ofSeq [])) && (isEmpty (ofSeqC 3 []))) |> Expect.isTrue "" }

            test "ofSeq and ofSeqC length 1" {
                ((head       (ofSeq ["a"])      = "a") && (head      (ofSeqC 3 ["a"])      = "a")) |> Expect.isTrue "" }

            test "ofSeq and ofSeqC length 2" {
                let r1 = ofSeq ["a";"b"]
            ...
            test "ofSeq and ofSeqC length 3" {
                let r1 = ofSeq ["a";"b";"c"]
            ...
            test "ofSeq and ofSeqC length 4" {
            ...
            test "ofSeq and ofSeqC length 5" {
            ...
            //length 5 more than sufficient to test ofSeq and ofSeqC
            test "ofSeq and ofSeqC length 6" {
            ...
            test "appending empty dqueus" {
                ((isEmpty (append (ofSeq []) (ofSeq []) )) && (isEmpty (append (empty 3) (empty 3)))
                ) |> Expect.isTrue "" }

            test "appending empty and length 1" {
                ((head (append (ofSeq []) len1) = "a") && (head (append len1 (empty 3)) = "a")) |> Expect.isTrue "" }

            test "appending empty and length 2" {
            ...
            test "appending length 1 and length 2" {
            ...
            test "appending length 1 and length 3" {
            ...
            test "appending length 1 and length 4" {
            ...
            test "appending length 1 and length 5" {
            ...
            test "appending length 6 and length 7" {
            ...
            test "appending length 2 and length 2" {
            ...
            test "appending length 2 and length 3" {
            ...
            test "appending length 2 and length 4" {
            ...
            test "appending length 2 and length 5" {
            ...
            test "appending length 3 and length 3" {
            ...
            test "lookup length 1" {
                len1 |> lookup 0 |> Expect.equal "" "a" } 

            test "lookup length 2" {
                (((len2 |> lookup 0) = "b") && ((len2 |> lookup 1) = "a")) |> Expect.isTrue "" }

            test "lookup length 3" {
                (((len3 |> lookup 0) = "c") && ((len3 |> lookup 1) = "b") && ((len3 |> lookup 2) = "a")) |> Expect.isTrue "" }

            test "lookup length 4" {
                (((len4 |> lookup 0) = "d") && ((len4 |> lookup 1) = "c") && ((len4 |> lookup 2) = "b") && ((len4 |> lookup 3) = "a")) 
                |> Expect.isTrue "" }

            test "lookup length 5" {
                (((len5 |> lookup 0) = "e") && ((len5 |> lookup 1) = "d") && ((len5 |> lookup 2) = "c") && ((len5 |> lookup 3) = "b") 
                && ((len5 |> lookup 4) = "a")) |> Expect.isTrue "" }

            test "lookup length 6" {
                (((len6 |> lookup 0) = "f") && ((len6 |> lookup 1) = "e") && ((len6 |> lookup 2) = "d") && ((len6 |> lookup 3) = "c") 
                && ((len6 |> lookup 4) = "b") && ((len6 |> lookup 5) = "a")) |> Expect.isTrue "" }

            test "lookup length 7" {
                (((len7 |> lookup 0) = "g") && ((len7 |> lookup 1) = "f") && ((len7 |> lookup 2) = "e") && ((len7 |> lookup 3) = "d") 
                && ((len7 |> lookup 4) = "c") && ((len7 |> lookup 5) = "b") && ((len7 |> lookup 6) = "a")) |> Expect.isTrue "" }

            test "lookup length 8" {
            ...
            test "lookup length 9" {
                ...
                && ((len9 |> lookup 8) = "a")) |> Expect.isTrue "" }

            test "lookup length 10" {
            ...
            test "tryLookup not found" {
                lena |> tryLookup 10 |> Expect.isNone "" }

            test "remove elements length 1" {
                len1 |> remove 0 |> isEmpty |> Expect.isTrue "" }

            test "remove elements length 2" {
                let a = len2 |> remove 0 |> head 
                let b = len2 |> remove 1 |> head
                ((a = "a") && (b = "b")) |> Expect.isTrue "" }

            test "remove elements length 3" {
            ...
            test "tryRemoveempty" {
                (empty 3) |> tryRemove 0 |> Expect.isNone "" }

            test "tryRemove elements length 1" {
                let a = len1 |> tryRemove 0 
                a.Value |> isEmpty |> Expect.isTrue "" }

            test "tryRemove elements length 2" {
            ...
            test "tryRemove elements length 3" {
            ...
            test "tryRemove elements length 4" {
            ...
            test "tryRemove elements length 5" {
            ...
            test "tryRemove elements length 6" {
            ...
            test "update elements length 1" {
                len1 |> update 0 "aa" |> head |> Expect.equal "" "aa" } 

            test "update elements length 2" {
            ...
            test "tryUpdate elements length 1" {
                let a = len1 |> tryUpdate 0 "aa" 
                a.Value |> head |> Expect.equal "" "aa" } 

            test "tryUpdate elements length 2" {
            ...
            test "tryUpdate elements length 3" {
            ...
            test "tryUpdate elements length 4" {
            ...
            test "tryUncons on empty" {
                let q = empty 2
                (tryUncons q = None) |> Expect.isTrue "" }
            ...
            test "tryUnsnoc on empty" {
                let q = empty 2
                (tryUnsnoc q = None) |> Expect.isTrue "" }
            ...
            test "tryGetHead on empty" {
                let q = empty 2
                (tryGetHead q = None) |> Expect.isTrue "" }

            test "tryGetHead on q" {
                let q = ofSeq ["a";"b";"c";"d"]
                (tryGetHead q).Value |> Expect.equal "" "a" } 

            test "tryGetInit on empty" {
                let q = empty 2
                (tryGetInit q = None) |> Expect.isTrue "" }
            ...
            test "tryGetLast on empty" {
                let q = empty 2
                (tryGetLast q = None) |> Expect.isTrue "" }

            test "tryGetLast on q" {
                let q = ofSeq ["a";"b";"c";"d"]
                (tryGetLast q).Value |> Expect.equal "" "d" } 


            test "tryGetTail on empty" {
                let q = empty 2
                (tryGetTail q = None) |> Expect.isTrue "" }

            test "tryGetTail on q" {
                let q = ofSeq ["a";"b";"c";"d"]
                (tryGetTail q).Value |> head |> Expect.equal "" "b" } 
        ]