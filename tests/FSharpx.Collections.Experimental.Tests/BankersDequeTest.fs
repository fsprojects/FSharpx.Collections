...
module BankersDequeTest =
    ...
    let testBankersDeque =
        ...
        testList "Experimental BankersDeque" [ test "BankersDeque.empty dqueue should be BankersDeque.empty" {
                                               ...
                                               test "appending BankersDeque.length 1 and BankersDeque.length 4" {
                                                   ...
                                                   let r1c =
                                                       BankersDeque.append
                                                           (BankersDeque.ofSeqC 3 [ "a" ])
                                                           (BankersDeque.ofSeqC 3 [ "b"; "c"; "d"; "e" ])
                                                   ...
                                                   let r1cr =
                                                       BankersDeque.append
                                                           (BankersDeque.ofSeqC 3 [ "a"; "b"; "c"; "d" ])
                                                           (BankersDeque.ofSeqC 3 [ "e" ])
                                               ...
                                               test "appending BankersDeque.length 1 and BankersDeque.length 5" {
                                                   let r1 =
                                                       BankersDeque.append
                                                           (BankersDeque.ofSeq [ "a" ])
                                                           (BankersDeque.ofSeq [ "b"; "c"; "d"; "e"; "f" ])

                                                   let r1c =
                                                       BankersDeque.append
                                                           (BankersDeque.ofSeqC 3 [ "a" ])
                                                           (BankersDeque.ofSeqC 3 [ "b"; "c"; "d"; "e"; "f" ])
                                                   ...
                                                   let r1r =
                                                       BankersDeque.append
                                                           ...
                                                           (BankersDeque.ofSeq [ "f" ])

                                                   let r1cr =
                                                       BankersDeque.append
                                                           (BankersDeque.ofSeqC 3 [ "a"; "b"; "c"; "d"; "e" ])
                                                           (BankersDeque.ofSeqC 3 [ "f" ])
                                               ...
                                               test "appending BankersDeque.length 2 and BankersDeque.length 3" {
                                                   ...
                                                   let r1c =
                                                       BankersDeque.append
                                                           (BankersDeque.ofSeqC 3 [ "a"; "b" ])
                                                           (BankersDeque.ofSeqC 3 [ "c"; "d"; "e" ])
                                                   ...
                                                   let r1cr =
                                                       BankersDeque.append
                                                           (BankersDeque.ofSeqC 3 [ "a"; "b"; "c" ])
                                                           (BankersDeque.ofSeqC 3 [ "d"; "e" ])
                                               ...
                                               test "appending BankersDeque.length 2 and BankersDeque.length 4" {
                                                   let r1 =
                                                       BankersDeque.append
                                                           (BankersDeque.ofSeq [ "a"; "b" ])
                                                           (BankersDeque.ofSeq [ "c"; "d"; "e"; "f" ])

                                                   let r1c =
                                                       BankersDeque.append
                                                           (BankersDeque.ofSeqC 3 [ "a"; "b" ])
                                                           (BankersDeque.ofSeqC 3 [ "c"; "d"; "e"; "f" ])
                                                   ...
                                                   let r1r =
                                                       BankersDeque.append
                                                           ...
                                                           (BankersDeque.ofSeq [ "e"; "f" ])

                                                   let r1cr =
                                                       BankersDeque.append
                                                           (BankersDeque.ofSeqC 3 [ "a"; "b"; "c"; "d" ])
                                                           (BankersDeque.ofSeqC 3 [ "e"; "f" ])
                                               ...
                                               test "appending BankersDeque.length 2 and BankersDeque.length 5" {
                                                   let r1 =
                                                       BankersDeque.append
                                                           (BankersDeque.ofSeq [ "a"; "b" ])
                                                           (BankersDeque.ofSeq [ "c"; "d"; "e"; "f"; "g" ])

                                                   let r1c =
                                                       BankersDeque.append
                                                           (BankersDeque.ofSeqC 3 [ "a"; "b" ])
                                                           (BankersDeque.ofSeqC 3 [ "c"; "d"; "e"; "f"; "g" ])
                                                   ...
                                                   let r1r =
                                                       BankersDeque.append
                                                           (BankersDeque.ofSeq [ "a"; "b"; "c"; "d"; "e" ])
                                                           (BankersDeque.ofSeq [ "f"; "g" ])

                                                   let r1cr =
                                                       BankersDeque.append
                                                           (BankersDeque.ofSeqC 3 [ "a"; "b"; "c"; "d"; "e" ])
                                                           (BankersDeque.ofSeqC 3 [ "f"; "g" ])
                                               ...
                                               test "appending BankersDeque.length 3 and BankersDeque.length 3" {
                                                   let r1 =
                                                       BankersDeque.append
                                                           ...
                                                           (BankersDeque.ofSeq [ "d"; "e"; "f" ])

                                                   let r1c =
                                                       BankersDeque.append
                                                           (BankersDeque.ofSeqC 3 [ "a"; "b"; "c" ])
                                                           (BankersDeque.ofSeqC 3 [ "d"; "e"; "f" ])
