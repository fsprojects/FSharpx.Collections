...
module ChampHashMapTests =
    ...
    let testQueue =
        testList
            "Experimental ChampHashMap tests"
            [ test "Insert 1000 elements and make sure they are retrieved." {
                  let startingMap = ChampHashMap<string, int>()

                  let fullMap =
                      Seq.fold (fun (data: ChampHashMap<string, int>) (i: int) -> data.Add (i.ToString()) i) (startingMap) (seq { 1..1000 })
              ...
              test "Insert 1000 colliding elements and make sure they are retrieved" {
                  ...
                  let fullMap =
                      Seq.fold
                          (fun (data: ChampHashMap<CollidingKey<string>, int>) (i: int) -> data.Add (CollidingKey(i.ToString())) i)
                          (startingMap)
                          (seq { 1..1000 })
              ...
              test "Insert 1000 elements and then remove the first 500 elements" {
                  ...
                  let filteredMap =
                      Seq.fold (fun (data: ChampHashMap<string, int>) (i: int) -> data.Remove(i.ToString())) (fullMap) (seq { 1..500 })
              ...
              test "Insert 1000 colliding elements and then remove the first 500 elements" {
                  ...
                  let filteredMap =
                      Seq.fold
                          (fun (data: ChampHashMap<CollidingKey<string>, int>) (i: int) -> data.Remove(CollidingKey(i.ToString())))
                          (fullMap)
                          (seq { 1..500 })
              ...
              test "Two references to the same hashmap should be equal" {
                  ...
                  let fullMap =
                      Seq.fold (fun (data: ChampHashMap<string, int>) (i: int) -> data.Add ((i.ToString())) i) (startingMap) (seq { 1..100 })
              ...
              test "Two maps holding the same values should be equal" {
                  ...
                  let secondMap =
                      Seq.fold (fun (data: ChampHashMap<string, int>) (i: int) -> data.Add ((i.ToString())) i) (secondStartingMap) (seq { 1..100 })
              ...
              test "Two maps with removed values but containing the same values should be equal" {
                  ...
                  let secondFilteredMap =
                      Seq.fold (fun (data: ChampHashMap<string, int>) (i: int) -> data.Remove(i.ToString())) (secondFullMap) (seq { 1..500 })
