...
module RealTimeDequeTest =
    ...
    let len3 = RealTimeDeque.singleton "a" |> RealTimeDeque.cons "b" |> RealTimeDeque.cons "c"
    let len4 = RealTimeDeque.singleton "a" |> RealTimeDeque.cons "b" |> RealTimeDeque.cons "c" |> RealTimeDeque.cons "d"
    let len5 = RealTimeDeque.singleton "a" |> RealTimeDeque.cons "b" |> RealTimeDeque.cons "c" |> RealTimeDeque.cons "d" |> RealTimeDeque.cons "e"
    let len6 = RealTimeDeque.singleton "a" |> RealTimeDeque.cons "b" |> RealTimeDeque.cons "c" |> RealTimeDeque.cons "d" |> RealTimeDeque.cons "e" |> RealTimeDeque.cons "f"
    let len7 = RealTimeDeque.singleton "a" |> RealTimeDeque.cons "b" |> RealTimeDeque.cons "c" |> RealTimeDeque.cons "d" |> RealTimeDeque.cons "e" |> RealTimeDeque.cons "f" |> RealTimeDeque.cons "g"
    let len8 = RealTimeDeque.singleton "a" |> RealTimeDeque.cons "b" |> RealTimeDeque.cons "c" |> RealTimeDeque.cons "d" |> RealTimeDeque.cons "e" |> RealTimeDeque.cons "f" |> RealTimeDeque.cons "g" |> RealTimeDeque.cons "h"
    let len9 = RealTimeDeque.singleton "a" |> RealTimeDeque.cons "b" |> RealTimeDeque.cons "c" |> RealTimeDeque.cons "d" |> RealTimeDeque.cons "e" |> RealTimeDeque.cons "f" |> RealTimeDeque.cons "g" |> RealTimeDeque.cons "h" |> RealTimeDeque.cons "i"
    let lena = RealTimeDeque.singleton "a" |> RealTimeDeque.cons "b" |> RealTimeDeque.cons "c" |> RealTimeDeque.cons "d" |> RealTimeDeque.cons "e" |> RealTimeDeque.cons "f" |> RealTimeDeque.cons "g" |> RealTimeDeque.cons "h" |> RealTimeDeque.cons "i" |> RealTimeDeque.cons "j"

    let len1snoc = RealTimeDeque.singleton "a"
    let len2snoc = RealTimeDeque.singleton "b" |> RealTimeDeque.snoc "a"
    let len3snoc = RealTimeDeque.singleton "c" |> RealTimeDeque.snoc "b" |> RealTimeDeque.snoc "a"
    let len4snoc = RealTimeDeque.singleton "d" |> RealTimeDeque.snoc "c" |> RealTimeDeque.snoc "b" |> RealTimeDeque.snoc "a"
    let len5snoc = RealTimeDeque.singleton "e" |> RealTimeDeque.snoc "d" |> RealTimeDeque.snoc "c" |> RealTimeDeque.snoc "b" |> RealTimeDeque.snoc "a"
    let len6snoc = RealTimeDeque.singleton "f" |> RealTimeDeque.snoc "e" |> RealTimeDeque.snoc "d" |> RealTimeDeque.snoc "c" |> RealTimeDeque.snoc "b" |> RealTimeDeque.snoc "a"
    let len7snoc = RealTimeDeque.singleton "g" |> RealTimeDeque.snoc "f" |> RealTimeDeque.snoc "e" |> RealTimeDeque.snoc "d" |> RealTimeDeque.snoc "c" |> RealTimeDeque.snoc "b" |> RealTimeDeque.snoc "a"
    let len8snoc = RealTimeDeque.singleton "h" |> RealTimeDeque.snoc "g" |> RealTimeDeque.snoc "f" |> RealTimeDeque.snoc "e" |> RealTimeDeque.snoc "d" |> RealTimeDeque.snoc "c" |> RealTimeDeque.snoc "b" |> RealTimeDeque.snoc "a"
    let len9snoc = RealTimeDeque.singleton "i" |> RealTimeDeque.snoc "h" |> RealTimeDeque.snoc "g" |> RealTimeDeque.snoc "f" |> RealTimeDeque.snoc "e" |> RealTimeDeque.snoc "d" |> RealTimeDeque.snoc "c" |> RealTimeDeque.snoc "b" |> RealTimeDeque.snoc "a"
    let lenasnoc = RealTimeDeque.singleton "j" |> RealTimeDeque.snoc "i" |> RealTimeDeque.snoc "h" |> RealTimeDeque.snoc "g" |> RealTimeDeque.snoc "f" |> RealTimeDeque.snoc "e" |> RealTimeDeque.snoc "d" |> RealTimeDeque.snoc "c" |> RealTimeDeque.snoc "b" |> RealTimeDeque.snoc "a"

    let len1C3 = RealTimeDeque.empty 3 |> RealTimeDeque.cons "a"
    let len2C3 = RealTimeDeque.empty 3 |> RealTimeDeque.cons "a" |> RealTimeDeque.cons "b"
    let len3C3 = RealTimeDeque.empty 3 |> RealTimeDeque.cons "a" |> RealTimeDeque.cons "b" |> RealTimeDeque.cons "c"
    let len4C3 = RealTimeDeque.empty 3 |> RealTimeDeque.cons "a" |> RealTimeDeque.cons "b" |> RealTimeDeque.cons "c" |> RealTimeDeque.cons "d"
    let len5C3 = RealTimeDeque.empty 3 |> RealTimeDeque.cons "a" |> RealTimeDeque.cons "b" |> RealTimeDeque.cons "c" |> RealTimeDeque.cons "d" |> RealTimeDeque.cons "e"
    let len6C3 = RealTimeDeque.empty 3 |> RealTimeDeque.cons "a" |> RealTimeDeque.cons "b" |> RealTimeDeque.cons "c" |> RealTimeDeque.cons "d" |> RealTimeDeque.cons "e" |> RealTimeDeque.cons "f"
    let len7C3 = RealTimeDeque.empty 3 |> RealTimeDeque.cons "a" |> RealTimeDeque.cons "b" |> RealTimeDeque.cons "c" |> RealTimeDeque.cons "d" |> RealTimeDeque.cons "e" |> RealTimeDeque.cons "f" |> RealTimeDeque.cons "g"
    let len8C3 = RealTimeDeque.empty 3 |> RealTimeDeque.cons "a" |> RealTimeDeque.cons "b" |> RealTimeDeque.cons "c" |> RealTimeDeque.cons "d" |> RealTimeDeque.cons "e" |> RealTimeDeque.cons "f" |> RealTimeDeque.cons "g" |> RealTimeDeque.cons "h"
    let len9C3 = RealTimeDeque.empty 3 |> RealTimeDeque.cons "a" |> RealTimeDeque.cons "b" |> RealTimeDeque.cons "c" |> RealTimeDeque.cons "d" |> RealTimeDeque.cons "e" |> RealTimeDeque.cons "f" |> RealTimeDeque.cons "g" |> RealTimeDeque.cons "h" |> RealTimeDeque.cons "i"
    let lenaC3 = RealTimeDeque.empty 3 |> RealTimeDeque.cons "a" |> RealTimeDeque.cons "b" |> RealTimeDeque.cons "c" |> RealTimeDeque.cons "d" |> RealTimeDeque.cons "e" |> RealTimeDeque.cons "f" |> RealTimeDeque.cons "g" |> RealTimeDeque.cons "h" |> RealTimeDeque.cons "i" |> RealTimeDeque.cons "j"

    let len1C3snoc = RealTimeDeque.empty 3 |> RealTimeDeque.snoc "a"
    let len2C3snoc = RealTimeDeque.empty 3 |> RealTimeDeque.snoc "b" |> RealTimeDeque.snoc "a"
    let len3C3snoc = RealTimeDeque.empty 3 |> RealTimeDeque.snoc "c" |> RealTimeDeque.snoc "b" |> RealTimeDeque.snoc "a"
    let len4C3snoc = RealTimeDeque.empty 3 |> RealTimeDeque.snoc "d" |> RealTimeDeque.snoc "c" |> RealTimeDeque.snoc "b" |> RealTimeDeque.snoc "a"
    let len5C3snoc = RealTimeDeque.empty 3 |> RealTimeDeque.snoc "e" |> RealTimeDeque.snoc "d" |> RealTimeDeque.snoc "c" |> RealTimeDeque.snoc "b" |> RealTimeDeque.snoc "a"
    let len6C3snoc = RealTimeDeque.empty 3 |> RealTimeDeque.snoc "f" |> RealTimeDeque.snoc "e" |> RealTimeDeque.snoc "d" |> RealTimeDeque.snoc "c" |> RealTimeDeque.snoc "b" |> RealTimeDeque.snoc "a"
    let len7C3snoc = RealTimeDeque.empty 3 |> RealTimeDeque.snoc "g" |> RealTimeDeque.snoc "f" |> RealTimeDeque.snoc "e" |> RealTimeDeque.snoc "d" |> RealTimeDeque.snoc "c" |> RealTimeDeque.snoc "b" |> RealTimeDeque.snoc "a"
    let len8C3snoc = RealTimeDeque.empty 3 |> RealTimeDeque.snoc "h" |> RealTimeDeque.snoc "g" |> RealTimeDeque.snoc "f" |> RealTimeDeque.snoc "e" |> RealTimeDeque.snoc "d" |> RealTimeDeque.snoc "c" |> RealTimeDeque.snoc "b" |> RealTimeDeque.snoc "a"
    let len9C3snoc = RealTimeDeque.empty 3 |> RealTimeDeque.snoc "i" |> RealTimeDeque.snoc "h" |> RealTimeDeque.snoc "g" |> RealTimeDeque.snoc "f" |> RealTimeDeque.snoc "e" |> RealTimeDeque.snoc "d" |> RealTimeDeque.snoc "c" |> RealTimeDeque.snoc "b" |> RealTimeDeque.snoc "a"
    let lenaC3snoc = RealTimeDeque.empty 3 |> RealTimeDeque.snoc "j" |> RealTimeDeque.snoc "i" |> RealTimeDeque.snoc "h" |> RealTimeDeque.snoc "g" |> RealTimeDeque.snoc "f" |> RealTimeDeque.snoc "e" |> RealTimeDeque.snoc "d" |> RealTimeDeque.snoc "c" |> RealTimeDeque.snoc "b" |> RealTimeDeque.snoc "a"

    [<Tests>]
    let testRealTimeDeque =

        testList "Experimental RealTimeDeque" [
            test "RealTimeDeque.empty dqueue should be RealTimeDeque.empty" {
                RealTimeDeque.isEmpty (RealTimeDeque.empty 2) |> Expect.isTrue "" }

            test "RealTimeDeque.cons works" {
                ((len2 |> RealTimeDeque.isEmpty) && (len2C3 |> RealTimeDeque.isEmpty)) |> Expect.isFalse "" }

            test "RealTimeDeque.snoc works" {
                ((len2snoc |> RealTimeDeque.isEmpty) && (len2C3snoc |> RealTimeDeque.isEmpty)) |> Expect.isFalse "" }

            test "RealTimeDeque.singleton RealTimeDeque.head works" {
                (((RealTimeDeque.head len1) = "a") && ((len1C3 |> RealTimeDeque.isEmpty)) = false) |> Expect.isTrue "" }
            ...
            test "RealTimeDeque.tail of RealTimeDeque.singleton RealTimeDeque.empty" {
                len1 |> RealTimeDeque.tail |> RealTimeDeque.isEmpty |> Expect.isTrue "" }

            test "RealTimeDeque.tail of RealTimeDeque.tail of 2 RealTimeDeque.empty" {
                 ( len2 |> RealTimeDeque.tail |> RealTimeDeque.tail |> RealTimeDeque.isEmpty) |> Expect.isTrue "" }

            test "RealTimeDeque.init of RealTimeDeque.singleton RealTimeDeque.empty" {
                ((RealTimeDeque.init len1)  |> RealTimeDeque.isEmpty) |> Expect.isTrue "" }
            ...
            test "RealTimeDeque.head, RealTimeDeque.tail, and RealTimeDeque.length work test 1" {
                ...
                (((RealTimeDeque.length t1) = 1) && ((RealTimeDeque.length t1C) = 1) && ((RealTimeDeque.length t1s) = 1) && ((RealTimeDeque.length t1Cs) = 1) 
                && (ht1 = "a") && (ht1C = "a") && (ht1s = "a") && (ht1Cs = "a")) |> Expect.isTrue "" }
            ...
            test "RealTimeDeque.head, RealTimeDeque.tail, and RealTimeDeque.length work test 2" {
                ...
                (((RealTimeDeque.length t1) = 2) && ((RealTimeDeque.length t1C) = 2) && ((RealTimeDeque.length t1s) = 2) && ((RealTimeDeque.length t1Cs) = 2)
                && ((RealTimeDeque.head t1) = "b") && ((RealTimeDeque.head t1C) = "b") && ((RealTimeDeque.head t1s) = "b") && ((RealTimeDeque.head t1Cs) = "b")
                && ((RealTimeDeque.length t1_1) = 1) && ((RealTimeDeque.length t1C_1) = 1) && ((RealTimeDeque.length t1_1s) = 1) && ((RealTimeDeque.length t1C_1s) = 1) 
                && ((RealTimeDeque.head t1_1) = "a") && ((RealTimeDeque.head t1C_1) = "a") && ((RealTimeDeque.head t1_1s) = "a") && ((RealTimeDeque.head t1C_1s) = "a")) |> Expect.isTrue "" }
            ...
            test "RealTimeDeque.head, RealTimeDeque.tail, and RealTimeDeque.length work test 3" {
                ...
                (((RealTimeDeque.length t1) = 3) && ((RealTimeDeque.length t1C) = 3) && ((RealTimeDeque.length t1s) = 3) && ((RealTimeDeque.length t1Cs) = 3)
                && ((RealTimeDeque.head t1) = "c") && ((RealTimeDeque.head t1C) = "c") && ((RealTimeDeque.head t1s) = "c") && ((RealTimeDeque.head t1Cs) = "c")
                && ((RealTimeDeque.length t1_2) = 2) && ((RealTimeDeque.length t1C_2) = 2) && ((RealTimeDeque.length t1_2s) = 2) && ((RealTimeDeque.length t1C_2s) = 2)
                && ((RealTimeDeque.head t1_2) = "b") && ((RealTimeDeque.head t1C_2) = "b") && ((RealTimeDeque.head t1_2s) = "b") && ((RealTimeDeque.head t1C_2s) = "b")
                && ((RealTimeDeque.length t1_1) = 1) && ((RealTimeDeque.length t1C_1) = 1) && ((RealTimeDeque.length t1_1s) = 1) && ((RealTimeDeque.length t1C_1s) = 1) 
                && ((RealTimeDeque.head t1_1) = "a") && ((RealTimeDeque.head t1C_1) = "a") && ((RealTimeDeque.head t1_1s) = "a") && ((RealTimeDeque.head t1C_1s) = "a")) |> Expect.isTrue "" }
            ...
            test "RealTimeDeque.head, RealTimeDeque.tail, and RealTimeDeque.length work test 4" {
                ...
                (((RealTimeDeque.length t1) = 4) && ((RealTimeDeque.length t1C) = 4) && ((RealTimeDeque.length t1s) = 4) && ((RealTimeDeque.length t1Cs) = 4)
                && ((RealTimeDeque.head t1) = "d") && ((RealTimeDeque.head t1C) = "d") && ((RealTimeDeque.head t1s) = "d") && ((RealTimeDeque.head t1Cs) = "d")
                && ((RealTimeDeque.length t1_3) = 3) && ((RealTimeDeque.length t1C_3) = 3) && ((RealTimeDeque.length t1_3s) = 3) && ((RealTimeDeque.length t1C_3s) = 3)
                && ((RealTimeDeque.head t1_3) = "c") && ((RealTimeDeque.head t1C_3) = "c") && ((RealTimeDeque.head t1_3s) = "c") && ((RealTimeDeque.head t1C_3s) = "c")
                && ((RealTimeDeque.length t1_2) = 2) && ((RealTimeDeque.length t1C_2) = 2) && ((RealTimeDeque.length t1_2s) = 2) && ((RealTimeDeque.length t1C_2s) = 2) 
                && ((RealTimeDeque.head t1_2) = "b") && ((RealTimeDeque.head t1C_2) = "b") && ((RealTimeDeque.head t1_2s) = "b") && ((RealTimeDeque.head t1C_2s) = "b")
                && ((RealTimeDeque.length t1_1) = 1) && ((RealTimeDeque.length t1C_1) = 1) && ((RealTimeDeque.length t1_1s) = 1) && ((RealTimeDeque.length t1C_1s) = 1) 
                && ((RealTimeDeque.head t1_1) = "a") && ((RealTimeDeque.head t1C_1) = "a") && ((RealTimeDeque.head t1_1s) = "a") && ((RealTimeDeque.head t1C_1s) = "a")) |> Expect.isTrue "" }
            ...
            test "RealTimeDeque.head, RealTimeDeque.tail, and RealTimeDeque.length work test 5" {
                ...
                (((RealTimeDeque.length t1) = 5) && ((RealTimeDeque.length t1C) = 5) && ((RealTimeDeque.length t1s) = 5) && ((RealTimeDeque.length t1Cs) = 5)
                && ((RealTimeDeque.head t1) = "e") && ((RealTimeDeque.head t1C) = "e") && ((RealTimeDeque.head t1s) = "e") && ((RealTimeDeque.head t1Cs) = "e")
                && ((RealTimeDeque.length t1_4) = 4) && ((RealTimeDeque.length t1C_4) = 4) && ((RealTimeDeque.length t1_4s) = 4) && ((RealTimeDeque.length t1C_4s) = 4)
                && ((RealTimeDeque.head t1_4) = "d") && ((RealTimeDeque.head t1C_4) = "d") && ((RealTimeDeque.head t1_4s) = "d") && ((RealTimeDeque.head t1C_4s) = "d")
                && ((RealTimeDeque.length t1_3) = 3) && ((RealTimeDeque.length t1C_3) = 3) && ((RealTimeDeque.length t1_3s) = 3) && ((RealTimeDeque.length t1C_3s) = 3)
                && ((RealTimeDeque.head t1_3) = "c") && ((RealTimeDeque.head t1C_3) = "c") && ((RealTimeDeque.head t1_3s) = "c") && ((RealTimeDeque.head t1C_3s) = "c")
                && ((RealTimeDeque.length t1_2) = 2) && ((RealTimeDeque.length t1C_2) = 2) && ((RealTimeDeque.length t1_2s) = 2) && ((RealTimeDeque.length t1C_2s) = 2) 
                && ((RealTimeDeque.head t1_2) = "b") && ((RealTimeDeque.head t1C_2) = "b") && ((RealTimeDeque.head t1_2s) = "b") && ((RealTimeDeque.head t1C_2s) = "b")
            ...
            test "RealTimeDeque.head, RealTimeDeque.tail, and RealTimeDeque.length work test 6" {
                ...
                (((RealTimeDeque.length t1) = 6) && ((RealTimeDeque.length t1C) = 6) && ((RealTimeDeque.length t1s) = 6) && ((RealTimeDeque.length t1Cs) = 6)
                && ((RealTimeDeque.head t1) = "f") && ((RealTimeDeque.head t1C) = "f") && ((RealTimeDeque.head t1s) = "f") && ((RealTimeDeque.head t1Cs) = "f")
                && ((RealTimeDeque.length t1_5) = 5) && ((RealTimeDeque.length t1C_5) = 5) && ((RealTimeDeque.length t1_5s) = 5) && ((RealTimeDeque.length t1C_5s) = 5)
                && ((RealTimeDeque.head t1_5) = "e") && ((RealTimeDeque.head t1C_5) = "e") && ((RealTimeDeque.head t1_5s) = "e") && ((RealTimeDeque.head t1C_5s) = "e")
                && ((RealTimeDeque.length t1_4) = 4) && ((RealTimeDeque.length t1C_4) = 4) && ((RealTimeDeque.length t1_4s) = 4) && ((RealTimeDeque.length t1C_4s) = 4)
                && ((RealTimeDeque.head t1_4) = "d") && ((RealTimeDeque.head t1C_4) = "d") && ((RealTimeDeque.head t1_4s) = "d") && ((RealTimeDeque.head t1C_4s) = "d")
                && ((RealTimeDeque.length t1_3) = 3) && ((RealTimeDeque.length t1C_3) = 3) && ((RealTimeDeque.length t1_3s) = 3) && ((RealTimeDeque.length t1C_3s) = 3)
                && ((RealTimeDeque.head t1_3) = "c") && ((RealTimeDeque.head t1C_3) = "c") && ((RealTimeDeque.head t1_3s) = "c") && ((RealTimeDeque.head t1C_3s) = "c")
            ...
            test "RealTimeDeque.head, RealTimeDeque.tail, and RealTimeDeque.length work test 7" {
                ...
                (((RealTimeDeque.length t1) = 7) && ((RealTimeDeque.length t1C) = 7) && ((RealTimeDeque.length t1s) = 7) && ((RealTimeDeque.length t1Cs) = 7)
                && ((RealTimeDeque.head t1) = "g") && ((RealTimeDeque.head t1C) = "g") && ((RealTimeDeque.head t1s) = "g") && ((RealTimeDeque.head t1Cs) = "g")
                && ((RealTimeDeque.length t1_6) = 6) && ((RealTimeDeque.length t1C_6) = 6) && ((RealTimeDeque.length t1_6s) = 6) && ((RealTimeDeque.length t1C_6s) = 6)
                && ((RealTimeDeque.head t1_6) = "f") && ((RealTimeDeque.head t1C_6) = "f") && ((RealTimeDeque.head t1_6s) = "f") && ((RealTimeDeque.head t1C_6s) = "f")
                && ((RealTimeDeque.length t1_5) = 5) && ((RealTimeDeque.length t1C_5) = 5) && ((RealTimeDeque.length t1_5s) = 5) && ((RealTimeDeque.length t1C_5s) = 5)
                && ((RealTimeDeque.head t1_5) = "e") && ((RealTimeDeque.head t1C_5) = "e") && ((RealTimeDeque.head t1_5s) = "e") && ((RealTimeDeque.head t1C_5s) = "e")
                && ((RealTimeDeque.length t1_4) = 4) && ((RealTimeDeque.length t1C_4) = 4) && ((RealTimeDeque.length t1_4s) = 4) && ((RealTimeDeque.length t1C_4s) = 4)
                && ((RealTimeDeque.head t1_4) = "d") && ((RealTimeDeque.head t1C_4) = "d") && ((RealTimeDeque.head t1_4s) = "d") && ((RealTimeDeque.head t1C_4s) = "d")
            ...
            test "RealTimeDeque.head, RealTimeDeque.tail, and RealTimeDeque.length work test 8" {
                ...
                (((RealTimeDeque.length t1) = 8) && ((RealTimeDeque.length t1C) = 8) && ((RealTimeDeque.length t1s) = 8) && ((RealTimeDeque.length t1Cs) = 8)
                && ((RealTimeDeque.head t1) = "h") && ((RealTimeDeque.head t1C) = "h") && ((RealTimeDeque.head t1s) = "h") && ((RealTimeDeque.head t1Cs) = "h")
                && ((RealTimeDeque.length t1_7) = 7) && ((RealTimeDeque.length t1C_7) = 7) && ((RealTimeDeque.length t1_7s) = 7) && ((RealTimeDeque.length t1C_7s) = 7)
                && ((RealTimeDeque.head t1_7) = "g") && ((RealTimeDeque.head t1C_7) = "g") && ((RealTimeDeque.head t1_7s) = "g") && ((RealTimeDeque.head t1C_7s) = "g")
                && ((RealTimeDeque.length t1_6) = 6) && ((RealTimeDeque.length t1C_6) = 6) && ((RealTimeDeque.length t1_6s) = 6) && ((RealTimeDeque.length t1C_6s) = 6)
                && ((RealTimeDeque.head t1_6) = "f") && ((RealTimeDeque.head t1C_6) = "f") && ((RealTimeDeque.head t1_6s) = "f") && ((RealTimeDeque.head t1C_6s) = "f")
                && ((RealTimeDeque.length t1_5) = 5) && ((RealTimeDeque.length t1C_5) = 5) && ((RealTimeDeque.length t1_5s) = 5) && ((RealTimeDeque.length t1C_5s) = 5)
                && ((RealTimeDeque.head t1_5) = "e") && ((RealTimeDeque.head t1C_5) = "e") && ((RealTimeDeque.head t1_5s) = "e") && ((RealTimeDeque.head t1C_5s) = "e")
            ...
            test "RealTimeDeque.head, RealTimeDeque.tail, and RealTimeDeque.length work test 9" {
                ...
                (((RealTimeDeque.length t1) = 9) && ((RealTimeDeque.length t1C) = 9) && ((RealTimeDeque.length t1s) = 9) && ((RealTimeDeque.length t1Cs) = 9)
                && ((RealTimeDeque.head t1) = "i") && ((RealTimeDeque.head t1C) = "i") && ((RealTimeDeque.head t1s) = "i") && ((RealTimeDeque.head t1Cs) = "i")
                && ((RealTimeDeque.length t1_8) = 8) && ((RealTimeDeque.length t1C_8) = 8) && ((RealTimeDeque.length t1_8s) = 8) && ((RealTimeDeque.length t1C_8s) = 8)
                && ((RealTimeDeque.head t1_8) = "h") && ((RealTimeDeque.head t1C_8) = "h") && ((RealTimeDeque.head t1_8s) = "h") && ((RealTimeDeque.head t1C_8s) = "h")
                && ((RealTimeDeque.length t1_7) = 7) && ((RealTimeDeque.length t1C_7) = 7) && ((RealTimeDeque.length t1_7s) = 7) && ((RealTimeDeque.length t1C_7s) = 7)
                && ((RealTimeDeque.head t1_7) = "g") && ((RealTimeDeque.head t1C_7) = "g") && ((RealTimeDeque.head t1_7s) = "g") && ((RealTimeDeque.head t1C_7s) = "g")
                && ((RealTimeDeque.length t1_6) = 6) && ((RealTimeDeque.length t1C_6) = 6) && ((RealTimeDeque.length t1_6s) = 6) && ((RealTimeDeque.length t1C_6s) = 6)
                && ((RealTimeDeque.head t1_6) = "f") && ((RealTimeDeque.head t1C_6) = "f") && ((RealTimeDeque.head t1_6s) = "f") && ((RealTimeDeque.head t1C_6s) = "f")
            ...
            test "RealTimeDeque.last, RealTimeDeque.init, and RealTimeDeque.length work test 1" {  
                ...
                (((RealTimeDeque.length t1) = 1) && ((RealTimeDeque.length t1C) = 1) && ((RealTimeDeque.last t1) = "b") && ((RealTimeDeque.last t1C) = "b")) |> Expect.isTrue "" }
            ...
            test "RealTimeDeque.last, RealTimeDeque.init, and RealTimeDeque.length work test 2" {
                ...
                (((RealTimeDeque.length t1) = 2) && ((RealTimeDeque.length t1C) = 2) && (lt1 = "b") && (lt1C = "b") && ((RealTimeDeque.length t1_1) = 1) 
                && ((RealTimeDeque.length t1C_1) = 1) && (lt1_1 = "c") 
                && (lt1C_1 = "c")) |> Expect.isTrue "" }
            ...
            test "RealTimeDeque.last, RealTimeDeque.init, and RealTimeDeque.length work test 3" {
                ...
                (((RealTimeDeque.length t1) = 3) && ((RealTimeDeque.length t1C) = 3) && ((RealTimeDeque.last t1) = "b") && ((RealTimeDeque.last t1C) = "b") 
                && ((RealTimeDeque.length t1_1) = 2) && ((RealTimeDeque.length t1C_1) = 2) && ((RealTimeDeque.last t1_1) = "c") && ((RealTimeDeque.last t1C_1) = "c")
                && ((RealTimeDeque.length t1_2) = 1) && ((RealTimeDeque.length t1C_2) = 1) && ((RealTimeDeque.last t1_2) = "d") && ((RealTimeDeque.last t1C_2) = "d")) |> Expect.isTrue "" }
            ...
            test "RealTimeDeque.last, RealTimeDeque.init, and RealTimeDeque.length work test 4" {
                ...
                (((RealTimeDeque.length t1) = 4) && ((RealTimeDeque.length t1C) = 4) && ((RealTimeDeque.last t1) = "b") && ((RealTimeDeque.last t1C) = "b") 
                && ((RealTimeDeque.length t1_1) = 3) && ((RealTimeDeque.length t1C_1) = 3) && ((RealTimeDeque.last t1_1) = "c") && ((RealTimeDeque.last t1C_1) = "c")
                && ((RealTimeDeque.length t1_2) = 2) && ((RealTimeDeque.length t1C_2) = 2) && ((RealTimeDeque.last t1_2) = "d") && ((RealTimeDeque.last t1C_2) = "d")
                && ((RealTimeDeque.length t1_3) = 1) && ((RealTimeDeque.length t1C_3) = 1) && ((RealTimeDeque.last t1_3) = "e") && ((RealTimeDeque.last t1C_3) = "e")) |> Expect.isTrue "" }
            ...
            test "RealTimeDeque.last, RealTimeDeque.init, and RealTimeDeque.length work test 5" {
                ...
                (((RealTimeDeque.length t1) = 5) && ((RealTimeDeque.length t1C) = 5) && ((RealTimeDeque.last t1) = "b") && ((RealTimeDeque.last t1C) = "b") 
                && ((RealTimeDeque.length t1_1) = 4) && ((RealTimeDeque.length t1C_1) = 4) && ((RealTimeDeque.last t1_1) = "c") && ((RealTimeDeque.last t1C_1) = "c")
                && ((RealTimeDeque.length t1_2) = 3) && ((RealTimeDeque.length t1C_2) = 3) && ((RealTimeDeque.last t1_2) = "d") && ((RealTimeDeque.last t1C_2) = "d")
                && ((RealTimeDeque.length t1_3) = 2) && ((RealTimeDeque.length t1C_3) = 2) && ((RealTimeDeque.last t1_3) = "e") && ((RealTimeDeque.last t1C_3) = "e")
                && ((RealTimeDeque.length t1_4) = 1) && ((RealTimeDeque.length t1C_4) = 1) && ((RealTimeDeque.last t1_4) = "f") && ((RealTimeDeque.last t1C_4) = "f")) |> Expect.isTrue "" }
            ...
            test "RealTimeDeque.last, RealTimeDeque.init, and RealTimeDeque.length work test 6" {
                ...
                (((RealTimeDeque.length t1) = 6) && ((RealTimeDeque.length t1C) = 6) && ((RealTimeDeque.last t1) = "b") && ((RealTimeDeque.last t1C) = "b") 
                && ((RealTimeDeque.length t1_1) = 5) && ((RealTimeDeque.length t1C_1) = 5) && ((RealTimeDeque.last t1_1) = "c") && ((RealTimeDeque.last t1C_1) = "c")
                && ((RealTimeDeque.length t1_2) = 4) && ((RealTimeDeque.length t1C_2) = 4) && ((RealTimeDeque.last t1_2) = "d") && ((RealTimeDeque.last t1C_2) = "d")
                && ((RealTimeDeque.length t1_3) = 3) && ((RealTimeDeque.length t1C_3) = 3) && ((RealTimeDeque.last t1_3) = "e") && ((RealTimeDeque.last t1C_3) = "e")
                && ((RealTimeDeque.length t1_4) = 2) && ((RealTimeDeque.length t1C_4) = 2) && ((RealTimeDeque.last t1_4) = "f") && ((RealTimeDeque.last t1C_4) = "f")
                && ((RealTimeDeque.length t1_5) = 1) && ((RealTimeDeque.length t1C_5) = 1) && ((RealTimeDeque.last t1_5) = "g") && ((RealTimeDeque.last t1C_5) = "g")) |> Expect.isTrue "" }
            ...
            test "RealTimeDeque.last, RealTimeDeque.init, and RealTimeDeque.length work test 7" {
                ...
                (((RealTimeDeque.length t1) = 7) && ((RealTimeDeque.length t1C) = 7) && ((RealTimeDeque.last t1) = "b") && ((RealTimeDeque.last t1C) = "b") 
                && ((RealTimeDeque.length t1_1) = 6) && ((RealTimeDeque.length t1C_1) = 6) && ((RealTimeDeque.last t1_1) = "c") && ((RealTimeDeque.last t1C_1) = "c")
                && ((RealTimeDeque.length t1_2) = 5) && ((RealTimeDeque.length t1C_2) = 5) && ((RealTimeDeque.last t1_2) = "d") && ((RealTimeDeque.last t1C_2) = "d")
                && ((RealTimeDeque.length t1_3) = 4) && ((RealTimeDeque.length t1C_3) = 4) && ((RealTimeDeque.last t1_3) = "e") && ((RealTimeDeque.last t1C_3) = "e")
                && ((RealTimeDeque.length t1_4) = 3) && ((RealTimeDeque.length t1C_4) = 3) && ((RealTimeDeque.last t1_4) = "f") && ((RealTimeDeque.last t1C_4) = "f")
                && ((RealTimeDeque.length t1_5) = 2) && ((RealTimeDeque.length t1C_5) = 2) && ((RealTimeDeque.last t1_5) = "g") && ((RealTimeDeque.last t1C_5) = "g")
                && ((RealTimeDeque.length t1_6) = 1) && ((RealTimeDeque.length t1C_6) = 1) && ((RealTimeDeque.last t1_6) = "h") && ((RealTimeDeque.last t1C_6) = "h")) |> Expect.isTrue "" }
            ...
            test "RealTimeDeque.last, RealTimeDeque.init, and RealTimeDeque.length work test 8" {
                ...
                (((RealTimeDeque.length t1) = 8) && ((RealTimeDeque.length t1C) = 8) && ((RealTimeDeque.last t1) = "b") && ((RealTimeDeque.last t1C) = "b") 
                && ((RealTimeDeque.length t1_1) = 7) && ((RealTimeDeque.length t1C_1) = 7) && ((RealTimeDeque.last t1_1) = "c") && ((RealTimeDeque.last t1C_1) = "c")
                && ((RealTimeDeque.length t1_2) = 6) && ((RealTimeDeque.length t1C_2) = 6) && ((RealTimeDeque.last t1_2) = "d") && ((RealTimeDeque.last t1C_2) = "d")
                && ((RealTimeDeque.length t1_3) = 5) && ((RealTimeDeque.length t1C_3) = 5) && ((RealTimeDeque.last t1_3) = "e") && ((RealTimeDeque.last t1C_3) = "e")
                && ((RealTimeDeque.length t1_4) = 4) && ((RealTimeDeque.length t1C_4) = 4) && ((RealTimeDeque.last t1_4) = "f") && ((RealTimeDeque.last t1C_4) = "f")
                && ((RealTimeDeque.length t1_5) = 3) && ((RealTimeDeque.length t1C_5) = 3) && ((RealTimeDeque.last t1_5) = "g") && ((RealTimeDeque.last t1C_5) = "g")
                && ((RealTimeDeque.length t1_6) = 2) && ((RealTimeDeque.length t1C_6) = 2) && ((RealTimeDeque.last t1_6) = "h") && ((RealTimeDeque.last t1C_6) = "h")
                && ((RealTimeDeque.length t1_7) = 1) && ((RealTimeDeque.length t1C_7) = 1) && ((RealTimeDeque.last t1_7) = "i") && ((RealTimeDeque.last t1C_7) = "i")) |> Expect.isTrue "" }
            ...
            test "RealTimeDeque.last, RealTimeDeque.init, and RealTimeDeque.length work test 9" {
                ...
                (((RealTimeDeque.length t1) = 9) && ((RealTimeDeque.length t1C) = 9) && ((RealTimeDeque.last t1) = "b") && ((RealTimeDeque.last t1C) = "b") 
                && ((RealTimeDeque.length t1_1) = 8) && ((RealTimeDeque.length t1C_1) = 8) && ((RealTimeDeque.last t1_1) = "c") && ((RealTimeDeque.last t1C_1) = "c")
                && ((RealTimeDeque.length t1_2) = 7) && ((RealTimeDeque.length t1C_2) = 7) && ((RealTimeDeque.last t1_2) = "d") && ((RealTimeDeque.last t1C_2) = "d")
                && ((RealTimeDeque.length t1_3) = 6) && ((RealTimeDeque.length t1C_3) = 6) && ((RealTimeDeque.last t1_3) = "e") && ((RealTimeDeque.last t1C_3) = "e")
                && ((RealTimeDeque.length t1_4) = 5) && ((RealTimeDeque.length t1C_4) = 5) && ((RealTimeDeque.last t1_4) = "f") && ((RealTimeDeque.last t1C_4) = "f")
                && ((RealTimeDeque.length t1_5) = 4) && ((RealTimeDeque.length t1C_5) = 4) && ((RealTimeDeque.last t1_5) = "g") && ((RealTimeDeque.last t1C_5) = "g")
                && ((RealTimeDeque.length t1_6) = 3) && ((RealTimeDeque.length t1C_6) = 3) && ((RealTimeDeque.last t1_6) = "h") && ((RealTimeDeque.last t1C_6) = "h")
                && ((RealTimeDeque.length t1_7) = 2) && ((RealTimeDeque.length t1C_7) = 2) && ((RealTimeDeque.last t1_7) = "i") && ((RealTimeDeque.last t1C_7) = "i")
                && ((RealTimeDeque.length t1_8) = 1) && ((RealTimeDeque.length t1C_8) = 1) && ((RealTimeDeque.last t1_8) = "j") && ((RealTimeDeque.last t1C_8) = "j")) |> Expect.isTrue "" }

            test "IEnumerable Seq" {
                (lena |> Seq.toArray).[5] |> Expect.equal "" "e" } 

            test "IEnumerable Seq RealTimeDeque.length" {
                lena |> Seq.length |> Expect.equal "" 10 } 

            test "type RealTimeDeque.cons works" {
                lena.Cons "zz" |> RealTimeDeque.head |> Expect.equal "" "zz" } 
            ...
            test "RealTimeDeque.ofCatLists and RealTimeDeque.uncons" {
                ...
                ((h1 = "a") && (h2 = "b") && (h3 = "c") && (h4 = "d") && (h5 = "e") && (h6 = "f") && (RealTimeDeque.isEmpty t6)) |> Expect.isTrue "" }
            ...
            test "unsnoc works" {
                ...
                ((l1 = "a") && (l2 = "b") && (l3 = "c") && (l4 = "d") && (l5 = "e") && (l6 = "f") && (RealTimeDeque.isEmpty i6)) |> Expect.isTrue "" }
            ...
            test "RealTimeDeque.rev RealTimeDeque.empty dqueue should be RealTimeDeque.empty" {
                RealTimeDeque.isEmpty (RealTimeDeque.rev (RealTimeDeque.empty 2)) |> Expect.isTrue "" }

            test "RealTimeDeque.rev dqueue RealTimeDeque.length 1" {
                ((RealTimeDeque.head (RealTimeDeque.rev len1) = "a") && (RealTimeDeque.head (RealTimeDeque.rev len1C3) = "a")) |> Expect.isTrue "" }
            ...
            test "RealTimeDeque.ofSeq and RealTimeDeque.ofSeqC RealTimeDeque.empty" {
                ((RealTimeDeque.isEmpty (RealTimeDeque.ofSeq [])) && (RealTimeDeque.isEmpty (RealTimeDeque.ofSeqC 3 []))) |> Expect.isTrue "" }

            test "RealTimeDeque.ofSeq and RealTimeDeque.ofSeqC RealTimeDeque.length 1" {
                ((RealTimeDeque.head       (RealTimeDeque.ofSeq ["a"])      = "a") && (RealTimeDeque.head      (RealTimeDeque.ofSeqC 3 ["a"])      = "a")) |> Expect.isTrue "" }
            ...
            test "appending RealTimeDeque.empty dqueus" {
                ((RealTimeDeque.isEmpty (RealTimeDeque.append (RealTimeDeque.ofSeq []) (RealTimeDeque.ofSeq []) )) && (RealTimeDeque.isEmpty (RealTimeDeque.append (RealTimeDeque.empty 3) (RealTimeDeque.empty 3)))
                ) |> Expect.isTrue "" }

            test "appending RealTimeDeque.empty and RealTimeDeque.length 1" {
                ((RealTimeDeque.head (RealTimeDeque.append (RealTimeDeque.ofSeq []) len1) = "a") && (RealTimeDeque.head (RealTimeDeque.append len1 (RealTimeDeque.empty 3)) = "a")) |> Expect.isTrue "" }

            test "appending RealTimeDeque.empty and RealTimeDeque.length 2" {
                let r1 = RealTimeDeque.append (RealTimeDeque.ofSeq []) (RealTimeDeque.ofSeq ["a";"b"])
                let r1c = RealTimeDeque.append (RealTimeDeque.empty 3) (RealTimeDeque.ofSeqC 3 ["a";"b"])
                let h1 = RealTimeDeque.head r1
                let h1c = RealTimeDeque.head r1c
                let t2 = RealTimeDeque.tail r1
                let t2c = RealTimeDeque.tail r1c
                ...
                let r1r = RealTimeDeque.append (RealTimeDeque.ofSeq ["a";"b"]) (RealTimeDeque.ofSeq [])
                let r1cr = RealTimeDeque.append (RealTimeDeque.ofSeqC 3 ["a";"b"]) (RealTimeDeque.empty 3)
            ...
            test "appending RealTimeDeque.length 1 and RealTimeDeque.length 2" {
                let r1 = RealTimeDeque.append (RealTimeDeque.ofSeq ["a"]) (RealTimeDeque.ofSeq ["b";"c"])
                let r1c = RealTimeDeque.append (RealTimeDeque.ofSeqC 3 ["a"]) (RealTimeDeque.ofSeqC 3 ["b";"c"])
                let h1 = RealTimeDeque.head r1
                let h1c = RealTimeDeque.head r1c
                let t2 = RealTimeDeque.tail r1
                let t2c = RealTimeDeque.tail r1c
                ...
                let r1r = RealTimeDeque.append (RealTimeDeque.ofSeq ["a";"b"]) (RealTimeDeque.ofSeq ["c"])
                let r1cr = RealTimeDeque.append (RealTimeDeque.ofSeqC 3 ["a";"b"]) (RealTimeDeque.ofSeqC 3 ["c"])
                let h1r = RealTimeDeque.head r1r
                let h1cr = RealTimeDeque.head r1cr
                let t2r = RealTimeDeque.tail r1r
                let t2cr = RealTimeDeque.tail r1cr
            ...
            test "appending RealTimeDeque.length 1 and RealTimeDeque.length 3" {
                let r1 = RealTimeDeque.append (RealTimeDeque.ofSeq ["a"]) (RealTimeDeque.ofSeq ["b";"c";"d"])
                let r1c = RealTimeDeque.append (RealTimeDeque.ofSeqC 3 ["a"]) (RealTimeDeque.ofSeqC 3 ["b";"c";"d"])
                let h1 = RealTimeDeque.head r1
                let h1c = RealTimeDeque.head r1c
                let t2 = RealTimeDeque.tail r1
                let t2c = RealTimeDeque.tail r1c
                ...
                let r1r = RealTimeDeque.append (RealTimeDeque.ofSeq ["a";"b";"c"]) (RealTimeDeque.ofSeq ["d"])
                let r1cr = RealTimeDeque.append (RealTimeDeque.ofSeqC 3 ["a";"b";"c"]) (RealTimeDeque.ofSeqC 3 ["d"])
                let h1r = RealTimeDeque.head r1r
                let h1cr = RealTimeDeque.head r1cr
                let t2r = RealTimeDeque.tail r1r
                let t2cr = RealTimeDeque.tail r1cr
            ...
            test "appending RealTimeDeque.length 1 and RealTimeDeque.length 4" {
                let r1 = RealTimeDeque.append (RealTimeDeque.ofSeq ["a"]) (RealTimeDeque.ofSeq ["b";"c";"d";"e"])
                let r1c = RealTimeDeque.append (RealTimeDeque.ofSeqC 3 ["a"]) (RealTimeDeque.ofSeqC 3 ["b";"c";"d";"e"])
                let h1 = RealTimeDeque.head r1
                let h1c = RealTimeDeque.head r1c
                let t2 = RealTimeDeque.tail r1
                let t2c = RealTimeDeque.tail r1c
                ...
                let r1r = RealTimeDeque.append (RealTimeDeque.ofSeq ["a";"b";"c";"d"]) (RealTimeDeque.ofSeq ["e"])
                let r1cr = RealTimeDeque.append (RealTimeDeque.ofSeqC 3 ["a";"b";"c";"d"]) (RealTimeDeque.ofSeqC 3 ["e"])
                let h1r = RealTimeDeque.head r1r
                let h1cr = RealTimeDeque.head r1cr
                let t2r = RealTimeDeque.tail r1r
                let t2cr = RealTimeDeque.tail r1cr
            ...
            test "appending RealTimeDeque.length 1 and RealTimeDeque.length 5" {
                let r1 = RealTimeDeque.append (RealTimeDeque.ofSeq ["a"]) (RealTimeDeque.ofSeq ["b";"c";"d";"e";"f"])
                let r1c = RealTimeDeque.append (RealTimeDeque.ofSeqC 3 ["a"]) (RealTimeDeque.ofSeqC 3 ["b";"c";"d";"e";"f"])
                let h1 = RealTimeDeque.head r1
                let h1c = RealTimeDeque.head r1c
                let t2 = RealTimeDeque.tail r1
                let t2c = RealTimeDeque.tail r1c
                ...
                let r1r = RealTimeDeque.append (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e"]) (RealTimeDeque.ofSeq ["f"])
                let r1cr = RealTimeDeque.append (RealTimeDeque.ofSeqC 3 ["a";"b";"c";"d";"e"]) (RealTimeDeque.ofSeqC 3 ["f"])
                let h1r = RealTimeDeque.head r1r
                let h1cr = RealTimeDeque.head r1cr
                let t2r = RealTimeDeque.tail r1r
                let t2cr = RealTimeDeque.tail r1cr
            ...
            test "appending RealTimeDeque.length 2 and RealTimeDeque.length 2" {
                let r1 = RealTimeDeque.append (RealTimeDeque.ofSeq ["a";"b"]) (RealTimeDeque.ofSeq ["c";"d"])
                let r1c = RealTimeDeque.append (RealTimeDeque.ofSeqC 3 ["a";"b"]) (RealTimeDeque.ofSeqC 3 ["c";"d"])
                let h1 = RealTimeDeque.head r1
                let h1c = RealTimeDeque.head r1c
                let t2 = RealTimeDeque.tail r1
                let t2c = RealTimeDeque.tail r1c
            ...
            test "appending RealTimeDeque.length 2 and RealTimeDeque.length 3" {
                let r1 = RealTimeDeque.append (RealTimeDeque.ofSeq ["a";"b"]) (RealTimeDeque.ofSeq ["c";"d";"e"])
                let r1c = RealTimeDeque.append (RealTimeDeque.ofSeqC 3 ["a";"b"]) (RealTimeDeque.ofSeqC 3 ["c";"d";"e"])
                let h1 = RealTimeDeque.head r1
                let h1c = RealTimeDeque.head r1c
                let t2 = RealTimeDeque.tail r1
                let t2c = RealTimeDeque.tail r1c
                ...
                let r1r = RealTimeDeque.append (RealTimeDeque.ofSeq ["a";"b";"c"]) (RealTimeDeque.ofSeq ["d";"e"])
                let r1cr = RealTimeDeque.append (RealTimeDeque.ofSeqC 3 ["a";"b";"c"]) (RealTimeDeque.ofSeqC 3 ["d";"e"])
                let h1r = RealTimeDeque.head r1r
                let h1cr = RealTimeDeque.head r1cr
                let t2r = RealTimeDeque.tail r1r
                let t2cr = RealTimeDeque.tail r1cr
            ...
            test "appending RealTimeDeque.length 2 and RealTimeDeque.length 4" {
                let r1 = RealTimeDeque.append (RealTimeDeque.ofSeq ["a";"b"]) (RealTimeDeque.ofSeq ["c";"d";"e";"f"])
                let r1c = RealTimeDeque.append (RealTimeDeque.ofSeqC 3 ["a";"b"]) (RealTimeDeque.ofSeqC 3 ["c";"d";"e";"f"])
                let h1 = RealTimeDeque.head r1
                let h1c = RealTimeDeque.head r1c
                let t2 = RealTimeDeque.tail r1
                let t2c = RealTimeDeque.tail r1c
                ...
                let r1r = RealTimeDeque.append (RealTimeDeque.ofSeq ["a";"b";"c";"d"]) (RealTimeDeque.ofSeq ["e";"f"])
                let r1cr = RealTimeDeque.append (RealTimeDeque.ofSeqC 3 ["a";"b";"c";"d"]) (RealTimeDeque.ofSeqC 3 ["e";"f"])
                let h1r = RealTimeDeque.head r1r
                let h1cr = RealTimeDeque.head r1cr
                let t2r = RealTimeDeque.tail r1r
                let t2cr = RealTimeDeque.tail r1cr
            ...
            test "appending RealTimeDeque.length 2 and RealTimeDeque.length 5" {
                let r1 = RealTimeDeque.append (RealTimeDeque.ofSeq ["a";"b"]) (RealTimeDeque.ofSeq ["c";"d";"e";"f";"g"])
                let r1c = RealTimeDeque.append (RealTimeDeque.ofSeqC 3 ["a";"b"]) (RealTimeDeque.ofSeqC 3 ["c";"d";"e";"f";"g"])
                let h1 = RealTimeDeque.head r1
                let h1c = RealTimeDeque.head r1c
                let t2 = RealTimeDeque.tail r1
                let t2c = RealTimeDeque.tail r1c
                ...
                let r1r = RealTimeDeque.append (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e"]) (RealTimeDeque.ofSeq ["f";"g"])
                let r1cr = RealTimeDeque.append (RealTimeDeque.ofSeqC 3 ["a";"b";"c";"d";"e"]) (RealTimeDeque.ofSeqC 3 ["f";"g"])
                let h1r = RealTimeDeque.head r1r
                let h1cr = RealTimeDeque.head r1cr
                let t2r = RealTimeDeque.tail r1r
                let t2cr = RealTimeDeque.tail r1cr
            ...
            test "appending RealTimeDeque.length 3 and RealTimeDeque.length 3" {
                let r1 = RealTimeDeque.append (RealTimeDeque.ofSeq ["a";"b";"c"]) (RealTimeDeque.ofSeq ["d";"e";"f"])
                let r1c = RealTimeDeque.append (RealTimeDeque.ofSeqC 3 ["a";"b";"c"]) (RealTimeDeque.ofSeqC 3 ["d";"e";"f"])
                let h1 = RealTimeDeque.head r1
                let h1c = RealTimeDeque.head r1c
                let t2 = RealTimeDeque.tail r1
                let t2c = RealTimeDeque.tail r1c
            ...
            test "appending RealTimeDeque.length 6 and RealTimeDeque.length 7" {
                let r1 = RealTimeDeque.append (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e";"f"]) (RealTimeDeque.ofSeq ["g";"h";"i";"j";"k";"l";"m"])
                let r1c = RealTimeDeque.append (RealTimeDeque.ofSeqC 3 ["a";"b";"c";"d";"e";"f"]) (RealTimeDeque.ofSeqC 3 ["g";"h";"i";"j";"k";"l";"m"])
                let h1 = RealTimeDeque.head r1
                let h1c = RealTimeDeque.head r1c
                let t2 = RealTimeDeque.tail r1
                let t2c = RealTimeDeque.tail r1c
                ...
                let r1r = RealTimeDeque.append (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e";"f";"g"]) (RealTimeDeque.ofSeq ["h";"i";"j";"k";"l";"m"])
                let r1cr = RealTimeDeque.append (RealTimeDeque.ofSeqC 3 ["a";"b";"c";"d";"e";"f";"g"]) (RealTimeDeque.ofSeqC 3 ["h";"i";"j";"k";"l";"m"])
                let h1r = RealTimeDeque.head r1r
                let h1cr = RealTimeDeque.head r1cr
                let t2r = RealTimeDeque.tail r1r
                let t2cr = RealTimeDeque.tail r1cr
            ...
            test "RealTimeDeque.lookup RealTimeDeque.length 2" {
                (((len2 |> RealTimeDeque.lookup 0) = "b") && ((len2 |> RealTimeDeque.lookup 1) = "a")) |> Expect.isTrue "" }

            test "RealTimeDeque.lookup RealTimeDeque.length 3" {
                (((len3 |> RealTimeDeque.lookup 0) = "c") && ((len3 |> RealTimeDeque.lookup 1) = "b") && ((len3 |> RealTimeDeque.lookup 2) = "a")) |> Expect.isTrue "" }

            test "RealTimeDeque.lookup RealTimeDeque.length 4" {
                (((len4 |> RealTimeDeque.lookup 0) = "d") && ((len4 |> RealTimeDeque.lookup 1) = "c") && ((len4 |> RealTimeDeque.lookup 2) = "b") && ((len4 |> RealTimeDeque.lookup 3) = "a")) 
                |> Expect.isTrue "" }

            test "RealTimeDeque.lookup RealTimeDeque.length 5" {
                (((len5 |> RealTimeDeque.lookup 0) = "e") && ((len5 |> RealTimeDeque.lookup 1) = "d") && ((len5 |> RealTimeDeque.lookup 2) = "c") && ((len5 |> RealTimeDeque.lookup 3) = "b") 
                && ((len5 |> RealTimeDeque.lookup 4) = "a")) |> Expect.isTrue "" }

            test "RealTimeDeque.lookup RealTimeDeque.length 6" {
                (((len6 |> RealTimeDeque.lookup 0) = "f") && ((len6 |> RealTimeDeque.lookup 1) = "e") && ((len6 |> RealTimeDeque.lookup 2) = "d") && ((len6 |> RealTimeDeque.lookup 3) = "c") 
                && ((len6 |> RealTimeDeque.lookup 4) = "b") && ((len6 |> RealTimeDeque.lookup 5) = "a")) |> Expect.isTrue "" }

            test "RealTimeDeque.lookup RealTimeDeque.length 7" {
                (((len7 |> RealTimeDeque.lookup 0) = "g") && ((len7 |> RealTimeDeque.lookup 1) = "f") && ((len7 |> RealTimeDeque.lookup 2) = "e") && ((len7 |> RealTimeDeque.lookup 3) = "d") 
                && ((len7 |> RealTimeDeque.lookup 4) = "c") && ((len7 |> RealTimeDeque.lookup 5) = "b") && ((len7 |> RealTimeDeque.lookup 6) = "a")) |> Expect.isTrue "" }

            test "RealTimeDeque.lookup RealTimeDeque.length 8" {
                (((len8 |> RealTimeDeque.lookup 0) = "h") && ((len8 |> RealTimeDeque.lookup 1) = "g") && ((len8 |> RealTimeDeque.lookup 2) = "f") && ((len8 |> RealTimeDeque.lookup 3) = "e") 
                && ((len8 |> RealTimeDeque.lookup 4) = "d") && ((len8 |> RealTimeDeque.lookup 5) = "c") && ((len8 |> RealTimeDeque.lookup 6) = "b") && ((len8 |> RealTimeDeque.lookup 7) = "a")) 
                |> Expect.isTrue "" }

            test "RealTimeDeque.lookup RealTimeDeque.length 9" {
                (((len9 |> RealTimeDeque.lookup 0) = "i") && ((len9 |> RealTimeDeque.lookup 1) = "h") && ((len9 |> RealTimeDeque.lookup 2) = "g") && ((len9 |> RealTimeDeque.lookup 3) = "f") 
                && ((len9 |> RealTimeDeque.lookup 4) = "e") && ((len9 |> RealTimeDeque.lookup 5) = "d") && ((len9 |> RealTimeDeque.lookup 6) = "c") && ((len9 |> RealTimeDeque.lookup 7) = "b")
                && ((len9 |> RealTimeDeque.lookup 8) = "a")) |> Expect.isTrue "" }

            test "RealTimeDeque.lookup RealTimeDeque.length 10" {
                (((lena |> RealTimeDeque.lookup 0) = "j") && ((lena |> RealTimeDeque.lookup 1) = "i") && ((lena |> RealTimeDeque.lookup 2) = "h") && ((lena |> RealTimeDeque.lookup 3) = "g") 
                && ((lena |> RealTimeDeque.lookup 4) = "f") && ((lena |> RealTimeDeque.lookup 5) = "e") && ((lena |> RealTimeDeque.lookup 6) = "d") && ((lena |> RealTimeDeque.lookup 7) = "c")
                && ((lena |> RealTimeDeque.lookup 8) = "b") && ((lena |> RealTimeDeque.lookup 9) = "a")) |> Expect.isTrue "" }
            ...
            test "RealTimeDeque.tryLookup not found" {
                lena |> RealTimeDeque.tryLookup 10 |> Expect.isNone "" }

            test "RealTimeDeque.remove elements RealTimeDeque.length 1" {
                len1 |> RealTimeDeque.remove 0 |> RealTimeDeque.isEmpty |> Expect.isTrue "" }
            ...
            test "RealTimeDeque.remove elements RealTimeDeque.length 5" {
                let r0 = (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e"]) |> RealTimeDeque.remove 0
                let b0 = RealTimeDeque.head r0
                ...
                let r1 = (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e"]) |> RealTimeDeque.remove 1
                let a1 = RealTimeDeque.head r1
                let t11 = RealTimeDeque.tail r1
                let c1 = RealTimeDeque.head t11
                let t12 = RealTimeDeque.tail t11
                ...
                let r2 = (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e"]) |> RealTimeDeque.remove 2
                let a2 = RealTimeDeque.head r2
                let t21 = RealTimeDeque.tail r2
                let b2 = RealTimeDeque.head t21
                let t22 = RealTimeDeque.tail t21
                ...
                let r3 = (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e"]) |> RealTimeDeque.remove 3
                let a3 = RealTimeDeque.head r3
                let t31 = RealTimeDeque.tail r3
                let b3 = RealTimeDeque.head t31
                let t32 = RealTimeDeque.tail t31
                ...
                let r4 = (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e"]) |> RealTimeDeque.remove 4
            ...
            test "RealTimeDeque.remove elements RealTimeDeque.length 6" {
                let r0 = (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e";"f"]) |> RealTimeDeque.remove 0
                let b0 = RealTimeDeque.head r0
                let t01 = RealTimeDeque.tail r0
                let c0 = RealTimeDeque.head t01
                let t02= RealTimeDeque.tail t01
                ...
                let r1 = (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e";"f"]) |> RealTimeDeque.remove 1
                let a1 = RealTimeDeque.head r1
                let t11 = RealTimeDeque.tail r1
                let c1 = RealTimeDeque.head t11
                let t12 = RealTimeDeque.tail t11
                ...
                let r2 = (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e";"f"]) |> RealTimeDeque.remove 2
                let a2 = RealTimeDeque.head r2
                let t21 = RealTimeDeque.tail r2
                let b2 = RealTimeDeque.head t21
                let t22 = RealTimeDeque.tail t21
                ...
                let r3 = (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e";"f"]) |> RealTimeDeque.remove 3
                let a3 = RealTimeDeque.head r3
                let t31 = RealTimeDeque.tail r3
                let b3 = RealTimeDeque.head t31
                let t32 = RealTimeDeque.tail t31
                ...
                let r4 = (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e";"f"]) |> RealTimeDeque.remove 4
                let a4 = RealTimeDeque.head r4
                let t41 = RealTimeDeque.tail r4
                let b4 = RealTimeDeque.head t41
                let t42 = RealTimeDeque.tail t41
                ...
                let r5 = (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e";"f"]) |> RealTimeDeque.remove 5
            ...
            test "tryRemoveempty" {
                (RealTimeDeque.empty 3) |> RealTimeDeque.tryRemove 0 |> Expect.isNone "" }
            ...
            test "RealTimeDeque.tryRemove elements RealTimeDeque.length 4" {
                let x0 = (RealTimeDeque.ofSeq ["a";"b";"c";"d"]) |> RealTimeDeque.tryRemove 0
                let r0 = x0.Value
                let b0 = RealTimeDeque.head r0
                let t0 = RealTimeDeque.tail r0
                let c0 = RealTimeDeque.head t0
                ...
                let x1 = (RealTimeDeque.ofSeq ["a";"b";"c";"d"]) |> RealTimeDeque.tryRemove 1
                let r1 = x1.Value
                let a1 = RealTimeDeque.head r1
                let t11 = RealTimeDeque.tail r1
                let c1 = RealTimeDeque.head t11
                ...
                let x2 = (RealTimeDeque.ofSeq ["a";"b";"c";"d"]) |> RealTimeDeque.tryRemove 2
                let r2 = x2.Value
                let a2 = RealTimeDeque.head r2
                let t21 = RealTimeDeque.tail r2
                let b2 = RealTimeDeque.head t21
                ...
                let x3 = (RealTimeDeque.ofSeq ["a";"b";"c";"d"]) |> RealTimeDeque.tryRemove 3
                let r3 = x3.Value
                let a3 = RealTimeDeque.head r3
                let t31 = RealTimeDeque.tail r3
                let b3 = RealTimeDeque.head t31
            ...
            test "RealTimeDeque.tryRemove elements RealTimeDeque.length 5" {
                let x0 = (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e"]) |> RealTimeDeque.tryRemove 0
                let r0 = x0.Value
                let b0 = RealTimeDeque.head r0
                let t01 = RealTimeDeque.tail r0
                let c0 = RealTimeDeque.head t01
                ...
                let x1 = (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e"]) |> RealTimeDeque.tryRemove 1
                let r1 = x1.Value
                let a1 = RealTimeDeque.head r1
                let t11 = RealTimeDeque.tail r1
                let c1 = RealTimeDeque.head t11
                ...
                let x2 = (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e"]) |> RealTimeDeque.tryRemove 2
                let r2 = x2.Value
                let a2 = RealTimeDeque.head r2
                let t21 = RealTimeDeque.tail r2
                let b2 = RealTimeDeque.head t21
                ...
                let x3 = (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e"]) |> RealTimeDeque.tryRemove 3
                let r3 = x3.Value
                let a3 = RealTimeDeque.head r3
                let t31 = RealTimeDeque.tail r3
                let b3 = RealTimeDeque.head t31
                ...
                let x4 = (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e"]) |> RealTimeDeque.tryRemove 4
                let r4 = x4.Value
                let a4 = RealTimeDeque.head r4
                let t41 = RealTimeDeque.tail r4
                let b4 = RealTimeDeque.head t41
            ...
            test "RealTimeDeque.tryRemove elements RealTimeDeque.length 6" {
                let x0 = (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e";"f"]) |> RealTimeDeque.tryRemove 0
                let r0 = x0.Value
                let b0 = RealTimeDeque.head r0
                let t01 = RealTimeDeque.tail r0
                let c0 = RealTimeDeque.head t01
                ...
                let x1 = (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e";"f"]) |> RealTimeDeque.tryRemove 1
                let r1 =x1.Value
                let a1 = RealTimeDeque.head r1
                let t11 = RealTimeDeque.tail r1
                let c1 = RealTimeDeque.head t11
                ...
                let x2 = (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e";"f"]) |> RealTimeDeque.tryRemove 2
                let r2 = x2.Value 
                let a2 = RealTimeDeque.head r2
                let t21 = RealTimeDeque.tail r2
                let b2 = RealTimeDeque.head t21
                ...
                let x3 = (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e";"f"]) |> RealTimeDeque.tryRemove 3
                let r3 = x3.Value
                let a3 = RealTimeDeque.head r3
                let t31 = RealTimeDeque.tail r3
                let b3 = RealTimeDeque.head t31
                ...
                let x4 = (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e";"f"]) |> RealTimeDeque.tryRemove 4
                let r4 = x4.Value
                let a4 = RealTimeDeque.head r4
                let t41 = RealTimeDeque.tail r4
                let b4 = RealTimeDeque.head t41
                ...
                let x5 = (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e";"f"]) |> RealTimeDeque.tryRemove 5
                let r5 = x5.Value
                let a5 = RealTimeDeque.head r5
                let t51 = RealTimeDeque.tail r5
                let b5 = RealTimeDeque.head t51
            ...
            test "RealTimeDeque.update elements RealTimeDeque.length 1" {
                len1 |> RealTimeDeque.update 0 "aa" |> RealTimeDeque.head |> Expect.equal ""  "aa" }
            ...
            test "RealTimeDeque.update elements RealTimeDeque.length 4" {
                let r0 = (RealTimeDeque.ofSeq ["a";"b";"c";"d"]) |> RealTimeDeque.update 0 "zz"
                let a0 = RealTimeDeque.head r0
                let t01 = RealTimeDeque.tail r0
                let b0 = RealTimeDeque.head t01
                let t02 = RealTimeDeque.tail t01
                ...
                let r1 = (RealTimeDeque.ofSeq ["a";"b";"c";"d"]) |> RealTimeDeque.update 1 "zz"
                let a1 = RealTimeDeque.head r1
                let t11 = RealTimeDeque.tail r1
                let b1 = RealTimeDeque.head t11
                let t12 = RealTimeDeque.tail t11
                ...
                let r2 = (RealTimeDeque.ofSeq ["a";"b";"c";"d"]) |> RealTimeDeque.update 2 "zz"
                let a2 = RealTimeDeque.head r2
                let t21 = RealTimeDeque.tail r2
                let b2 = RealTimeDeque.head t21
                let t22 = RealTimeDeque.tail t21
                ...
                let r3 = (RealTimeDeque.ofSeq ["a";"b";"c";"d"]) |> RealTimeDeque.update 3 "zz"
                let a3 = RealTimeDeque.head r3
                let t31 = RealTimeDeque.tail r3
                let b3 = RealTimeDeque.head t31
                let t32 = RealTimeDeque.tail t31
            ...
            test "RealTimeDeque.update elements RealTimeDeque.length 5" {
                let r0 = (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e"]) |> RealTimeDeque.update 0 "zz"
                let a0 = RealTimeDeque.head r0
                let t01 = RealTimeDeque.tail r0
                let b0 = RealTimeDeque.head t01
                let t02 = RealTimeDeque.tail t01
                ...
                let r1 = (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e"]) |> RealTimeDeque.update 1 "zz"
                let a1 = RealTimeDeque.head r1
                let t11 = RealTimeDeque.tail r1
                let b1 = RealTimeDeque.head t11
                let t12 = RealTimeDeque.tail t11
                ...
                let r2 = (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e"]) |> RealTimeDeque.update 2 "zz"
                let a2 = RealTimeDeque.head r2
                let t21 = RealTimeDeque.tail r2
                let b2 = RealTimeDeque.head t21
                let t22 = RealTimeDeque.tail t21
                ...
                let r3 = (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e"]) |> RealTimeDeque.update 3 "zz"
                let a3 = RealTimeDeque.head r3
                let t31 = RealTimeDeque.tail r3
                let b3 = RealTimeDeque.head t31
                let t32 = RealTimeDeque.tail t31
                ...
                let r4 = (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e"]) |> RealTimeDeque.update 4 "zz"
                let a4 = RealTimeDeque.head r4
                let t41 = RealTimeDeque.tail r4
                let b4 = RealTimeDeque.head t41
                let t42 = RealTimeDeque.tail t41
            ...
            test "RealTimeDeque.update elements RealTimeDeque.length 6" {
                let r0 = (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e";"f"]) |> RealTimeDeque.update 0 "zz"
                let a0 = RealTimeDeque.head r0
                let t01 = RealTimeDeque.tail r0
                let b0 = RealTimeDeque.head t01
                let t02 = RealTimeDeque.tail t01
                ...
                let r1 = (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e";"f"]) |> RealTimeDeque.update 1 "zz"
                let a1 = RealTimeDeque.head r1
                let t11 = RealTimeDeque.tail r1
                let b1 = RealTimeDeque.head t11
                let t12 = RealTimeDeque.tail t11
                ...
                let r2 = (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e";"f"]) |> RealTimeDeque.update 2 "zz"
                let a2 = RealTimeDeque.head r2
                let t21 = RealTimeDeque.tail r2
                let b2 = RealTimeDeque.head t21
                let t22 = RealTimeDeque.tail t21
                ...
                let r3 = (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e";"f"]) |> RealTimeDeque.update 3 "zz"
                let a3 = RealTimeDeque.head r3
                let t31 = RealTimeDeque.tail r3
                let b3 = RealTimeDeque.head t31
                let t32 = RealTimeDeque.tail t31
                ...
                let r4 = (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e";"f"]) |> RealTimeDeque.update 4 "zz"
                let a4 = RealTimeDeque.head r4
                let t41 = RealTimeDeque.tail r4
                let b4 = RealTimeDeque.head t41
                let t42 = RealTimeDeque.tail t41
                ...
                let r5 = (RealTimeDeque.ofSeq ["a";"b";"c";"d";"e";"f"]) |> RealTimeDeque.update 5 "zz"
                let a5 = RealTimeDeque.head r5
                let t51 = RealTimeDeque.tail r5
                let b5 = RealTimeDeque.head t51
                let t52 = RealTimeDeque.tail t51
            ...
            test "RealTimeDeque.tryUpdate elements RealTimeDeque.length 3" {
                let x0 = (RealTimeDeque.ofSeq ["a";"b";"c"]) |> RealTimeDeque.tryUpdate 0 "zz"
                let r0 = x0.Value
                let a0 = RealTimeDeque.head r0
                let t01 = RealTimeDeque.tail r0
                let b0 = RealTimeDeque.head t01
                ...
                let x1 = (RealTimeDeque.ofSeq ["a";"b";"c"]) |> RealTimeDeque.tryUpdate 1 "zz"
                let r1 = x1.Value
                let a1 = RealTimeDeque.head r1
                let t11 = RealTimeDeque.tail r1
                let b1 = RealTimeDeque.head t11
                ...
                let x2 = (RealTimeDeque.ofSeq ["a";"b";"c"]) |> RealTimeDeque.tryUpdate 2 "zz"
                let r2 = x2.Value
                let a2 = RealTimeDeque.head r2
                let t21 = RealTimeDeque.tail r2
                let b2 = RealTimeDeque.head t21
            ...
            test "RealTimeDeque.tryUpdate elements RealTimeDeque.length 4" {
                let x0 = (RealTimeDeque.ofSeq ["a";"b";"c";"d"]) |> RealTimeDeque.tryUpdate 0 "zz"
                let r0 = x0.Value
                let a0 = RealTimeDeque.head r0
                let t01 = RealTimeDeque.tail r0
                let b0 = RealTimeDeque.head t01
                ...
                let x1 = (RealTimeDeque.ofSeq ["a";"b";"c";"d"]) |> RealTimeDeque.tryUpdate 1 "zz"
                let r1 = x1.Value
                let a1 = RealTimeDeque.head r1
                let t11 = RealTimeDeque.tail r1
                let b1 = RealTimeDeque.head t11
                ...
                let x2 = (RealTimeDeque.ofSeq ["a";"b";"c";"d"]) |> RealTimeDeque.tryUpdate 2 "zz"
                let r2 = x2.Value
                let a2 = RealTimeDeque.head r2
                let t21 = RealTimeDeque.tail r2
                let b2 = RealTimeDeque.head t21
                ...
                let x3 = (RealTimeDeque.ofSeq ["a";"b";"c";"d"]) |> RealTimeDeque.tryUpdate 3 "zz"
                let r3 = x3.Value
                let a3 = RealTimeDeque.head r3
                let t31 = RealTimeDeque.tail r3
                let b3 = RealTimeDeque.head t31
            ...
            test "tryGetTail on q" {
                let q = RealTimeDeque.ofSeq ["a";"b";"c";"d"]
                (RealTimeDeque.tryGetTail q).Value |> RealTimeDeque.head |> Expect.equal "" "b" } 
        ]