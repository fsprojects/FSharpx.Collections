...
module RealTimeDequeTest =
    ...
    let testRealTimeDeque =
        ...
        testList
            "Experimental RealTimeDeque"
            [ test "RealTimeDeque.empty dqueue should be RealTimeDeque.empty" { RealTimeDeque.isEmpty(RealTimeDeque.empty 2) |> Expect.isTrue "" }
              ...
              test "RealTimeDeque.singleton RealTimeDeque.last works" { len1 |> RealTimeDeque.last |> Expect.equal "" "a" }
              ...
              test "IDeque RealTimeDeque.cons works" { ((lena :> IDeque<string>).Cons "zz").Head |> Expect.equal "" "zz" }
              ...
              test "appending RealTimeDeque.length 1 and RealTimeDeque.length 3" {
                  ...
                  let r1c =
                      RealTimeDeque.append (RealTimeDeque.ofSeqC 3 [ "a" ]) (RealTimeDeque.ofSeqC 3 [ "b"; "c"; "d" ])
                  ...
                  let r1cr =
                      RealTimeDeque.append (RealTimeDeque.ofSeqC 3 [ "a"; "b"; "c" ]) (RealTimeDeque.ofSeqC 3 [ "d" ])
              ...
              test "appending RealTimeDeque.length 1 and RealTimeDeque.length 4" {
                  let r1 =
                      RealTimeDeque.append (RealTimeDeque.ofSeq [ "a" ]) (RealTimeDeque.ofSeq [ "b"; "c"; "d"; "e" ])

                  let r1c =
                      RealTimeDeque.append (RealTimeDeque.ofSeqC 3 [ "a" ]) (RealTimeDeque.ofSeqC 3 [ "b"; "c"; "d"; "e" ])
                  ...
                  let r1r =
                      RealTimeDeque.append (RealTimeDeque.ofSeq [ "a"; "b"; "c"; "d" ]) (RealTimeDeque.ofSeq [ "e" ])

                  let r1cr =
                      RealTimeDeque.append (RealTimeDeque.ofSeqC 3 [ "a"; "b"; "c"; "d" ]) (RealTimeDeque.ofSeqC 3 [ "e" ])
              ...
              test "appending RealTimeDeque.length 1 and RealTimeDeque.length 5" {
                  let r1 =
                      RealTimeDeque.append (RealTimeDeque.ofSeq [ "a" ]) (RealTimeDeque.ofSeq [ "b"; "c"; "d"; "e"; "f" ])

                  let r1c =
                      RealTimeDeque.append (RealTimeDeque.ofSeqC 3 [ "a" ]) (RealTimeDeque.ofSeqC 3 [ "b"; "c"; "d"; "e"; "f" ])
                  ...
                  let r1r =
                      RealTimeDeque.append (RealTimeDeque.ofSeq [ "a"; "b"; "c"; "d"; "e" ]) (RealTimeDeque.ofSeq [ "f" ])

                  let r1cr =
                      RealTimeDeque.append (RealTimeDeque.ofSeqC 3 [ "a"; "b"; "c"; "d"; "e" ]) (RealTimeDeque.ofSeqC 3 [ "f" ])
              ...
              test "appending RealTimeDeque.length 2 and RealTimeDeque.length 2" {
                  ...
                  let r1c =
                      RealTimeDeque.append (RealTimeDeque.ofSeqC 3 [ "a"; "b" ]) (RealTimeDeque.ofSeqC 3 [ "c"; "d" ])
              ...
              test "appending RealTimeDeque.length 2 and RealTimeDeque.length 3" {
                  let r1 =
                      RealTimeDeque.append (RealTimeDeque.ofSeq [ "a"; "b" ]) (RealTimeDeque.ofSeq [ "c"; "d"; "e" ])

                  let r1c =
                      RealTimeDeque.append (RealTimeDeque.ofSeqC 3 [ "a"; "b" ]) (RealTimeDeque.ofSeqC 3 [ "c"; "d"; "e" ])
                  ...
                  let r1r =
                      RealTimeDeque.append (RealTimeDeque.ofSeq [ "a"; "b"; "c" ]) (RealTimeDeque.ofSeq [ "d"; "e" ])

                  let r1cr =
                      RealTimeDeque.append (RealTimeDeque.ofSeqC 3 [ "a"; "b"; "c" ]) (RealTimeDeque.ofSeqC 3 [ "d"; "e" ])
              ...
              test "appending RealTimeDeque.length 2 and RealTimeDeque.length 4" {
                  let r1 =
                      RealTimeDeque.append (RealTimeDeque.ofSeq [ "a"; "b" ]) (RealTimeDeque.ofSeq [ "c"; "d"; "e"; "f" ])

                  let r1c =
                      RealTimeDeque.append (RealTimeDeque.ofSeqC 3 [ "a"; "b" ]) (RealTimeDeque.ofSeqC 3 [ "c"; "d"; "e"; "f" ])
                  ...
                  let r1r =
                      RealTimeDeque.append (RealTimeDeque.ofSeq [ "a"; "b"; "c"; "d" ]) (RealTimeDeque.ofSeq [ "e"; "f" ])

                  let r1cr =
                      RealTimeDeque.append (RealTimeDeque.ofSeqC 3 [ "a"; "b"; "c"; "d" ]) (RealTimeDeque.ofSeqC 3 [ "e"; "f" ])
              ...
              test "appending RealTimeDeque.length 2 and RealTimeDeque.length 5" {
                  let r1 =
                      RealTimeDeque.append (RealTimeDeque.ofSeq [ "a"; "b" ]) (RealTimeDeque.ofSeq [ "c"; "d"; "e"; "f"; "g" ])

                  let r1c =
                      RealTimeDeque.append (RealTimeDeque.ofSeqC 3 [ "a"; "b" ]) (RealTimeDeque.ofSeqC 3 [ "c"; "d"; "e"; "f"; "g" ])
                  ...
                  let r1r =
                      RealTimeDeque.append (RealTimeDeque.ofSeq [ "a"; "b"; "c"; "d"; "e" ]) (RealTimeDeque.ofSeq [ "f"; "g" ])

                  let r1cr =
                      RealTimeDeque.append (RealTimeDeque.ofSeqC 3 [ "a"; "b"; "c"; "d"; "e" ]) (RealTimeDeque.ofSeqC 3 [ "f"; "g" ])
              ...
              test "appending RealTimeDeque.length 3 and RealTimeDeque.length 3" {
                  let r1 =
                      RealTimeDeque.append (RealTimeDeque.ofSeq [ "a"; "b"; "c" ]) (RealTimeDeque.ofSeq [ "d"; "e"; "f" ])

                  let r1c =
                      RealTimeDeque.append (RealTimeDeque.ofSeqC 3 [ "a"; "b"; "c" ]) (RealTimeDeque.ofSeqC 3 [ "d"; "e"; "f" ])
              ...
              test "RealTimeDeque.lookup RealTimeDeque.length 1" { len1 |> RealTimeDeque.lookup 0 |> Expect.equal "" "a" }
