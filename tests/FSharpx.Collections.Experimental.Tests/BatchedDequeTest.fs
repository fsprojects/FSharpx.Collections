...
module BatchDequeTest =
    ...
    let testBatchDeque =
        ...
        testList "Experimental BatchDeque" [
            ...
            test "cons works" {
                len2 |> isEmpty |> Expect.isFalse "" }

            test "snoc works" {
                len2snoc |> isEmpty |> Expect.isFalse "" }

            test "singleton head works" {
                len1 |> head |> Expect.equal "" "a" } 
            ...
            test "init of singleton empty" {
                len1 |> init |> isEmpty |> Expect.isTrue "" }

            test "head, tail, and length work test 1" {
                let t1 = tail len2
                let t1s = tail len2snoc
                (((length t1) = 1) && ((length t1s) = 1) && ((head t1) = "a") && ((head t1s) = "a")) |> Expect.isTrue "" }
            ...
            test "head, tail, and length work test 2" {
                ...
                && ((head t1_1) = "a") && ((head t1_1s) = "a")) |> Expect.isTrue "" }
            ...
            test "head, tail, and length work test 4" {
                ...
                && ((length t1_1) = 1) && ((length t1_1s) = 1) && ((head t1_1) = "a") && ((head t1_1s) = "a")) |> Expect.isTrue "" }
            ...
            test "last, init, and length work test 1" {  
                ...
                (((length t1) = 1) && ((last t1) = "b")) |> Expect.isTrue "" }

            test "last, init, and length work test 2" {
                let t1 = init len3
                let t1_1 = init t1
    
                (((length t1) = 2) && ((last t1) = "b") && ((length t1_1) = 1)  && ((last t1_1) = "c") ) |> Expect.isTrue "" }
            ...
            test "last, init, and length work test 3" {
                ...
                && ((length t1_2) = 1)  && ((last t1_2) = "d") ) |> Expect.isTrue "" }
            ...
            test "last, init, and length work test 4" {
                ...
                && ((length t1_3) = 1)  && ((last t1_3) = "e") ) |> Expect.isTrue "" }
            ...
            test "last, init, and length work test 5" {
                ...
                && ((length t1_4) = 1)  && ((last t1_4) = "f") ) |> Expect.isTrue "" }
            ...
            test "last, init, and length work test 6" {
                ...
                && ((length t1_5) = 1)  && ((last t1_5) = "g") ) |> Expect.isTrue "" }
            ...
            test "last, init, and length work test 7" {
                ...
                && ((length t1_6) = 1)  && ((last t1_6) = "h") ) |> Expect.isTrue "" }
            ...
            test "last, init, and length work test 8" {
                ...
                && ((length t1_7) = 1)  && ((last t1_7) = "i") ) |> Expect.isTrue "" }
            ...
            test "last, init, and length work test 9" {
                ...
                && ((length t1_8) = 1)  && ((last t1_8) = "j") ) |> Expect.isTrue "" }
            ...
            test "tryRemoveempty" {
                empty() |>tryRemove 0 |> Expect.isNone "" }
