...
module BatchDequeTest =
    ...
    let len3snoc =
        BatchedDeque.singleton "c"
        |> BatchedDeque.snoc "b"
        |> BatchedDeque.snoc "a"

    let len4snoc =
        BatchedDeque.singleton "d"
        |> BatchedDeque.snoc "c"
        |> BatchedDeque.snoc "b"
        |> BatchedDeque.snoc "a"

    let len5snoc =
        BatchedDeque.singleton "e"
        |> BatchedDeque.snoc "d"
        |> BatchedDeque.snoc "c"
        |> BatchedDeque.snoc "b"
        |> BatchedDeque.snoc "a"
    ...
    let testBatchDeque =
        ...
        testList
            "Experimental BatchDeque"
            [

              test "empty dqueue should be empty" { BatchedDeque.empty() |> BatchedDeque.isEmpty |> Expect.isTrue "" }

              test "BatchedDeque.cons works" { len2 |> BatchedDeque.isEmpty |> Expect.isFalse "" }

              test "BatchedDeque.snoc works" { len2snoc |> BatchedDeque.isEmpty |> Expect.isFalse "" }

              test "BatchedDeque.singleton BatchedDeque.head works" { len1 |> BatchedDeque.head |> Expect.equal "" "a" }

              test "BatchedDeque.singleton BatchedDeque.last works" { len1 |> BatchedDeque.last |> Expect.equal "" "a" }

              test "BatchedDeque.tail of BatchedDeque.singleton empty" { len1 |> BatchedDeque.tail |> BatchedDeque.isEmpty |> Expect.isTrue "" }

              test "BatchedDeque.tail of BatchedDeque.tail of 2 empty" {
                  (len2 |> BatchedDeque.tail |> BatchedDeque.tail |> BatchedDeque.isEmpty)
                  |> Expect.isTrue ""
              }

              test "BatchedDeque.init of BatchedDeque.singleton empty" { len1 |> BatchedDeque.init |> BatchedDeque.isEmpty |> Expect.isTrue "" }
              ...
              test "BatchedDeque.head, BatchedDeque.tail, and BatchedDeque.length work test 1" {
                  ...
                  (((BatchedDeque.length t1) = 1)
                   && ((BatchedDeque.length t1s) = 1)
                   && ((BatchedDeque.head t1) = "a")
                   && ((BatchedDeque.head t1s) = "a"))
                  |> Expect.isTrue ""
              }
              ...
              test "BatchedDeque.head, BatchedDeque.tail, and BatchedDeque.length work test 2" {
                  ...
                  (((BatchedDeque.length t1) = 2)
                   && ((BatchedDeque.length t1s) = 2)
                   && ((BatchedDeque.head t1) = "b")
                   && ((BatchedDeque.head t1s) = "b")
                   && ((BatchedDeque.length t1_1) = 1)
                   && ((BatchedDeque.length t1_1s) = 1)
                   && ((BatchedDeque.head t1_1) = "a")
                   && ((BatchedDeque.head t1_1s) = "a"))
                  |> Expect.isTrue ""
              }
              ...
              test "BatchedDeque.head, BatchedDeque.tail, and BatchedDeque.length work test 3" {
                  ...
                  (((BatchedDeque.length t1) = 3)
                   && ((BatchedDeque.length t1s) = 3)
                   && ((BatchedDeque.head t1) = "c")
                   && ((BatchedDeque.head t1s) = "c")
                   && ((BatchedDeque.length t1_2) = 2)
                   && ((BatchedDeque.length t1_2s) = 2)
                   && ((BatchedDeque.head t1_2) = "b")
                   && ((BatchedDeque.head t1_2s) = "b")
                   && ((BatchedDeque.length t1_1) = 1)
                   && ((BatchedDeque.length t1_1s) = 1)
                   && ((BatchedDeque.head t1_1) = "a")
                   && ((BatchedDeque.head t1_1s) = "a"))
              ...
              test "BatchedDeque.head, BatchedDeque.tail, and BatchedDeque.length work test 4" {
                  ...
                  (((BatchedDeque.length t1) = 4)
                   && ((BatchedDeque.length t1s) = 4)
                   && ((BatchedDeque.head t1) = "d")
                   && ((BatchedDeque.head t1s) = "d")
                   && ((BatchedDeque.length t1_3) = 3)
                   && ((BatchedDeque.length t1_3s) = 3)
                   && ((BatchedDeque.head t1_3) = "c")
                   && ((BatchedDeque.head t1_3s) = "c")
                   && ((BatchedDeque.length t1_2) = 2)
                   && ((BatchedDeque.length t1_2s) = 2)
                   && ((BatchedDeque.head t1_2) = "b")
                   && ((BatchedDeque.head t1_2s) = "b")
              ...
              test "BatchedDeque.head, BatchedDeque.tail, and BatchedDeque.length work test 5" {
                  ...
                  (((BatchedDeque.length t1) = 5)
                   && ((BatchedDeque.length t1s) = 5)
                   && ((BatchedDeque.head t1) = "e")
                   && ((BatchedDeque.head t1s) = "e")
                   && ((BatchedDeque.length t1_4) = 4)
                   && ((BatchedDeque.length t1_4s) = 4)
                   && ((BatchedDeque.head t1_4) = "d")
                   && ((BatchedDeque.head t1_4s) = "d")
                   && ((BatchedDeque.length t1_3) = 3)
                   && ((BatchedDeque.length t1_3s) = 3)
                   && ((BatchedDeque.head t1_3) = "c")
                   && ((BatchedDeque.head t1_3s) = "c")
              ...
              test "BatchedDeque.head, BatchedDeque.tail, and BatchedDeque.length work test 6" {
                  ...
                  (((BatchedDeque.length t1) = 6)
                   && ((BatchedDeque.length t1s) = 6)
                   && ((BatchedDeque.head t1) = "f")
                   && ((BatchedDeque.head t1s) = "f")
                   && ((BatchedDeque.length t1_5) = 5)
                   && ((BatchedDeque.length t1_5s) = 5)
                   && ((BatchedDeque.head t1_5) = "e")
                   && ((BatchedDeque.head t1_5s) = "e")
                   && ((BatchedDeque.length t1_4) = 4)
                   && ((BatchedDeque.length t1_4s) = 4)
                   && ((BatchedDeque.head t1_4) = "d")
                   && ((BatchedDeque.head t1_4s) = "d")
              ...
              test "BatchedDeque.head, BatchedDeque.tail, and BatchedDeque.length work test 7" {
                  ...
                  (((BatchedDeque.length t1) = 7)
                   && ((BatchedDeque.length t1s) = 7)
                   && ((BatchedDeque.head t1) = "g")
                   && ((BatchedDeque.head t1s) = "g")
                   && ((BatchedDeque.length t1_6) = 6)
                   && ((BatchedDeque.length t1_6s) = 6)
                   && ((BatchedDeque.head t1_6) = "f")
                   && ((BatchedDeque.head t1_6s) = "f")
                   && ((BatchedDeque.length t1_5) = 5)
                   && ((BatchedDeque.length t1_5s) = 5)
                   && ((BatchedDeque.head t1_5) = "e")
                   && ((BatchedDeque.head t1_5s) = "e")
              ...
              test "BatchedDeque.head, BatchedDeque.tail, and BatchedDeque.length work test 8" {
                  ...
                  (((BatchedDeque.length t1) = 8)
                   && ((BatchedDeque.length t1s) = 8)
                   && ((BatchedDeque.head t1) = "h")
                   && ((BatchedDeque.head t1s) = "h")
                   && ((BatchedDeque.length t1_7) = 7)
                   && ((BatchedDeque.length t1_7s) = 7)
                   && ((BatchedDeque.head t1_7) = "g")
                   && ((BatchedDeque.head t1_7s) = "g")
                   && ((BatchedDeque.length t1_6) = 6)
                   && ((BatchedDeque.length t1_6s) = 6)
                   && ((BatchedDeque.head t1_6) = "f")
                   && ((BatchedDeque.head t1_6s) = "f")
              ...
              test "BatchedDeque.head, BatchedDeque.tail, and BatchedDeque.length work test 9" {
                  ...
                  (((BatchedDeque.length t1) = 9)
                   && ((BatchedDeque.length t1s) = 9)
                   && ((BatchedDeque.head t1) = "i")
                   && ((BatchedDeque.head t1s) = "i")
                   && ((BatchedDeque.length t1_8) = 8)
                   && ((BatchedDeque.length t1_8s) = 8)
                   && ((BatchedDeque.head t1_8) = "h")
                   && ((BatchedDeque.head t1_8s) = "h")
                   && ((BatchedDeque.length t1_7) = 7)
                   && ((BatchedDeque.length t1_7s) = 7)
                   && ((BatchedDeque.head t1_7) = "g")
                   && ((BatchedDeque.head t1_7s) = "g")
              ...
              test "BatchedDeque.last, BatchedDeque.init, and BatchedDeque.length work test 1" {
                  ...
                  (((BatchedDeque.length t1) = 1) && ((BatchedDeque.last t1) = "b"))
                  |> Expect.isTrue ""
              }
              ...
              test "BatchedDeque.last, BatchedDeque.init, and BatchedDeque.length work test 2" {
                  ...
                  (((BatchedDeque.length t1) = 2)
                   && ((BatchedDeque.last t1) = "b")
                   && ((BatchedDeque.length t1_1) = 1)
                   && ((BatchedDeque.last t1_1) = "c"))
                  |> Expect.isTrue ""
              }
              ...
              test "BatchedDeque.last, BatchedDeque.init, and BatchedDeque.length work test 3" {
                  ...
                  (((BatchedDeque.length t1) = 3)
                   && ((BatchedDeque.last t1) = "b")
                   && ((BatchedDeque.length t1_1) = 2)
                   && ((BatchedDeque.last t1_1) = "c")
                   && ((BatchedDeque.length t1_2) = 1)
                   && ((BatchedDeque.last t1_2) = "d"))
                  |> Expect.isTrue ""
              }
              ...
              test "BatchedDeque.last, BatchedDeque.init, and BatchedDeque.length work test 4" {
                  ...
                  (((BatchedDeque.length t1) = 4)
                   && ((BatchedDeque.last t1) = "b")
                   && ((BatchedDeque.length t1_1) = 3)
                   && ((BatchedDeque.last t1_1) = "c")
                   && ((BatchedDeque.length t1_2) = 2)
                   && ((BatchedDeque.last t1_2) = "d")
                   && ((BatchedDeque.length t1_3) = 1)
                   && ((BatchedDeque.last t1_3) = "e"))
                  |> Expect.isTrue ""
              }
              ...
              test "BatchedDeque.last, BatchedDeque.init, and BatchedDeque.length work test 5" {
                  ...
                  (((BatchedDeque.length t1) = 5)
                   && ((BatchedDeque.last t1) = "b")
                   && ((BatchedDeque.length t1_1) = 4)
                   && ((BatchedDeque.last t1_1) = "c")
                   && ((BatchedDeque.length t1_2) = 3)
                   && ((BatchedDeque.last t1_2) = "d")
                   && ((BatchedDeque.length t1_3) = 2)
                   && ((BatchedDeque.last t1_3) = "e")
                   && ((BatchedDeque.length t1_4) = 1)
                   && ((BatchedDeque.last t1_4) = "f"))
                  |> Expect.isTrue ""
              }
              ...
              test "BatchedDeque.last, BatchedDeque.init, and BatchedDeque.length work test 6" {
                  ...
                  (((BatchedDeque.length t1) = 6)
                   && ((BatchedDeque.last t1) = "b")
                   && ((BatchedDeque.length t1_1) = 5)
                   && ((BatchedDeque.last t1_1) = "c")
                   && ((BatchedDeque.length t1_2) = 4)
                   && ((BatchedDeque.last t1_2) = "d")
                   && ((BatchedDeque.length t1_3) = 3)
                   && ((BatchedDeque.last t1_3) = "e")
                   && ((BatchedDeque.length t1_4) = 2)
                   && ((BatchedDeque.last t1_4) = "f")
                   && ((BatchedDeque.length t1_5) = 1)
                   && ((BatchedDeque.last t1_5) = "g"))
                  |> Expect.isTrue ""
              }
              ...
              test "BatchedDeque.last, BatchedDeque.init, and BatchedDeque.length work test 7" {
                  ...
                  (((BatchedDeque.length t1) = 7)
                   && ((BatchedDeque.last t1) = "b")
                   && ((BatchedDeque.length t1_1) = 6)
                   && ((BatchedDeque.last t1_1) = "c")
                   && ((BatchedDeque.length t1_2) = 5)
                   && ((BatchedDeque.last t1_2) = "d")
                   && ((BatchedDeque.length t1_3) = 4)
                   && ((BatchedDeque.last t1_3) = "e")
                   && ((BatchedDeque.length t1_4) = 3)
                   && ((BatchedDeque.last t1_4) = "f")
                   && ((BatchedDeque.length t1_5) = 2)
                   && ((BatchedDeque.last t1_5) = "g")
                   && ((BatchedDeque.length t1_6) = 1)
                   && ((BatchedDeque.last t1_6) = "h"))
                  |> Expect.isTrue ""
              }
              ...
              test "BatchedDeque.last, BatchedDeque.init, and BatchedDeque.length work test 8" {
                  ...
                  (((BatchedDeque.length t1) = 8)
                   && ((BatchedDeque.last t1) = "b")
                   && ((BatchedDeque.length t1_1) = 7)
                   && ((BatchedDeque.last t1_1) = "c")
                   && ((BatchedDeque.length t1_2) = 6)
                   && ((BatchedDeque.last t1_2) = "d")
                   && ((BatchedDeque.length t1_3) = 5)
                   && ((BatchedDeque.last t1_3) = "e")
                   && ((BatchedDeque.length t1_4) = 4)
                   && ((BatchedDeque.last t1_4) = "f")
                   && ((BatchedDeque.length t1_5) = 3)
                   && ((BatchedDeque.last t1_5) = "g")
                   && ((BatchedDeque.length t1_6) = 2)
                   && ((BatchedDeque.last t1_6) = "h")
                   && ((BatchedDeque.length t1_7) = 1)
                   && ((BatchedDeque.last t1_7) = "i"))
                  |> Expect.isTrue ""
              }
              ...
              test "BatchedDeque.last, BatchedDeque.init, and BatchedDeque.length work test 9" {
                  ...
                  (((BatchedDeque.length t1) = 9)
                   && ((BatchedDeque.last t1) = "b")
                   && ((BatchedDeque.length t1_1) = 8)
                   && ((BatchedDeque.last t1_1) = "c")
                   && ((BatchedDeque.length t1_2) = 7)
                   && ((BatchedDeque.last t1_2) = "d")
                   && ((BatchedDeque.length t1_3) = 6)
                   && ((BatchedDeque.last t1_3) = "e")
                   && ((BatchedDeque.length t1_4) = 5)
                   && ((BatchedDeque.last t1_4) = "f")
                   && ((BatchedDeque.length t1_5) = 4)
                   && ((BatchedDeque.last t1_5) = "g")
                   && ((BatchedDeque.length t1_6) = 3)
                   && ((BatchedDeque.last t1_6) = "h")
                   && ((BatchedDeque.length t1_7) = 2)
                   && ((BatchedDeque.last t1_7) = "i")
                   && ((BatchedDeque.length t1_8) = 1)
                   && ((BatchedDeque.last t1_8) = "j"))
                  |> Expect.isTrue ""
              }

              test "IEnumerable Seq" { (lena |> Seq.toArray).[5] |> Expect.equal "" "e" }

              test "IEnumerable Seq BatchedDeque.length" { lena |> Seq.length |> Expect.equal "" 10 }

              test "type BatchedDeque.cons works" { lena.Cons "zz" |> BatchedDeque.head |> Expect.equal "" "zz" }

              test "IDeque BatchedDeque.cons works" { ((lena :> IDeque<string>).Cons "zz").Head |> Expect.equal "" "zz" }
              ...
              test "BatchedDeque.rev dqueue BatchedDeque.length 1" { BatchedDeque.rev len1 |> BatchedDeque.head |> Expect.equal "" "a" }
              ...
              test "BatchedDeque.lookup BatchedDeque.length 1" { len1 |> BatchedDeque.lookup 0 |> Expect.equal "" "a" }

              test "BatchedDeque.lookup BatchedDeque.length 2" {
                  (((len2 |> BatchedDeque.lookup 0) = "b")
                   && ((len2 |> BatchedDeque.lookup 1) = "a"))
                  |> Expect.isTrue ""
              }

              test "BatchedDeque.lookup BatchedDeque.length 3" {
                  (((len3 |> BatchedDeque.lookup 0) = "c")
                   && ((len3 |> BatchedDeque.lookup 1) = "b")
                   && ((len3 |> BatchedDeque.lookup 2) = "a"))
                  |> Expect.isTrue ""
              }

              test "BatchedDeque.lookup BatchedDeque.length 4" {
                  (((len4 |> BatchedDeque.lookup 0) = "d")
                   && ((len4 |> BatchedDeque.lookup 1) = "c")
                   && ((len4 |> BatchedDeque.lookup 2) = "b")
                   && ((len4 |> BatchedDeque.lookup 3) = "a"))
                  |> Expect.isTrue ""
              }

              test "BatchedDeque.lookup BatchedDeque.length 5" {
                  (((len5 |> BatchedDeque.lookup 0) = "e")
                   && ((len5 |> BatchedDeque.lookup 1) = "d")
                   && ((len5 |> BatchedDeque.lookup 2) = "c")
                   && ((len5 |> BatchedDeque.lookup 3) = "b")
                   && ((len5 |> BatchedDeque.lookup 4) = "a"))
                  |> Expect.isTrue ""
              }

              test "BatchedDeque.lookup BatchedDeque.length 6" {
                  (((len6 |> BatchedDeque.lookup 0) = "f")
                   && ((len6 |> BatchedDeque.lookup 1) = "e")
                   && ((len6 |> BatchedDeque.lookup 2) = "d")
                   && ((len6 |> BatchedDeque.lookup 3) = "c")
                   && ((len6 |> BatchedDeque.lookup 4) = "b")
                   && ((len6 |> BatchedDeque.lookup 5) = "a"))
                  |> Expect.isTrue ""
              }

              test "BatchedDeque.lookup BatchedDeque.length 7" {
                  (((len7 |> BatchedDeque.lookup 0) = "g")
                   && ((len7 |> BatchedDeque.lookup 1) = "f")
                   && ((len7 |> BatchedDeque.lookup 2) = "e")
                   && ((len7 |> BatchedDeque.lookup 3) = "d")
                   && ((len7 |> BatchedDeque.lookup 4) = "c")
                   && ((len7 |> BatchedDeque.lookup 5) = "b")
                   && ((len7 |> BatchedDeque.lookup 6) = "a"))
                  |> Expect.isTrue ""
              }

              test "BatchedDeque.lookup BatchedDeque.length 8" {
                  (((len8 |> BatchedDeque.lookup 0) = "h")
                   && ((len8 |> BatchedDeque.lookup 1) = "g")
                   && ((len8 |> BatchedDeque.lookup 2) = "f")
                   && ((len8 |> BatchedDeque.lookup 3) = "e")
                   && ((len8 |> BatchedDeque.lookup 4) = "d")
                   && ((len8 |> BatchedDeque.lookup 5) = "c")
                   && ((len8 |> BatchedDeque.lookup 6) = "b")
                   && ((len8 |> BatchedDeque.lookup 7) = "a"))
                  |> Expect.isTrue ""
              }

              test "BatchedDeque.lookup BatchedDeque.length 9" {
                  (((len9 |> BatchedDeque.lookup 0) = "i")
                   && ((len9 |> BatchedDeque.lookup 1) = "h")
                   && ((len9 |> BatchedDeque.lookup 2) = "g")
                   && ((len9 |> BatchedDeque.lookup 3) = "f")
                   && ((len9 |> BatchedDeque.lookup 4) = "e")
                   && ((len9 |> BatchedDeque.lookup 5) = "d")
                   && ((len9 |> BatchedDeque.lookup 6) = "c")
                   && ((len9 |> BatchedDeque.lookup 7) = "b")
                   && ((len9 |> BatchedDeque.lookup 8) = "a"))
                  |> Expect.isTrue ""
              }

              test "BatchedDeque.lookup BatchedDeque.length 10" {
                  (((lena |> BatchedDeque.lookup 0) = "j")
                   && ((lena |> BatchedDeque.lookup 1) = "i")
                   && ((lena |> BatchedDeque.lookup 2) = "h")
                   && ((lena |> BatchedDeque.lookup 3) = "g")
                   && ((lena |> BatchedDeque.lookup 4) = "f")
                   && ((lena |> BatchedDeque.lookup 5) = "e")
                   && ((lena |> BatchedDeque.lookup 6) = "d")
                   && ((lena |> BatchedDeque.lookup 7) = "c")
                   && ((lena |> BatchedDeque.lookup 8) = "b")
                   && ((lena |> BatchedDeque.lookup 9) = "a"))
                  |> Expect.isTrue ""
              }
              ...
              test "BatchedDeque.tryLookup not found" { lena |> BatchedDeque.tryLookup 10 |> Expect.isNone "" }

              test "BatchedDeque.remove elements BatchedDeque.length 1" {
                  len1
                  |> BatchedDeque.remove 0
              ...
              test "BatchedDeque.remove elements BatchedDeque.length 6" {
                  let r0 =
                      (BatchedDeque.ofSeq [ "a"; "b"; "c"; "d"; "e"; "f" ])
                      |> BatchedDeque.remove 0
              ...
              test "tryRemoveempty" { BatchedDeque.empty() |> BatchedDeque.tryRemove 0 |> Expect.isNone "" }
              ...
              test "BatchedDeque.tryRemove elements BatchedDeque.length 4" {
                  let x0 =
                      (BatchedDeque.ofSeq [ "a"; "b"; "c"; "d" ])
                      |> BatchedDeque.tryRemove 0
              ...
              test "BatchedDeque.tryUpdate elements BatchedDeque.length 3" {
                  let x0 =
                      (BatchedDeque.ofSeq [ "a"; "b"; "c" ])
                      |> BatchedDeque.tryUpdate 0 "zz"
              ...
              test "BatchedDeque.tryGetTail on q" {
                  ...
                  (BatchedDeque.tryGetTail q).Value
                  |> BatchedDeque.head
                  |> Expect.equal "" "b"
              } ]
