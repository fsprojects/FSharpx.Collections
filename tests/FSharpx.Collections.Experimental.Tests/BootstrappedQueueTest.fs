...
module BootstrappedQueueTest =
    ...
    let testBootstrappedQueue =
        ...
        testList "Experimental BootstrappedQueue" [ test "BootstrappedQueue.empty queue should be BootstrappedQueue.empty" {
                                                        BootstrappedQueue.isEmpty BootstrappedQueue.empty |> Expect.isTrue ""
                                                    }

                                                    test "it should allow to enqueue" {
                                                        BootstrappedQueue.empty
                                                        |> BootstrappedQueue.snoc 1
                                                        |> BootstrappedQueue.snoc 2
                                                    ...
                                                    test "it should allow to get the BootstrappedQueue.tail from the queue" {
                                                        BootstrappedQueue.empty
                                                        |> BootstrappedQueue.snoc "a"
                                                        |> BootstrappedQueue.snoc "b"
                                                        |> BootstrappedQueue.snoc "c"
                                                        |> BootstrappedQueue.tail
                                                        |> BootstrappedQueue.head
                                                        |> Expect.equal "" "b"
                                                    }
                                                    ...
                                                    test "it should initialize from a list" {
                                                        BootstrappedQueue.ofList [ 1..10 ]
                                                        |> BootstrappedQueue.snoc 11
                                                        |> BootstrappedQueue.snoc 12
                                                        |> BootstrappedQueue.tail
