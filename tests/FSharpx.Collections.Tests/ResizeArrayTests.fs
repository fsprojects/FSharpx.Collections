...
module ResizeArrayTests =
    ...
    [<Tests>]
    let testResizeArray =
        testList "ResizeArray" [ test "ra_exists2_a" {
                                 ...
                                 test "ra_findIndex_b" {
                                     Expect.throwsT<KeyNotFoundException> "findIndex" (fun () ->
                                         ResizeArray.findIndex (fun i -> i >= 20) (ra [ 0..10 ]) |> ignore)
                                 }
                                 ...
                                 test "ra_find b" {
                                     Expect.throwsT<KeyNotFoundException> "find" (fun () ->
                                         ra [ 1..100 ] |> ResizeArray.find(fun x -> x > 180) |> ignore)
                                 }
