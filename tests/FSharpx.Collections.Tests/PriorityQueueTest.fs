    ...
    let testPriorityQueue =
        ...
        testList "PriorityQueue" [
            ...
            test "After adding an element to the PQ the element should be the smallest" {
                ...
                Expect.equal "PriorityQueue.insert" (Some 1) <| PriorityQueue.tryPeek pq
            ...
            test "Adding multiple elements to the PQ should allow to PriorityQueue.pop the smallest" {
                let pq = PriorityQueue.empty false |> PriorityQueue.insert 1 |> PriorityQueue.insert 3 |> PriorityQueue.insert 0 |> PriorityQueue.insert 4 |> PriorityQueue.insert -3
            ...
            test "Adding multiple elements to a MaxPriorityQueue should allow to PriorityQueue.pop the smallest" {
                let pq = PriorityQueue.empty true |> PriorityQueue.insert 1 |> PriorityQueue.insert 3 |> PriorityQueue.insert 0 |> PriorityQueue.insert 4 |> PriorityQueue.insert -3
            ...
            test "Can use a PQ as a seq" {
                let pq = PriorityQueue.empty false |> PriorityQueue.insert 15 |> PriorityQueue.insert 3 |> PriorityQueue.insert 0 |> PriorityQueue.insert 4 |> PriorityQueue.insert -3
