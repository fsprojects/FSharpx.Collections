...
module RandomAccessListTest =
    ...
    let testRandomAccessList =
        ...
        testList "RandomAccessList" [
                                      ...
                                      test "fail if there is no RandomAccessList.head in the RandomAccessList" {
                                          Expect.throwsT<System.Exception> "no RandomAccessList.head" (fun () ->
                                              emptyRandomAccessList |> RandomAccessList.head |> ignore)
                                      }

                                      test "fail if there is no RandomAccessList.tail in the RandomAccessList" {
                                          Expect.throwsT<System.Exception> "no RandomAccessList.tail" (fun () ->
                                              emptyRandomAccessList |> RandomAccessList.tail |> ignore)
                                      }

                                      test "RandomAccessList.foldBack matches build list 2" {
                                          let q = RandomAccessList.ofSeq [ "f"; "e"; "d"; "c"; "b"; "a" ]

                                          Expect.equal "RandomAccessList.foldBack" (List.ofSeq q)
                                          <| RandomAccessList.foldBack (fun (elem: string) (l': string list) -> elem :: l') q []
                                      }

                                      test "RandomAccessList.fold matches build list rev 2" {
                                          let q = RandomAccessList.ofSeq [ "f"; "e"; "d"; "c"; "b"; "a" ]

                                          Expect.equal "RandomAccessList.fold" (List.rev(List.ofSeq q))
                                          <| RandomAccessList.fold (fun (l': string list) (elem: string) -> elem :: l') [] q
                                      }
                                      ...
                                      test "RandomAccessList.cons works" {
                                          Expect.isFalse
                                              ...
                                              (RandomAccessList.empty
                                               |> RandomAccessList.cons 1
                                               |> RandomAccessList.cons 2
                                      ...
                                      test "RandomAccessList.tryTail on len 2 should return" {
                                          ...
                                          Expect.equal "RandomAccessList.tryTail" 1
                                          <| RandomAccessList.head a.Value
                                      }
                                          ...
                                          let windowFun windowLength =
                                              fun (v: RandomAccessList<RandomAccessList<int>>) t ->
                                                  if v.Head.Length = windowLength then
                                                      RandomAccessList.cons (RandomAccessList.empty.Cons(t)) v
                                                  else
                                                      RandomAccessList.tail v
                                                      |> RandomAccessList.cons(RandomAccessList.cons t (RandomAccessList.head v))
                                      ...
                                      test "RandomAccessList.windowSeq should keep every value from its original list" {
                                          ...
                                          for i in 1..35 do
                                              ...
                                              Expect.equal
                                                  ...
                                                  fullVec
                                                  (lists
                                                   |> RandomAccessList.fold RandomAccessList.append RandomAccessList.empty)
                                      ...
                                      test "RandomAccessList.windowSeq should return vectors of equal RandomAccessList.length if possible" {
                                          ...
                                          Expect.equal
                                              ...
                                              [ 3; 3; 3; 3; 3; 3; 3; 3; 3; 3 ]
                                              (len3lists
                                               |> RandomAccessList.map RandomAccessList.length
                                               |> RandomAccessList.toSeq
                                               |> Seq.toList)
                                      ...
                                      test "RandomAccessList.nth on RandomAccessList.empty list should throw" {
                                          Expect.throwsT<System.IndexOutOfRangeException> "RandomAccessList.empty list" (fun () ->
                                              RandomAccessList.empty |> RandomAccessList.nth 0 |> ignore)
                                      }
                                      ...
                                      test "appending two lists keeps order of items" {
                                          ...
                                          Expect.equal
                                              ""
                                              [ 1; 2; 3; 7; 8; 9 ]
                                              (RandomAccessList.append (!list1) (!list2)
                                               |> RandomAccessList.toSeq
                                               |> Seq.toList)
                                      }

                                      test "rev RandomAccessList.empty" {
                                          Expect.isTrue "rev RandomAccessList.empty"
                                          <| RandomAccessList.isEmpty(RandomAccessList.empty |> RandomAccessList.rev)
                                      }
                                      ...
                                      test "rev elements RandomAccessList.length 15" {
                                          let a =
                                              RandomAccessList.ofSeq [ "a"; "b"; "c"; "d"; "e"; "f"; "g"; "h"; "i"; "j"; "l"; "m"; "n"; "o"; "p" ]
                                      ...
                                      test "RandomAccessList.nth RandomAccessList.length 2" {
                                          Expect.isTrue
                                              ""
                                              (((RandomAccessList.empty
                                                 |> RandomAccessList.cons "a"
                                                 |> RandomAccessList.cons "b"
                                                 |> RandomAccessList.nth 0) = "b")
                                               && ((RandomAccessList.empty
                                                    |> RandomAccessList.cons "a"
                                                    |> RandomAccessList.cons "b"
                                                    |> RandomAccessList.nth 1) = "a"))
                                      }
                                      ...
                                      test "RandomAccessList.nth RandomAccessList.length 4" {
                                          let len4 =
                                              ...
                                              |> RandomAccessList.cons "b"
                                              |> RandomAccessList.cons "c"
                                              |> RandomAccessList.cons "d"

                                          Expect.isTrue
                                              "RandomAccessList.nth"
                                              (((len4 |> RandomAccessList.nth 0) = "d")
                                               && ((len4 |> RandomAccessList.nth 1) = "c")
                                               && ((len4 |> RandomAccessList.nth 2) = "b")
                                               && ((len4 |> RandomAccessList.nth 3) = "a"))
                                      }
                                      ...
                                      test "RandomAccessList.nth RandomAccessList.length 5" {
                                          let len5 =
                                              ...
                                              |> RandomAccessList.cons "c"
                                              |> RandomAccessList.cons "d"
                                              |> RandomAccessList.cons "e"

                                          (((len5 |> RandomAccessList.nth 0) = "e")
                                           && ((len5 |> RandomAccessList.nth 1) = "d")
                                           && ((len5 |> RandomAccessList.nth 2) = "c")
                                           && ((len5 |> RandomAccessList.nth 3) = "b")
                                           && ((len5 |> RandomAccessList.nth 4) = "a"))
                                          |> Expect.isTrue "RandomAccessList.nth"
                                      }
                                      ...
                                      test "RandomAccessList.nth RandomAccessList.length 6" {
                                          let len6 =
                                              ...
                                              |> RandomAccessList.cons "d"
                                              |> RandomAccessList.cons "e"
                                              |> RandomAccessList.cons "f"

                                          (((len6 |> RandomAccessList.nth 0) = "f")
                                           && ((len6 |> RandomAccessList.nth 1) = "e")
                                           && ((len6 |> RandomAccessList.nth 2) = "d")
                                           && ((len6 |> RandomAccessList.nth 3) = "c")
                                           && ((len6 |> RandomAccessList.nth 4) = "b")
                                           && ((len6 |> RandomAccessList.nth 5) = "a"))
                                          |> Expect.isTrue "RandomAccessList.nth"
                                      }
                                      ...
                                      test "RandomAccessList.nth RandomAccessList.length 7" {
                                          let len7 =
                                              ...
                                              |> RandomAccessList.cons "e"
                                              |> RandomAccessList.cons "f"
                                              |> RandomAccessList.cons "g"

                                          (((len7 |> RandomAccessList.nth 0) = "g")
                                           && ((len7 |> RandomAccessList.nth 1) = "f")
                                           && ((len7 |> RandomAccessList.nth 2) = "e")
                                           && ((len7 |> RandomAccessList.nth 3) = "d")
                                           && ((len7 |> RandomAccessList.nth 4) = "c")
                                           && ((len7 |> RandomAccessList.nth 5) = "b")
                                           && ((len7 |> RandomAccessList.nth 6) = "a"))
                                          |> Expect.isTrue "RandomAccessList.nth"
                                      }
                                      ...
                                      test "RandomAccessList.nth RandomAccessList.length 8" {
                                          let len8 =
                                              ...
                                              |> RandomAccessList.cons "f"
                                              |> RandomAccessList.cons "g"
                                              |> RandomAccessList.cons "h"

                                          (((len8 |> RandomAccessList.nth 0) = "h")
                                           && ((len8 |> RandomAccessList.nth 1) = "g")
                                           && ((len8 |> RandomAccessList.nth 2) = "f")
                                           && ((len8 |> RandomAccessList.nth 3) = "e")
                                           && ((len8 |> RandomAccessList.nth 4) = "d")
                                           && ((len8 |> RandomAccessList.nth 5) = "c")
                                           && ((len8 |> RandomAccessList.nth 6) = "b")
                                           && ((len8 |> RandomAccessList.nth 7) = "a"))
                                          |> Expect.isTrue "RandomAccessList.nth"
                                      }
                                      ...
                                      test "RandomAccessList.nth RandomAccessList.length 9" {
                                          let len9 =
                                              ...
                                              |> RandomAccessList.cons "g"
                                              |> RandomAccessList.cons "h"
                                              |> RandomAccessList.cons "i"

                                          (((len9 |> RandomAccessList.nth 0) = "i")
                                           && ((len9 |> RandomAccessList.nth 1) = "h")
                                           && ((len9 |> RandomAccessList.nth 2) = "g")
                                           && ((len9 |> RandomAccessList.nth 3) = "f")
                                           && ((len9 |> RandomAccessList.nth 4) = "e")
                                           && ((len9 |> RandomAccessList.nth 5) = "d")
                                           && ((len9 |> RandomAccessList.nth 6) = "c")
                                           && ((len9 |> RandomAccessList.nth 7) = "b")
                                           && ((len9 |> RandomAccessList.nth 8) = "a"))
                                          |> Expect.isTrue "RandomAccessList.nth"
                                      }
                                      ...
                                      test "RandomAccessList.nth RandomAccessList.length 10" {
                                          let lena =
                                              ...
                                              |> RandomAccessList.cons "h"
                                              |> RandomAccessList.cons "i"
                                              |> RandomAccessList.cons "j"

                                          (((lena |> RandomAccessList.nth 0) = "j")
                                           && ((lena |> RandomAccessList.nth 1) = "i")
                                           && ((lena |> RandomAccessList.nth 2) = "h")
                                           && ((lena |> RandomAccessList.nth 3) = "g")
                                           && ((lena |> RandomAccessList.nth 4) = "f")
                                           && ((lena |> RandomAccessList.nth 5) = "e")
                                           && ((lena |> RandomAccessList.nth 6) = "d")
                                           && ((lena |> RandomAccessList.nth 7) = "c")
                                           && ((lena |> RandomAccessList.nth 8) = "b")
                                           && ((lena |> RandomAccessList.nth 9) = "a"))
                                          |> Expect.isTrue "RandomAccessList.nth"
                                      }
                                      ...
                                      test "RandomAccessList.tryNth RandomAccessList.length 7" {
                                          ...
                                          ((g.Value = "g")
                                           ...
                                           && (b.Value = "b")
                                           && (a.Value = "a"))
                                          |> Expect.isTrue "RandomAccessList.tryNth"
                                      }
                                      ...
                                      test "RandomAccessList.nthNth throws exception for out-of-bounds indices" {
                                          ...
                                          Expect.throwsT<System.IndexOutOfRangeException> "RandomAccessList.nthNth" (fun () ->
                                              RandomAccessList.nthNth 2 2 outer |> ignore)

                                          Expect.throwsT<System.IndexOutOfRangeException> "RandomAccessList.nthNth" (fun () ->
                                              RandomAccessList.nthNth 1 5 outer |> ignore)

                                          Expect.throwsT<System.IndexOutOfRangeException> "RandomAccessList.nthNth" (fun () ->
                                              RandomAccessList.nthNth -1 2 outer |> ignore)
                                      ...
                                      test "list of lists can be RandomAccessList.updated with RandomAccessList.updateNth" {
                                          ...
                                          Expect.equal
                                              ...
                                              7
                                              (outer
                                               |> RandomAccessList.updateNth 0 2 7
                                               |> RandomAccessList.nthNth 0 2)

                                          Expect.equal
                                              "RandomAccessList.updateNth"
                                              9
                                              (outer
                                               |> RandomAccessList.updateNth 1 4 9
                                               |> RandomAccessList.nthNth 1 4)
                                      }
                                      ...
                                      test "RandomAccessList.updateNth throws exception for out-of-bounds indices" {
                                          ...
                                          Expect.throwsT<System.IndexOutOfRangeException> "RandomAccessList.updateNth" (fun () ->
                                              RandomAccessList.updateNth 0 6 7 outer |> ignore)

                                          Expect.throwsT<System.IndexOutOfRangeException> "RandomAccessList.updateNth" (fun () ->
                                              RandomAccessList.updateNth 9 2 7 outer |> ignore)

                                          Expect.throwsT<System.IndexOutOfRangeException> "RandomAccessList.updateNth" (fun () ->
                                              RandomAccessList.updateNth 1 -4 7 outer |> ignore)
                                      ...
                                      test "RandomAccessList.tryUpdateNth returns None for out-of-bounds indices" {
                                          ...
                                          Expect.isNone "RandomAccessList.tryUpdateNth"
                                          <| RandomAccessList.tryUpdateNth 0 6 7 outer

                                          Expect.isNone "RandomAccessList.tryUpdateNth"
                                          <| RandomAccessList.tryUpdateNth 9 2 7 outer

                                          Expect.isNone "RandomAccessList.tryUpdateNth"
                                          <| RandomAccessList.tryUpdateNth 1 -4 7 outer
                                      ...
                                      test "RandomAccessList.tryUpdateNth should not change the original list" {
                                          ...
                                          Expect.equal
                                              ...
                                              7
                                              (!outer
                                               |> RandomAccessList.tryUpdateNth 0 2 7
                                               |> Option.get
                                               |> RandomAccessList.nthNth 0 2)
                                          ...
                                          Expect.equal
                                              ...
                                              9
                                              (!outer
                                               |> RandomAccessList.tryUpdateNth 1 4 9
                                               |> Option.get
                                               |> RandomAccessList.nthNth 1 4)
                                      ...
                                      test "RandomAccessList.update RandomAccessList.length 1" {
                                          Expect.equal
                                              ...
                                              (RandomAccessList.empty
                                               |> RandomAccessList.cons "a"
                                               |> RandomAccessList.update 0 "aa"
                                               |> RandomAccessList.nth 0)
                                      }
                                      ...
                                      test "RandomAccessList.update RandomAccessList.length 2" {
                                          ...
                                          Expect.isTrue
                                              "RandomAccessList.update"
                                              (((len2 |> RandomAccessList.update 0 "bb" |> RandomAccessList.nth 0) = "bb")
                                               && ((len2 |> RandomAccessList.update 1 "aa" |> RandomAccessList.nth 1) = "aa"))
                                      }
                                      ...
                                      test "RandomAccessList.update RandomAccessList.length 3" {
                                          ...
                                          (((len3 |> RandomAccessList.update 0 "cc" |> RandomAccessList.nth 0) = "cc")
                                           && ((len3 |> RandomAccessList.update 1 "bb" |> RandomAccessList.nth 1) = "bb")
                                           && ((len3 |> RandomAccessList.update 2 "aa" |> RandomAccessList.nth 2) = "aa"))
                                      ...
                                      test "RandomAccessList.update RandomAccessList.length 4" {
                                          ...
                                          (((len4 |> RandomAccessList.update 0 "dd" |> RandomAccessList.nth 0) = "dd")
                                           && ((len4 |> RandomAccessList.update 1 "cc" |> RandomAccessList.nth 1) = "cc")
                                           && ((len4 |> RandomAccessList.update 2 "bb" |> RandomAccessList.nth 2) = "bb")
                                           && ((len4 |> RandomAccessList.update 3 "aa" |> RandomAccessList.nth 3) = "aa"))
                                          |> Expect.isTrue "RandomAccessList.update"
                                      }
                                      ...
                                      test "RandomAccessList.update RandomAccessList.length 5" {
                                          ...
                                          (((len5 |> RandomAccessList.update 0 "ee" |> RandomAccessList.nth 0) = "ee")
                                           && ((len5 |> RandomAccessList.update 1 "dd" |> RandomAccessList.nth 1) = "dd")
                                           && ((len5 |> RandomAccessList.update 2 "cc" |> RandomAccessList.nth 2) = "cc")
                                           && ((len5 |> RandomAccessList.update 3 "bb" |> RandomAccessList.nth 3) = "bb")
                                           && ((len5 |> RandomAccessList.update 4 "aa" |> RandomAccessList.nth 4) = "aa"))
                                          |> Expect.isTrue "RandomAccessList.update"
                                      }
                                      ...
                                      test "RandomAccessList.update RandomAccessList.length 6" {
                                          ...
                                          (((len6 |> RandomAccessList.update 0 "ff" |> RandomAccessList.nth 0) = "ff")
                                           && ((len6 |> RandomAccessList.update 1 "ee" |> RandomAccessList.nth 1) = "ee")
                                           && ((len6 |> RandomAccessList.update 2 "dd" |> RandomAccessList.nth 2) = "dd")
                                           && ((len6 |> RandomAccessList.update 3 "cc" |> RandomAccessList.nth 3) = "cc")
                                           && ((len6 |> RandomAccessList.update 4 "bb" |> RandomAccessList.nth 4) = "bb")
                                           && ((len6 |> RandomAccessList.update 5 "aa" |> RandomAccessList.nth 5) = "aa"))
                                          |> Expect.isTrue "RandomAccessList.update"
                                      }
                                      ...
                                      test "RandomAccessList.update RandomAccessList.length 7" {
                                          ...
                                          (((len7 |> RandomAccessList.update 0 "gg" |> RandomAccessList.nth 0) = "gg")
                                           && ((len7 |> RandomAccessList.update 1 "ff" |> RandomAccessList.nth 1) = "ff")
                                           && ((len7 |> RandomAccessList.update 2 "ee" |> RandomAccessList.nth 2) = "ee")
                                           && ((len7 |> RandomAccessList.update 3 "dd" |> RandomAccessList.nth 3) = "dd")
                                           && ((len7 |> RandomAccessList.update 4 "cc" |> RandomAccessList.nth 4) = "cc")
                                           && ((len7 |> RandomAccessList.update 5 "bb" |> RandomAccessList.nth 5) = "bb")
                                           && ((len7 |> RandomAccessList.update 6 "aa" |> RandomAccessList.nth 6) = "aa"))
                                          |> Expect.isTrue "RandomAccessList.update"
                                      }
                                      ...
                                      test "RandomAccessList.update RandomAccessList.length 8" {
                                          ...
                                          (((len8 |> RandomAccessList.update 0 "hh" |> RandomAccessList.nth 0) = "hh")
                                           && ((len8 |> RandomAccessList.update 1 "gg" |> RandomAccessList.nth 1) = "gg")
                                           && ((len8 |> RandomAccessList.update 2 "ff" |> RandomAccessList.nth 2) = "ff")
                                           && ((len8 |> RandomAccessList.update 3 "ee" |> RandomAccessList.nth 3) = "ee")
                                           && ((len8 |> RandomAccessList.update 4 "dd" |> RandomAccessList.nth 4) = "dd")
                                           && ((len8 |> RandomAccessList.update 5 "cc" |> RandomAccessList.nth 5) = "cc")
                                           && ((len8 |> RandomAccessList.update 6 "bb" |> RandomAccessList.nth 6) = "bb")
                                           && ((len8 |> RandomAccessList.update 7 "aa" |> RandomAccessList.nth 7) = "aa"))
                                          |> Expect.isTrue "RandomAccessList.update"
                                      }
                                      ...
                                      test "RandomAccessList.update RandomAccessList.length 9" {
                                          ...
                                          (((len9 |> RandomAccessList.update 0 "ii" |> RandomAccessList.nth 0) = "ii")
                                           && ((len9 |> RandomAccessList.update 1 "hh" |> RandomAccessList.nth 1) = "hh")
                                           && ((len9 |> RandomAccessList.update 2 "gg" |> RandomAccessList.nth 2) = "gg")
                                           && ((len9 |> RandomAccessList.update 3 "ff" |> RandomAccessList.nth 3) = "ff")
                                           && ((len9 |> RandomAccessList.update 4 "ee" |> RandomAccessList.nth 4) = "ee")
                                           && ((len9 |> RandomAccessList.update 5 "dd" |> RandomAccessList.nth 5) = "dd")
                                           && ((len9 |> RandomAccessList.update 6 "cc" |> RandomAccessList.nth 6) = "cc")
                                           && ((len9 |> RandomAccessList.update 7 "bb" |> RandomAccessList.nth 7) = "bb")
                                           && ((len9 |> RandomAccessList.update 8 "aa" |> RandomAccessList.nth 8) = "aa"))
                                          |> Expect.isTrue "RandomAccessList.update"
                                      }
                                      ...
                                      test "RandomAccessList.update RandomAccessList.length 10" {
                                          ...
                                          (((lena |> RandomAccessList.update 0 "jj" |> RandomAccessList.nth 0) = "jj")
                                           && ((lena |> RandomAccessList.update 1 "ii" |> RandomAccessList.nth 1) = "ii")
                                           && ((lena |> RandomAccessList.update 2 "hh" |> RandomAccessList.nth 2) = "hh")
                                           && ((lena |> RandomAccessList.update 3 "gg" |> RandomAccessList.nth 3) = "gg")
                                           && ((lena |> RandomAccessList.update 4 "ff" |> RandomAccessList.nth 4) = "ff")
                                           && ((lena |> RandomAccessList.update 5 "ee" |> RandomAccessList.nth 5) = "ee")
                                           && ((lena |> RandomAccessList.update 6 "dd" |> RandomAccessList.nth 6) = "dd")
                                           && ((lena |> RandomAccessList.update 7 "cc" |> RandomAccessList.nth 7) = "cc")
                                           && ((lena |> RandomAccessList.update 8 "bb" |> RandomAccessList.nth 8) = "bb")
                                           && ((lena |> RandomAccessList.update 9 "aa" |> RandomAccessList.nth 9) = "aa"))
                                          |> Expect.isTrue "RandomAccessList.update"
                                      }
                                      ...
                                      test "RandomAccessList.tryUpdate RandomAccessList.length 1" {
                                          let a =
                                              RandomAccessList.empty
                                              |> RandomAccessList.cons "a"
                                              |> RandomAccessList.tryUpdate 0 "aa"

                                          ((a.Value |> RandomAccessList.nth 0) = "aa")
                                      ...
                                      test "RandomAccessList.tryUpdate RandomAccessList.length 2" {
                                          ...
                                          (((b.Value |> RandomAccessList.nth 0) = "bb")
                                           && ((a.Value |> RandomAccessList.nth 1) = "aa"))
                                          |> Expect.isTrue "RandomAccessList.tryUpdate"
                                      }
                                      ...
                                      test "RandomAccessList.tryUpdate RandomAccessList.length 3" {
                                          ...
                                          (((c.Value |> RandomAccessList.nth 0) = "cc")
                                           && ((b.Value |> RandomAccessList.nth 1) = "bb")
                                           && ((a.Value |> RandomAccessList.nth 2) = "aa"))
                                          |> Expect.isTrue "RandomAccessList.tryUpdate"
                                      }
                                      ...
                                      test "RandomAccessList.tryUpdate RandomAccessList.length 4" {
                                          ...
                                          (((d.Value |> RandomAccessList.nth 0) = "dd")
                                           && ((c.Value |> RandomAccessList.nth 1) = "cc")
                                           && ((b.Value |> RandomAccessList.nth 2) = "bb")
                                           && ((a.Value |> RandomAccessList.nth 3) = "aa"))
                                          |> Expect.isTrue "RandomAccessList.tryUpdate"
                                      }
                                      ...
                                      test "RandomAccessList.tryUpdate RandomAccessList.length 5" {
                                          ...
                                          (((e.Value |> RandomAccessList.nth 0) = "ee")
                                           && ((d.Value |> RandomAccessList.nth 1) = "dd")
                                           && ((c.Value |> RandomAccessList.nth 2) = "cc")
                                           && ((b.Value |> RandomAccessList.nth 3) = "bb")
                                           && ((a.Value |> RandomAccessList.nth 4) = "aa"))
                                          |> Expect.isTrue "RandomAccessList.tryUpdate"
                                      }
                                      ...
                                      test "RandomAccessList.tryUpdate RandomAccessList.length 6" {
                                          ...
                                          (((f.Value |> RandomAccessList.nth 0) = "ff")
                                           && ((e.Value |> RandomAccessList.nth 1) = "ee")
                                           && ((d.Value |> RandomAccessList.nth 2) = "dd")
                                           && ((c.Value |> RandomAccessList.nth 3) = "cc")
                                           && ((b.Value |> RandomAccessList.nth 4) = "bb")
                                           && ((a.Value |> RandomAccessList.nth 5) = "aa"))
                                          |> Expect.isTrue "RandomAccessList.tryUpdate"
                                      }
                                      ...
                                      test "RandomAccessList.tryUpdate RandomAccessList.length 7" {
                                          ...
                                          (((g.Value |> RandomAccessList.nth 0) = "gg")
                                           && ((f.Value |> RandomAccessList.nth 1) = "ff")
                                           && ((e.Value |> RandomAccessList.nth 2) = "ee")
                                           && ((d.Value |> RandomAccessList.nth 3) = "dd")
                                           && ((c.Value |> RandomAccessList.nth 4) = "cc")
                                           && ((b.Value |> RandomAccessList.nth 5) = "bb")
                                           && ((a.Value |> RandomAccessList.nth 6) = "aa"))
                                          |> Expect.isTrue "RandomAccessList.tryUpdate"
                                      }
                                      ...
                                      test "RandomAccessList.tryUpdate RandomAccessList.length 8" {
                                          ...
                                          (((h.Value |> RandomAccessList.nth 0) = "hh")
                                           && ((g.Value |> RandomAccessList.nth 1) = "gg")
                                           && ((f.Value |> RandomAccessList.nth 2) = "ff")
                                           && ((e.Value |> RandomAccessList.nth 3) = "ee")
                                           && ((d.Value |> RandomAccessList.nth 4) = "dd")
                                           && ((c.Value |> RandomAccessList.nth 5) = "cc")
                                           && ((b.Value |> RandomAccessList.nth 6) = "bb")
                                           && ((a.Value |> RandomAccessList.nth 7) = "aa"))
                                          |> Expect.isTrue "RandomAccessList.tryUpdate"
                                      }
                                      ...
                                      test "RandomAccessList.tryUpdate RandomAccessList.length 9" {
                                          ...
                                          (((i.Value |> RandomAccessList.nth 0) = "ii")
                                           && ((h.Value |> RandomAccessList.nth 1) = "hh")
                                           && ((g.Value |> RandomAccessList.nth 2) = "gg")
                                           && ((f.Value |> RandomAccessList.nth 3) = "ff")
                                           && ((e.Value |> RandomAccessList.nth 4) = "ee")
                                           && ((d.Value |> RandomAccessList.nth 5) = "dd")
                                           && ((c.Value |> RandomAccessList.nth 6) = "cc")
                                           && ((b.Value |> RandomAccessList.nth 7) = "bb")
                                           && ((a.Value |> RandomAccessList.nth 8) = "aa"))
                                          |> Expect.isTrue "RandomAccessList.tryUpdate"
                                      }
                                      ...
                                      test "RandomAccessList.tryUpdate RandomAccessList.length 10" {
                                          ...
                                          (((j.Value |> RandomAccessList.nth 0) = "jj")
                                           && ((i.Value |> RandomAccessList.nth 1) = "ii")
                                           && ((h.Value |> RandomAccessList.nth 2) = "hh")
                                           && ((g.Value |> RandomAccessList.nth 3) = "gg")
                                           && ((f.Value |> RandomAccessList.nth 4) = "ff")
                                           && ((e.Value |> RandomAccessList.nth 5) = "ee")
                                           && ((d.Value |> RandomAccessList.nth 6) = "dd")
                                           && ((c.Value |> RandomAccessList.nth 7) = "cc")
                                           && ((b.Value |> RandomAccessList.nth 8) = "bb")
                                           && ((a.Value |> RandomAccessList.nth 9) = "aa"))
                                          |> Expect.isTrue "RandomAccessList.tryUpdate"
                                      }
                                      ...
                                      test "RandomAccessList.length of 1 - 10 good" {
                                          ...
                                          (((RandomAccessList.length len1) = 1)
                                           && ((RandomAccessList.length len2) = 2)
                                           && ((RandomAccessList.length len3) = 3)
                                           && ((RandomAccessList.length len4) = 4)
                                           && ((RandomAccessList.length len5) = 5)
                                           && ((RandomAccessList.length len6) = 6)
                                           && ((RandomAccessList.length len7) = 7)
                                           && ((RandomAccessList.length len8) = 8)
                                           && ((RandomAccessList.length len9) = 9)
                                           && ((RandomAccessList.length lena) = 10))
                                          |> Expect.isTrue "RandomAccessList.length"
                                      }
                                      ...
                                      test "RandomAccessList.ofSeq random access list" {
                                          ...
                                          (((x |> RandomAccessList.nth 0) = "a")
                                           && ((x |> RandomAccessList.nth 1) = "b")
                                           && ((x |> RandomAccessList.nth 2) = "c")
                                           && ((x |> RandomAccessList.nth 3) = "d")
                                           && ((x |> RandomAccessList.nth 4) = "e")
                                           && ((x |> RandomAccessList.nth 5) = "f")
                                           && ((x |> RandomAccessList.nth 6) = "g")
                                           && ((x |> RandomAccessList.nth 7) = "h")
                                           && ((x |> RandomAccessList.nth 8) = "i")
                                           && ((x |> RandomAccessList.nth 9) = "j"))
                                          |> Expect.isTrue "RandomAccessList.ofSeq"
                                      }
    ...
    let propertyTestRandomAccessList =
        ...
        *)
        let RandomAccessListOfListGen = gen {
        ...
        *)
        let RandomAccessListIntGen = gen {
        ...
        let RandomAccessListIntOfSeqGen = gen {
            let! n = Gen.length1thru100
            let! x = Gen.listInt n
            return ((RandomAccessList.ofSeq x), x)
        }

        let RandomAccessListIntConsGen = gen {
            let! n = Gen.length1thru100
            let! x = Gen.listInt n
            return ((RandomAccessList.empty |> consThruList x), List.rev x)
        }

        let RandomAccessListObjGen = gen {
            let! n = Gen.length2thru100
        ...
        let RandomAccessListStringGen = gen {
            let! n = Gen.length1thru100
            let! n2 = Gen.length2thru100
        ...
        let intGens start =
            ...
            v.[1] <-
                RandomAccessListIntOfSeqGen
                |> Gen.filter(fun (q, l) -> l.Length >= start)

            v.[2] <-
                RandomAccessListIntConsGen
                |> Gen.filter(fun (q, l) -> l.Length >= start)
        ...
        testList "RandomAccessList property tests" [ testPropertyWithConfig
                                                         config10k
                                                         "RandomAccessList.fold matches build list rev"
                                                         (Prop.forAll(Arb.fromGen RandomAccessListIntGen)
                                                          <| fun (q, l) -> q |> RandomAccessList.fold (fun l' elem -> elem :: l') [] = (List.rev l))

                                                     testPropertyWithConfig
                                                         config10k
                                                         "RandomAccessList OfSeq RandomAccessList.fold matches build list rev"
                                                         (Prop.forAll(Arb.fromGen RandomAccessListIntOfSeqGen)
                                                          <| fun (q, l) -> q |> RandomAccessList.fold (fun l' elem -> elem :: l') [] = (List.rev l))

                                                     testPropertyWithConfig
                                                         config10k
                                                         "andomAccessList Consfold matches build list rev"
                                                         (Prop.forAll(Arb.fromGen RandomAccessListIntConsGen)
                                                          <| fun (q, l) -> q |> RandomAccessList.fold (fun l' elem -> elem :: l') [] = (List.rev l))

                                                     testPropertyWithConfig
                                                         config10k
                                                         "RandomAccessList.foldBack matches build list"
                                                         (Prop.forAll(Arb.fromGen RandomAccessListIntGen)
                                                          <| fun (q, l) -> RandomAccessList.foldBack (fun elem l' -> elem :: l') q [] = l)

                                                     testPropertyWithConfig
                                                         config10k
                                                         "OfSeq RandomAccessList.foldBack matches build list"
                                                         (Prop.forAll(Arb.fromGen RandomAccessListIntOfSeqGen)
                                                          <| fun (q, l) -> RandomAccessList.foldBack (fun elem l' -> elem :: l') q [] = l)

                                                     testPropertyWithConfig
                                                         config10k
                                                         "Conj RandomAccessList.foldBack matches build list"
                                                         (Prop.forAll(Arb.fromGen RandomAccessListIntConsGen)
                                                          <| fun (q, l) -> RandomAccessList.foldBack (fun elem l' -> elem :: l') q [] = l)

                                                     testPropertyWithConfig
                                                         config10k
                                                         "get RandomAccessList.head from RandomAccessList 0"
                                                         (Prop.forAll(Arb.fromGen intGensStart1.[0])
                                                          <| fun (q, l) -> (RandomAccessList.head q) = (List.item 0 l))

                                                     testPropertyWithConfig
                                                         config10k
                                                         "get RandomAccessList.head from RandomAccessList 1"
                                                         (Prop.forAll(Arb.fromGen intGensStart1.[1])
                                                          <| fun (q, l) -> (RandomAccessList.head q) = (List.item 0 l))

                                                     testPropertyWithConfig
                                                         config10k
                                                         "get RandomAccessList.head from RandomAccessList 2"
                                                         (Prop.forAll(Arb.fromGen intGensStart1.[2])
                                                          <| fun (q, l) -> (RandomAccessList.head q) = (List.item 0 l))

                                                     testPropertyWithConfig
                                                         config10k
                                                         "get RandomAccessList.head from RandomAccessList safely 0"
                                                         (Prop.forAll(Arb.fromGen intGensStart1.[0])
                                                          <| fun (q, l) -> (RandomAccessList.tryHead q).Value = (List.item 0 l))

                                                     testPropertyWithConfig
                                                         config10k
                                                         "get RandomAccessList.head from RandomAccessList safely 1"
                                                         (Prop.forAll(Arb.fromGen intGensStart1.[1])
                                                          <| fun (q, l) -> (RandomAccessList.tryHead q).Value = (List.item 0 l))

                                                     testPropertyWithConfig
                                                         config10k
                                                         "get RandomAccessList.head from RandomAccessList safely 2"
                                                         (Prop.forAll(Arb.fromGen intGensStart1.[2])
                                                          <| fun (q, l) -> (RandomAccessList.tryHead q).Value = (List.item 0 l))

                                                     testPropertyWithConfig
                                                         config10k
                                                         "get RandomAccessList.tail from RandomAccessList 0"
                                                         (Prop.forAll(Arb.fromGen intGensStart2.[0])
                                                          <| fun ((q), l) -> q.Tail.Head = (List.item 1 l))

                                                     testPropertyWithConfig
                                                         config10k
                                                         "get RandomAccessList.tail from RandomAccessList 1"
                                                         (Prop.forAll(Arb.fromGen intGensStart2.[1])
                                                          <| fun ((q), l) -> q.Tail.Head = (List.item 1 l))

                                                     testPropertyWithConfig
                                                         config10k
                                                         "get RandomAccessList.tail from RandomAccessList 2"
                                                         (Prop.forAll(Arb.fromGen intGensStart2.[2])
                                                          <| fun ((q), l) -> q.Tail.Head = (List.item 1 l))

                                                     testPropertyWithConfig
                                                         config10k
                                                         "get RandomAccessList.tail from RandomAccessList safely 0"
                                                         (Prop.forAll(Arb.fromGen intGensStart2.[0])
                                                          <| fun (q, l) -> q.TryTail.Value.Head = (List.item 1 l))

                                                     testPropertyWithConfig
                                                         config10k
                                                         "get RandomAccessList.tail from RandomAccessList safely 1"
                                                         (Prop.forAll(Arb.fromGen intGensStart2.[1])
                                                          <| fun (q, l) -> q.TryTail.Value.Head = (List.item 1 l))

                                                     testPropertyWithConfig
                                                         config10k
                                                         "get RandomAccessList.tail from RandomAccessList safely 2"
                                                         (Prop.forAll(Arb.fromGen intGensStart2.[2])
                                                          <| fun (q, l) -> q.TryTail.Value.Head = (List.item 1 l))

                                                     testPropertyWithConfig
                                                         config10k
                                                         "int RandomAccessList builds and serializes 0"
                                                         (Prop.forAll(Arb.fromGen intGensStart1.[0])
                                                          <| fun (q, l) -> q |> Seq.toList = l)

                                                     testPropertyWithConfig
                                                         config10k
                                                         "int RandomAccessList builds and serializes 1"
                                                         (Prop.forAll(Arb.fromGen intGensStart1.[1])
                                                          <| fun (q, l) -> q |> Seq.toList = l)

                                                     testPropertyWithConfig
                                                         config10k
                                                         "int RandomAccessList builds and serializes 2"
                                                         (Prop.forAll(Arb.fromGen intGensStart1.[2])
                                                          <| fun (q, l) -> q |> Seq.toList = l)

                                                     testPropertyWithConfig
                                                         config10k
                                                         "obj RandomAccessList builds and serializes"
                                                         (Prop.forAll(Arb.fromGen RandomAccessListObjGen)
                                                          <| fun (q, l) -> q |> Seq.toList = l)

                                                     testPropertyWithConfig
                                                         config10k
                                                         "string RandomAccessList builds and serializes"
                                                         (Prop.forAll(Arb.fromGen RandomAccessListStringGen)
                                                          <| fun (q, l) -> q |> Seq.toList = l)

                                                     testPropertyWithConfig
                                                         config10k
                                                         "rev matches build list rev"
                                                         (Prop.forAll(Arb.fromGen RandomAccessListIntGen)
                                                          <| fun (q, l) -> q |> RandomAccessList.rev |> List.ofSeq = (List.rev l))

                                                     testPropertyWithConfig
                                                         config10k
                                                         "OfSeq rev matches build list rev"
                                                         (Prop.forAll(Arb.fromGen RandomAccessListIntOfSeqGen)
                                                          <| fun (q, l) -> q |> RandomAccessList.rev |> List.ofSeq = (List.rev l))

                                                     testPropertyWithConfig
                                                         config10k
                                                         "Cons rev matches build list rev"
                                                         (Prop.forAll(Arb.fromGen RandomAccessListIntConsGen)
                                                          <| fun (q, l) -> q |> RandomAccessList.rev |> List.ofSeq = (List.rev l))
