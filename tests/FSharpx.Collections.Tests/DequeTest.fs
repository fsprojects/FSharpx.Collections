...
module DequeTests  =
    ...
    let testDeque =
        ...
        let len4conj = Deque.empty |> Deque.conj "d" |> Deque.conj "c" |> Deque.conj "b" |> Deque.conj "a"
        let len5conj = Deque.empty |> Deque.conj "e" |> Deque.conj "d" |> Deque.conj "c" |> Deque.conj "b" |> Deque.conj "a"
        let len6conj = Deque.empty |> Deque.conj "f" |> Deque.conj "e" |> Deque.conj "d" |> Deque.conj "c" |> Deque.conj "b" |> Deque.conj "a"
        let len7conj = Deque.empty |> Deque.conj "g" |> Deque.conj "f" |> Deque.conj "e" |> Deque.conj "d" |> Deque.conj "c" |> Deque.conj "b" |> Deque.conj "a"
        let len8conj = Deque.empty |> Deque.conj "h" |> Deque.conj "g" |> Deque.conj "f" |> Deque.conj "e" |> Deque.conj "d" |> Deque.conj "c" |> Deque.conj "b" |> Deque.conj "a"
        let len9conj = Deque.empty |> Deque.conj "i" |> Deque.conj "h" |> Deque.conj "g" |> Deque.conj "f" |> Deque.conj "e" |> Deque.conj "d" |> Deque.conj "c" |> Deque.conj "b" |> Deque.conj "a"
        let lenaconj = Deque.empty |> Deque.conj "j" |> Deque.conj "i" |> Deque.conj "h" |> Deque.conj "g" |> Deque.conj "f" |> Deque.conj "e" |> Deque.conj "d" |> Deque.conj "c" |> Deque.conj "b" |> Deque.conj "a"
        ...
        testList "Deque" [
            ...
            test "Deque.conj works" {
                Expect.isFalse "" (len2conj |> Deque.isEmpty) }

            test "Deque.singleton head works" {
                Expect.equal "Deque.singleton" "a" (len1 |> Deque.head) }

            test "Deque.singleton last works" {
            ...
            test "head, Deque.tail, and length work test 1" {
                ...
                Expect.isTrue "head, Deque.tail, and length" (((Deque.length t1) = 1) && ((Deque.length t1s) = 1) && ((Deque.head t1) = "a") && ((Deque.head t1s) = "a")) }
            ...
            test "head, Deque.tail, and length work test 2" {
                ...
                && ((Deque.head t1_1) = "a") && ((Deque.head t1_1s) = "a")) |> Expect.isTrue "head, Deque.tail, and length" }
            ...
            test "head, Deque.tail, and length work test 3" {
                ...
                && ((Deque.head t1_1s) = "a")) |> Expect.isTrue "head, Deque.tail, and length" }
            ...
            test "head, Deque.tail, and length work test 4" {
                ...
                && ((Deque.length t1_1) = 1) && ((Deque.length t1_1s) = 1) && ((Deque.head t1_1) = "a") && ((Deque.head t1_1s) = "a")) |> Expect.isTrue "head, Deque.tail, and length" }
            ...
            test "last, init, and length work test 2" {
                ...
                Expect.isTrue "last, init, and length" (((Deque.length t1) = 2) && ((Deque.last t1) = "b") && ((Deque.length t1_1) = 1)  && ((Deque.last t1_1) = "c") ) }
            ...
            test "last, init, and length work test 3" {
                ...
                && ((Deque.length t1_2) = 1)  && ((Deque.last t1_2) = "d") ) |> Expect.isTrue "last, init, and length" }
            ...
            test "last, init, and length work test 4" {
                ...
                && ((Deque.length t1_3) = 1)  && ((Deque.last t1_3) = "e") ) |> Expect.isTrue "last, init, and length" }
            ...
            test "last, init, and length work test 5" {
                ...
                && ((Deque.length t1_4) = 1)  && ((Deque.last t1_4) = "f") ) |> Expect.isTrue "last, init, and length" }
            ...
            test "last, init, and length work test 6" {
                ...
                && ((Deque.length t1_5) = 1)  && ((Deque.last t1_5) = "g") ) |> Expect.isTrue "last, init, and length" }
            ...
            test "last, init, and length work test 7" {
                ...
                && ((Deque.length t1_6) = 1)  && ((Deque.last t1_6) = "h") ) |> Expect.isTrue "last, init, and length" }
            ...
            test "last, init, and length work test 8" {
                ...
                && ((Deque.length t1_7) = 1)  && ((Deque.last t1_7) = "i") ) |> Expect.isTrue "last, init, and length" }
            ...
            test "last, init, and length work test 9" {
                ...
                && ((Deque.length t1_8) = 1)  && ((Deque.last t1_8) = "j") ) |> Expect.isTrue "last, init, and length" }
            ...
            test "ofCatLists and Deque.uncons" {
                ...
                Expect.isTrue "ofCatLists and Deque.uncons" ((h1 = "a") && (h2 = "b") && (h3 = "c") && (h4 = "d") && (h5 = "e") && (h6 = "f") && (Deque.isEmpty t6)) }
            ...
            test "Deque.unconj works" {
                ...
                Expect.isTrue "Deque.unconj" ((l1 = "a") && (l2 = "b") && (l3 = "c") && (l4 = "d") && (l5 = "e") && (l6 = "f") && (Deque.isEmpty i6)) }
            ...
            test "rev deque length 1" {
                Expect.equal "length" "a" (Deque.rev len1 |> Deque.head) } 
    ...
    let propertyTestDeque =
        ...
        *)
        ...
        testList "Deque property tests" [
            ...
            testPropertyWithConfig config10k "get Deque.tail from deque 0" (Prop.forAll (Arb.fromGen intGensStart2.[0]) <|
                fun (q, l) -> q.Tail.Head = List.item 1 l )

            testPropertyWithConfig config10k "get Deque.tail from deque 1" (Prop.forAll (Arb.fromGen intGensStart2.[1]) <|
                fun (q, l) -> q.Tail.Head = List.item 1 l )

            testPropertyWithConfig config10k "get Deque.tail from deque 2" (Prop.forAll (Arb.fromGen intGensStart2.[2]) <|
                fun (q, l) -> q.Tail.Head = List.item 1 l )

            testPropertyWithConfig config10k "get Deque.tail from deque safely 0" (Prop.forAll (Arb.fromGen intGensStart2.[0]) <|
                fun (q, l) -> q.TryTail.Value.Head = List.item 1 l )

            testPropertyWithConfig config10k "get Deque.tail from deque safely 1" (Prop.forAll (Arb.fromGen intGensStart2.[1]) <|
                fun (q, l) -> q.TryTail.Value.Head = List.item 1 l )

            testPropertyWithConfig config10k "get Deque.tail from deque safely 2" (Prop.forAll (Arb.fromGen intGensStart2.[2]) <|
                fun (q, l) -> q.TryTail.Value.Head = List.item 1 l )

            testPropertyWithConfig config10k "get Deque.initial from deque 0" (Prop.forAll (Arb.fromGen intGensStart2.[0]) <|
                fun (q, l) -> List.ofSeq (Deque.initial q) = (List.rev l |> List.tail |> List.rev) )

            testPropertyWithConfig config10k "get Deque.initial from deque 1" (Prop.forAll (Arb.fromGen intGensStart2.[1]) <|
                fun (q, l) -> List.ofSeq (Deque.initial q) = (List.rev l |> List.tail |> List.rev) )

            testPropertyWithConfig config10k "get Deque.initial from deque 2" (Prop.forAll (Arb.fromGen intGensStart2.[2]) <|
                fun (q, l) -> List.ofSeq (Deque.initial q) = (List.rev l |> List.tail |> List.rev) )

            testPropertyWithConfig config10k "get Deque.initial from deque safely 0" (Prop.forAll (Arb.fromGen intGensStart2.[0]) <|
                fun (q, l) -> List.ofSeq q.TryInitial.Value = (List.rev l |> List.tail |> List.rev) )

            testPropertyWithConfig config10k "get Deque.initial from deque safely 1" (Prop.forAll (Arb.fromGen intGensStart2.[1]) <|
                fun (q, l) -> List.ofSeq q.TryInitial.Value = (List.rev l |> List.tail |> List.rev) )

            testPropertyWithConfig config10k "get Deque.initial from deque safely 2" (Prop.forAll (Arb.fromGen intGensStart2.[2]) <|
                fun (q, l) -> List.ofSeq q.TryInitial.Value = (List.rev l |> List.tail |> List.rev) )
        ]