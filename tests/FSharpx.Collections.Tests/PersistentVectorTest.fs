...
module PersistentVectorTests =
    ...
    let testPersistentVector =
        ...
        testList "PersistentVector" [ test "PersistentVector.empty vector should be PersistentVector.empty" {
                                      ...
                                      test "multiple cons to an PersistentVector.empty vector should create a vector" {
                                          Expect.equal
                                              ...
                                              (PersistentVector.empty
                                               ...
                                               |> PersistentVector.conj 4
                                               |> PersistentVector.conj 25
                                               |> PersistentVector.nth 1)
                                      }

                                      test "multiple assoc to the end should work like cons and create a vector" {
                                          let v =
                                              PersistentVector.empty
                                              |> PersistentVector.update 0 1
                                              |> PersistentVector.update 1 4
                                              |> PersistentVector.update 2 25
                                      ...
                                      test "vector with 300 elements should be convertable to a seq" {
                                          ...
                                          for i in 1..300 do
                                              i |> Expect.equal "toSeq toArray" a.[i - 1]
                                      }
                                      ...
                                      test "PersistentVector.nthNth throws exception for out-of-bounds indices" {
                                          ...
                                          Expect.throwsT<System.IndexOutOfRangeException> "PersistentVector.nthNth" (fun () ->
                                              PersistentVector.nthNth 2 2 outer |> ignore)

                                          Expect.throwsT<System.IndexOutOfRangeException> "PersistentVector.nthNth" (fun () ->
                                              PersistentVector.nthNth 1 5 outer |> ignore)

                                          Expect.throwsT<System.IndexOutOfRangeException> "PersistentVector.nthNth" (fun () ->
                                              PersistentVector.nthNth -1 2 outer |> ignore)
                                      ...
                                      test "vector of vectors can be updated with PersistentVector.updateNth" {
                                          ...
                                          Expect.equal
                                              ...
                                              7
                                              (outer
                                               |> PersistentVector.updateNth 0 2 7
                                               |> PersistentVector.nthNth 0 2)

                                          Expect.equal
                                              "PersistentVector.updateNth"
                                              9
                                              (outer
                                               |> PersistentVector.updateNth 1 4 9
                                               |> PersistentVector.nthNth 1 4)
                                      }
                                      ...
                                      test "PersistentVector.updateNth throws exception for out-of-bounds indices" {
                                          ...
                                          Expect.throwsT<System.IndexOutOfRangeException> "PersistentVector.updateNth" (fun () ->
                                              PersistentVector.updateNth 0 6 7 outer |> ignore)

                                          Expect.throwsT<System.IndexOutOfRangeException> "PersistentVector.updateNth" (fun () ->
                                              PersistentVector.updateNth 9 2 7 outer |> ignore)

                                          Expect.throwsT<System.IndexOutOfRangeException> "PersistentVector.updateNth" (fun () ->
                                              PersistentVector.updateNth 1 -4 7 outer |> ignore)
                                      ...
                                      test "PersistentVector.tryUpdateNth should not change the original vector" {
                                          ...
                                          Expect.equal
                                              ...
                                              7
                                              (!outer
                                               |> PersistentVector.tryUpdateNth 0 2 7
                                               |> Option.get
                                               |> PersistentVector.nthNth 0 2)
                                          ...
                                          Expect.equal
                                              ...
                                              9
                                              (!outer
                                               |> PersistentVector.tryUpdateNth 1 4 9
                                               |> Option.get
                                               |> PersistentVector.nthNth 1 4)
                                      ...
                                      test "appending two vectors keeps order of items" {
                                          ...
                                          Expect.equal
                                              "append"
                                              [ 1; 2; 3; 7; 8; 9 ]
                                              (PersistentVector.append (!vector1) (!vector2)
                                      ...
                                      test "windowSeq should keep every value from its original list" {
                                          ...
                                          for i in 1..35 do
                                              ...
                                              Expect.equal
                                                  ...
                                                  fullVec
                                                  (vecs
                                                   |> PersistentVector.fold PersistentVector.append PersistentVector.empty)
                                      }
                                      ...
                                      test "windowSeq should return vectors of equal length if possible" {
                                          ...
                                          Expect.equal
                                              ...
                                              [ 3; 3; 3; 3; 3; 3; 3; 3; 3; 3 ]
                                              (len3vecs
                                               |> PersistentVector.map PersistentVector.length
                                               |> PersistentVector.toSeq
                                               |> Seq.toList)
                                      ...
                                      testList "rangedIterator" [ test "0..count is same as toSeq" {
                                                                  ...
                                                                  test "-1..-2 (negative empty range) throws before iteration starts" {
                                                                      ...
                                                                      Expect.throwsT<IndexOutOfRangeException> "should throw" (fun () ->
                                                                          PersistentVector.rangedIterator -1 -2 vector |> ignore)
                                                                  }
                                                                  ...
                                                                  test "-2..-1 (1 element range, but before start) throws before iteration starts" {
                                                                      ...
                                                                      Expect.throwsT<IndexOutOfRangeException> "should throw" (fun () ->
                                                                          PersistentVector.rangedIterator -2 -1 vector |> ignore)
                                                                  }
