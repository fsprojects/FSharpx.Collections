        ...
        testList
            ...
            [
              ...
              test "tryTail seq3" {
                  ...
                  <| LazyList.toList((LazyList.tryTail(LazyList.cons 1 (LazyList.cons 2 (LazyList.cons 3 LazyList.empty)))).Value)
              }
              ...
              test "find N" {
                  Expect.throwsT<KeyNotFoundException> "find N" (fun () -> LazyList.find (fun x -> x >= 8) (LazyList.take 5 nats) |> ignore)
              }
