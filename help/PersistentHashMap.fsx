...
let lookupInFSharpMapAndPersistentMap n count =
    ...
    stopAndReportAvarageTime trials "  ImmutableDictionay" (fun () -> for i in 1..count do dict.[r.Next(n).ToString()] |> ignore) |> ignore
