                ...
                if (this.bitmap &&& bit) <> 0 then
                    ...
                    if keyOrNull = null then
                        ...
                        if key = keyOrNull then
                            ...
                            BitmapIndexedNode(ref null, this.bitmap, cloneAndSet2(this.array, idx', null, idx'+1, NodeCreation.createNode(ref null, shift + 5, keyOrNull, valOrNode, hashKey, key, value) :> obj)) :> INode
                else
                    let n = NumberOfSetBits(this.bitmap)
                    if n >= 16 then
