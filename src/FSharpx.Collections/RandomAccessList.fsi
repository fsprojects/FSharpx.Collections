...
module RandomAccessList =
    ...
    val inline updateNth:
        int -> int -> 'T -> RandomAccessList<RandomAccessList<'T>> -> RandomAccessList<RandomAccessList<'T>>
    ...
    val inline tryUpdateNth:
        int -> int -> 'T -> RandomAccessList<RandomAccessList<'T>> -> RandomAccessList<RandomAccessList<'T>> option
